...
pub struct AssetsCommandArgs {
    #[command(subcommand)]
    pub target: AssetsTargetContract,
}

#[derive(Debug, Clone, Subcommand, PartialEq, Eq)]
pub enum AssetsTargetContract {
...
#[derive(Debug, Clone, Args, PartialEq, Eq)]
#[command(arg_required_else_help = true)]
pub struct AssetsManifestCommandArgs {
    #[command(subcommand)]
    pub action: AssetsManifestActionContract,
}

#[derive(Debug, Clone, Subcommand, PartialEq, Eq)]
pub enum AssetsManifestActionContract {
...
#[derive(Debug, Clone, Args, PartialEq, Eq)]
#[command(arg_required_else_help = true)]
pub struct AssetsRustCommandArgs {
    #[command(subcommand)]
    pub action: AssetsRustActionContract,
}

#[derive(Debug, Clone, Subcommand, PartialEq, Eq)]
pub enum AssetsRustActionContract {
...
pub struct AssetBundleSelectorArgs {
    /// Use a raw bundle id.
...
#[derive(Debug, Clone, Args, PartialEq, Eq)]
pub struct AssetsManifestWriteCommandArgs {
...
pub enum AssetsRustSurfaceContract {
    Fret,
    Framework,
}

#[derive(Debug, Clone, Args, PartialEq, Eq)]
pub struct AssetsRustWriteCommandArgs {
    /// Assets source directory to scan.
    #[arg(long)]
    pub dir: PathBuf,
