use super::shaders::{
    BLIT_SHADER, BLUR_H_SHADER, BLUR_V_SHADER, CLIP_MASK_SHADER, COLOR_ADJUST_SHADER,
    COMPOSITE_PREMUL_MASK_SHADER, COMPOSITE_PREMUL_SHADER, DOWNSAMPLE_NEAREST_SHADER, MASK_SHADER,
    PATH_SHADER, QUAD_SHADER, TEXT_COLOR_SHADER, TEXT_SHADER, UPSCALE_NEAREST_MASK_SHADER,
    UPSCALE_NEAREST_SHADER, VIEWPORT_SHADER,
};
