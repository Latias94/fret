...
mod tests {
    ...
    use fret_runtime::{
        CommandRegistry, DragKind, DragSession, Effect, ModelId, ModelStore, UiHost,
    };
    ...
    fn button_variant_uses_semantic_palette_keys() {
        ...
        let mut theme = Theme::global(&TestHostImpl::default()).clone();
