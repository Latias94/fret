...
mod tests {
    ...
    #[test]
    fn map_directional_resize_cursor_icons_to_winit() {
        assert_eq!(
            map_cursor_icon(fret_core::CursorIcon::EResize),
            winit::cursor::CursorIcon::EResize
        );
        assert_eq!(
            map_cursor_icon(fret_core::CursorIcon::WResize),
            winit::cursor::CursorIcon::WResize
        );
    }
}
