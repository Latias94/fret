...
pub const UI_WINDOW_HIT_TEST_PASSTHROUGH_ALL: &str = "ui.window.hit_test.passthrough_all";
pub const UI_WINDOW_HIT_TEST_PASSTHROUGH_REGIONS: &str = "ui.window.hit_test.passthrough_regions";
