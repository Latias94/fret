...
pub(crate) const REGISTERED_FRAME_STATS_KEYS: &[PerfKey] = &[
    ...
    count_key("gc_stale_liveness_offenders", PerfKeyAggregate::Max),
    ...
    count_key("parent_pointer_would_repair_passes", PerfKeyAggregate::Max),
    count_key("parent_pointer_would_repair_nodes", PerfKeyAggregate::Max),
    count_key(
