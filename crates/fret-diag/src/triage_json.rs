            ...
            let examples: Vec<serde_json::Value> = worst
                ...
                .map(|p| {
                    json!({
                        ...
                        "layout_child_first_pass_roots": p.layout_child_first_pass_roots,
                        "layout_child_first_pass_layout_invalidated_roots": p.layout_child_first_pass_layout_invalidated_roots,
                        "layout_child_first_pass_subtree_dirty_roots": p.layout_child_first_pass_subtree_dirty_roots,
                        "layout_child_first_pass_clean_roots": p.layout_child_first_pass_clean_roots,
                        "layout_child_first_pass_performed_roots": p.layout_child_first_pass_performed_roots,
                        "layout_child_first_pass_skipped_roots": p.layout_child_first_pass_skipped_roots,
                        "layout_child_first_pass_bounds_changed_roots": p.layout_child_first_pass_bounds_changed_roots,
                        "layout_child_first_pass_bounds_size_changed_roots": p.layout_child_first_pass_bounds_size_changed_roots,
                        "layout_child_first_pass_input_mismatch_roots": p.layout_child_first_pass_input_mismatch_roots,
                        "layout_child_first_pass_input_size_mismatch_roots": p.layout_child_first_pass_input_size_mismatch_roots,
            ...
            "scroll_layout_profiles": row.scroll_layout_profiles.iter().take(10).map(|p| {
                json!({
                    ...
                    "layout_child_corrected_content_max_us": p.layout_child_corrected_content_max_us,
                        ...
                        "layout_child_roots": p.layout_child_roots,
                        "layout_child_layout_invalidated_roots": p.layout_child_layout_invalidated_roots,
                        "layout_child_subtree_dirty_roots": p.layout_child_subtree_dirty_roots,
                        "layout_child_clean_roots": p.layout_child_clean_roots,
                        "layout_child_performed_roots": p.layout_child_performed_roots,
                        "layout_child_skipped_roots": p.layout_child_skipped_roots,
                        "layout_child_bounds_changed_roots": p.layout_child_bounds_changed_roots,
                        "layout_child_bounds_size_changed_roots": p.layout_child_bounds_size_changed_roots,
                        "layout_child_input_mismatch_roots": p.layout_child_input_mismatch_roots,
                        "layout_child_input_size_mismatch_roots": p.layout_child_input_size_mismatch_roots,
