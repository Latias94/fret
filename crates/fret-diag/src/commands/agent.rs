...
pub(crate) fn cmd_agent(
    ...
    let payload = json!({
        ...
        "steps": [
            {
                "id": "doctor_check",
                "command": format!("fretboard-dev diag doctor --check {} --warmup-frames {}", bundle_dir.display(), warmup_frames),
                "why": "Verify that required sidecars exist and match warmup_frames.",
            },
            {
                "id": "doctor_fix",
                "command": format!("fretboard-dev diag doctor --fix {} --warmup-frames {}", bundle_dir.display(), warmup_frames),
            ...
            },
            {
                ...
                "command": format!("fretboard-dev diag pack {} --ai-only --warmup-frames {}", bundle_dir.display(), warmup_frames),
            ...
            },
            {
                ...
                "command": format!("fretboard-dev diag pack {} --include-all --pack-schema2-only --warmup-frames {}", bundle_dir.display(), warmup_frames),
            ...
            },
            {
                ...
                "command": format!("fretboard-dev diag triage --lite {} --warmup-frames {} --metric total", bundle_dir.display(), warmup_frames),
                "why": "First-pass perf triage (slowest frames) without materializing bundle artifacts.",
            },
            {
                "id": "triage_lite_layout",
                "command": format!("fretboard-dev diag triage --lite {} --warmup-frames {} --metric layout", bundle_dir.display(), warmup_frames),
                "why": "Identify layout-heavy worst frames.",
            },
            {
                "id": "triage_lite_paint",
                "command": format!("fretboard-dev diag triage --lite {} --warmup-frames {} --metric paint", bundle_dir.display(), warmup_frames),
                "why": "Identify paint-heavy worst frames.",
            },
            {
                "id": "hotspots_lite_total",
                "command": format!("fretboard-dev diag hotspots --lite {} --warmup-frames {} --metric total", bundle_dir.display(), warmup_frames),
                "why": "Perf hotspots (slow frames) fallback when a bundle artifact is too large for JSON-size hotspots.",
            },
            {
                "id": "slice_targeted",
                "command": format!("fretboard-dev diag slice {} --test-id <test_id> --window <window> --frame-id <frame_id> --warmup-frames {}", bundle_dir.display(), warmup_frames),
                "why": "Extract a small, shareable slice for the candidate window/frame.",
            },
            {
                "id": "ai_packet",
                "command": format!("fretboard-dev diag ai-packet {} --sidecars-only --warmup-frames {}", bundle_dir.display(), warmup_frames),
            ...
            },
            {
                ...
                "command": format!("fretboard-dev diag ai-packet {} --include-triage --warmup-frames {}", bundle_dir.display(), warmup_frames),
            ...
            },
            {
                ...
                "command": format!("fretboard-dev diag hotspots {} --force", bundle_dir.display()),
