...
pub(crate) fn ui_gallery_code_editor_suite_scripts() -> [&'static str; 43] {
    [
        "tools/diag-scripts/ui-gallery-code-editor-torture-scroll-stability.json",
        "tools/diag-scripts/ui-gallery-code-editor-torture-soft-wrap-editing-baseline.json",
        "tools/diag-scripts/ui-gallery-code-editor-torture-soft-wrap-geom-fallback-baseline.json",
...
pub(crate) fn ui_gallery_overlay_steady_suite_scripts() -> [&'static str; 4] {
    [
...
pub(crate) fn ui_gallery_text_wrap_suite_scripts() -> [&'static str; 5] {
    [
...
pub(crate) fn ui_gallery_select_suite_scripts() -> [&'static str; 10] {
    [
...
pub(crate) fn ui_gallery_shadcn_conformance_suite_scripts() -> [&'static str; 24] {
    [
...
pub(crate) fn ui_gallery_layout_suite_scripts() -> [&'static str; 6] {
    [
...
pub(crate) fn docking_arbitration_suite_scripts() -> Vec<&'static str> {
    let mut scripts = vec![
