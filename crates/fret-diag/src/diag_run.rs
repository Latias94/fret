...
impl Default for RunChecks {
    fn default() -> Self {
        Self {
            ...
            check_asset_load_stale_manifest_max: None,
            ...
            check_asset_load_io_max: None,
            check_asset_load_revision_changes_max: None,
            check_bundled_font_baseline_source: None,
            check_asset_reload_epoch_min: None,
            check_asset_reload_configured_backend: None,
            check_asset_reload_active_backend: None,
            check_asset_reload_fallback_reason: None,
