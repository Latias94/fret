...
use fret_core::{
    Event, InternalDragEvent, InternalDragKind, Point, Px, UiServices, WindowMetricsService,
};
...
mod window_redraw_present;
mod window_redraw_present_capture_commands;
...
mod window_redraw_renderdoc_capture;
