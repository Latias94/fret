...
#[path = "../app_handler.rs"]
mod app_handler;
#[path = "../diag_bundle_screenshots.rs"]
mod diag_bundle_screenshots;
#[cfg(feature = "diag-screenshots")]
#[path = "../diag_screenshots.rs"]
mod diag_screenshots;
#[path = "../dispatcher.rs"]
mod dispatcher;
#[cfg(target_os = "ios")]
#[path = "../ios_keyboard.rs"]
mod ios_keyboard;
#[cfg(target_os = "macos")]
#[path = "../macos_menu.rs"]
mod macos_menu;
...
#[path = "../renderdoc_capture.rs"]
mod renderdoc_capture;
#[cfg(windows)]
#[path = "../windows_menu.rs"]
mod windows_menu;
...
struct UploadedImageEntry {
    ...
    nv12_planes: Option<super::super::yuv_gpu::Nv12Planes>,
}
