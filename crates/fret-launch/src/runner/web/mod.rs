...
pub struct WinitRunner<D: WinitAppDriver> {
    ...
    web_canvas_context_menu_blocker: Option<Closure<dyn FnMut(web_sys::Event)>>,
...
impl<D: WinitAppDriver> WinitRunner<D> {
    pub fn new_app(config: WinitRunnerConfig, app: App, driver: D) -> Self {
        ...
        crate::assets::ensure_default_web_url_passthrough_resolver(&mut app);
        ...
        Self {
            ...
            web_canvas_context_menu_blocker: None,
