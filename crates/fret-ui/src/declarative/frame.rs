...
pub(crate) enum ElementInstance {
    ...
    LayoutQueryRegion(crate::element::LayoutQueryRegionProps),
    InteractivityGate(crate::element::InteractivityGateProps),
    HitTestGate(crate::element::HitTestGateProps),
    FocusTraversalGate(crate::element::FocusTraversalGateProps),
    ForegroundScope(crate::element::ForegroundScopeProps),
    Opacity(crate::element::OpacityProps),
    EffectLayer(crate::element::EffectLayerProps),
    BackdropSourceGroup(crate::element::BackdropSourceGroupProps),
    MaskLayer(crate::element::MaskLayerProps),
    CompositeGroup(crate::element::CompositeGroupProps),
...
impl ElementInstance {
    pub fn kind_name(&self) -> &'static str {
        match self {
            ...
            Self::LayoutQueryRegion(_) => "LayoutQueryRegion",
            Self::InteractivityGate(_) => "InteractivityGate",
            Self::HitTestGate(_) => "HitTestGate",
            Self::FocusTraversalGate(_) => "FocusTraversalGate",
            Self::ForegroundScope(_) => "ForegroundScope",
            Self::Opacity(_) => "Opacity",
            Self::EffectLayer(_) => "EffectLayer",
            Self::BackdropSourceGroup(_) => "BackdropSourceGroup",
            Self::MaskLayer(_) => "MaskLayer",
            Self::CompositeGroup(_) => "CompositeGroup",
...
pub(crate) fn layout_style_for_instance(instance: &ElementInstance) -> LayoutStyle {
    match instance {
        ...
        ElementInstance::LayoutQueryRegion(p) => p.layout,
        ElementInstance::InteractivityGate(p) => p.layout,
        ElementInstance::HitTestGate(p) => p.layout,
        ElementInstance::FocusTraversalGate(p) => p.layout,
        ElementInstance::ForegroundScope(p) => p.layout,
        ElementInstance::Opacity(p) => p.layout,
        ElementInstance::EffectLayer(p) => p.layout,
        ElementInstance::BackdropSourceGroup(p) => p.layout,
        ElementInstance::MaskLayer(p) => p.layout,
        ElementInstance::CompositeGroup(p) => p.layout,
