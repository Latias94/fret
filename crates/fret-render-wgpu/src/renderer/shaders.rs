...
pub(super) const BLIT_SRGB_ENCODE_SHADER: &str = r#"
@group(0) @binding(0) var src_texture: texture_2d<f32>;
...
pub(super) const DITHER_SHADER: &str = r#"
@group(0) @binding(0) var src_texture: texture_2d<f32>;
...
const DITHER_MASKED_SHADER_PART_A: &str = r#"
struct ClipRRect {
  rect: vec4<f32>,
  corner_radii: vec4<f32>,
  inv0: vec4<f32>,
...
const DITHER_MASKED_SHADER_PART_B: &str = r#"
fn clip_alpha(pixel_pos: vec2<f32>) -> f32 {
  var alpha = 1.0;
  var idx = viewport.clip_head;
  for (var i = 0u; i < 64u; i = i + 1u) {
...
pub(super) const DITHER_MASK_SHADER: &str = r#"
struct ClipRRect {
  rect: vec4<f32>,
  corner_radii: vec4<f32>,
  inv0: vec4<f32>,
...
pub(super) const NOISE_SHADER: &str = r#"
@group(0) @binding(0) var src_texture: texture_2d<f32>;
...
@group(0) @binding(1) var<uniform> noise: NoiseParams;
...
const NOISE_MASKED_SHADER_PART_A: &str = r#"
struct ClipRRect {
  rect: vec4<f32>,
  corner_radii: vec4<f32>,
  inv0: vec4<f32>,
...
const NOISE_MASKED_SHADER_PART_B: &str = r#"
fn clip_alpha(pixel_pos: vec2<f32>) -> f32 {
  var alpha = 1.0;
  var idx = viewport.clip_head;
  for (var i = 0u; i < 64u; i = i + 1u) {
...
pub(super) const NOISE_MASK_SHADER: &str = r#"
struct Viewport {
  viewport_size: vec2<f32>,
  clip_head: u32,
  clip_count: u32,
