...
impl Renderer {
    ...
    fn record_fullscreen_blit_pass(
        &mut self,
        device: &wgpu::Device,
        format: wgpu::TextureFormat,
        target_view: &wgpu::TextureView,
                            ...
                            #[cfg(any())]
                            {
                                ...
                                let dst_view_owned = match pass.dst {
                                    ...
                                    PlanTarget::Mask0 | PlanTarget::Mask1 | PlanTarget::Mask2 => {
                                        debug_assert!(
                                            false,
                                            "DropShadow dst cannot be mask targets"
                                        );
                                        None
                                    }
                                };
                                ...
                                if let Some(mask) = pass.mask {
                                    ...
                                    if perf_enabled {
                                        frame_perf.pipeline_switches =
                                            frame_perf.pipeline_switches.saturating_add(1);
                                        frame_perf.pipeline_switches_fullscreen = frame_perf
