...
impl Renderer {
    ...
    pub fn take_perf_snapshot(&mut self) -> Option<RenderPerfSnapshot> {
        ...
        let snap = RenderPerfSnapshot {
            ...
            prepare_text_collect_pin_keys_us: perf.prepare_text_collect_pin_keys.as_micros() as u64,
            prepare_text_bucket_delta_us: perf.prepare_text_bucket_delta.as_micros() as u64,
            prepare_text_prewarm_us: perf.prepare_text_prewarm.as_micros() as u64,
            prepare_text_pin_bucket_update_us: perf.prepare_text_pin_bucket_update.as_micros()
                as u64,
            ...
            prepare_text_added_glyph_keys: perf.prepare_text_added_glyph_keys,
            prepare_text_removed_glyph_keys: perf.prepare_text_removed_glyph_keys,
            encode_scene_stack_us: perf.encode_scene_stack.as_micros() as u64,
            encode_scene_clip_us: perf.encode_scene_clip.as_micros() as u64,
            encode_scene_mask_us: perf.encode_scene_mask.as_micros() as u64,
            encode_scene_effect_us: perf.encode_scene_effect.as_micros() as u64,
            encode_scene_quad_us: perf.encode_scene_quad.as_micros() as u64,
            encode_scene_image_us: perf.encode_scene_image.as_micros() as u64,
            encode_scene_text_us: perf.encode_scene_text.as_micros() as u64,
            encode_scene_path_us: perf.encode_scene_path.as_micros() as u64,
            encode_scene_viewport_us: perf.encode_scene_viewport.as_micros() as u64,
            encode_scene_flush_us: perf.encode_scene_flush.as_micros() as u64,
            encode_scene_text_shadow_us: perf.encode_scene_text_shadow.as_micros() as u64,
            encode_scene_text_setup_us: perf.encode_scene_text_setup.as_micros() as u64,
            encode_scene_text_glyphs_us: perf.encode_scene_text_glyphs.as_micros() as u64,
            encode_scene_text_glyph_transform_us: perf.encode_scene_text_glyph_transform.as_micros()
                as u64,
            encode_scene_text_glyph_emit_us: perf.encode_scene_text_glyph_emit.as_micros() as u64,
            encode_scene_text_group_flush_us: perf.encode_scene_text_group_flush.as_micros() as u64,
            encode_scene_text_vertex_grow_events: perf.encode_scene_text_vertex_grow_events,
            encode_scene_text_transform_fast_path_glyphs: perf
                .encode_scene_text_transform_fast_path_glyphs,
            encode_scene_text_transform_generic_glyphs: perf
                .encode_scene_text_transform_generic_glyphs,
            encode_scene_stack_ops: perf.encode_scene_stack_ops,
            encode_scene_clip_ops: perf.encode_scene_clip_ops,
            encode_scene_mask_ops: perf.encode_scene_mask_ops,
            encode_scene_effect_ops: perf.encode_scene_effect_ops,
            encode_scene_quad_ops: perf.encode_scene_quad_ops,
            encode_scene_image_ops: perf.encode_scene_image_ops,
            encode_scene_text_ops: perf.encode_scene_text_ops,
            encode_scene_path_ops: perf.encode_scene_path_ops,
            encode_scene_viewport_ops: perf.encode_scene_viewport_ops,
            encode_scene_flushes: perf.encode_scene_flushes,
            ...
            scene_chunk_encoding_payload_cache_hits: perf.scene_chunk_encoding_payload_cache_hits,
            scene_chunk_encoding_payload_cache_misses: perf
                .scene_chunk_encoding_payload_cache_misses,
            scene_chunk_encoding_payload_chunks_encoded: perf
                .scene_chunk_encoding_payload_chunks_encoded,
            scene_chunk_encoding_payload_bytes_estimate: perf
            ...
            geometry_upload: perf.geometry_upload,
            ...
            scene_encoding_cache_miss_histogram: perf.scene_encoding_cache_miss_histogram,
