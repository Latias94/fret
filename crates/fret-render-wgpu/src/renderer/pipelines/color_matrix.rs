...
impl Renderer {
    pub(in crate::renderer) fn ensure_color_matrix_pipeline(
        ...
        if self.pipelines.color_matrix_pipeline_format == Some(format)
            && self.pipelines.color_matrix_pipeline.is_some()
            && self.pipelines.color_matrix_masked_pipeline.is_some()
            && self.pipelines.color_matrix_bind_group_layout.is_some()
            && self.pipelines.color_matrix_mask_pipeline.is_some()
            && self.pipelines.color_matrix_mask_bind_group_layout.is_some()
        {
            return;
        }
        ...
        let create_span = tracing::enabled!(tracing::Level::TRACE)
            .then(|| {
                let reason = if self.pipelines.color_matrix_pipeline_format != Some(format) {
                    "format_changed"
                } else {
                    "missing"
                };
                tracing::trace_span!(
                    "fret.renderer.pipeline.create.color_matrix",
                    format = ?format,
                    reason
                )
            })
        ...
        self.pipelines.color_matrix_pipeline_format = Some(format);
        self.pipelines.color_matrix_bind_group_layout = Some(bind_group_layout);
        self.pipelines.color_matrix_mask_bind_group_layout = Some(mask_bind_group_layout);
        self.pipelines.color_matrix_pipeline = Some(pipeline);
        self.pipelines.color_matrix_masked_pipeline = Some(masked_pipeline);
        self.pipelines.color_matrix_mask_pipeline = Some(mask_pipeline);
    }

    pub(in crate::renderer) fn color_matrix_bind_group_layout_ref(&self) -> &wgpu::BindGroupLayout {
        self.pipelines
    ...
    pub(in crate::renderer) fn color_matrix_mask_bind_group_layout_ref(
        &self,
    ...
    pub(in crate::renderer) fn color_matrix_pipeline_ref(&self) -> &wgpu::RenderPipeline {
        self.pipelines
    ...
    pub(in crate::renderer) fn color_matrix_masked_pipeline_ref(&self) -> &wgpu::RenderPipeline {
        self.pipelines
    ...
    pub(in crate::renderer) fn color_matrix_mask_pipeline_ref(&self) -> &wgpu::RenderPipeline {
        self.pipelines
