...
- `cargo run -p fretboard-dev -- diag run tools/diag-scripts/ui-gallery/data-table/ui-gallery-data-table-smoke.json --dir target/fret-diag/data-table-reusable-components-smoke --timeout-ms 240000 --pack --ai-packet --launch -- env CARGO_TARGET_DIR=target-codex-data-table cargo run -p fret-ui-gallery`
- `cargo run -p fretboard-dev -- diag run tools/diag-scripts/ui-gallery/data-table/ui-gallery-data-table-guide-header-screenshot-zinc-light.json --dir target/fret-diag/data-table-guide-header-zinc-light --timeout-ms 240000 --pack --ai-packet --launch -- env CARGO_TARGET_DIR=target-codex-data-table cargo run -p fret-ui-gallery`
- `cargo run -p fretboard-dev -- diag run tools/diag-scripts/ui-gallery/data-table/ui-gallery-data-table-reusable-view-options-toggle.json --dir target/fret-diag/data-table-reusable-view-options-toggle --timeout-ms 240000 --pack --ai-packet --launch -- env CARGO_TARGET_DIR=target-codex-data-table cargo run -p fret-ui-gallery`
...
- `cargo run -p fretboard-dev -- diag run tools/diag-scripts/ui-gallery/data-table/ui-gallery-data-table-guide-row-actions-menu-stability.json --dir target/fret-diag/data-table-guide-row-actions-recheck --timeout-ms 240000 --pack --ai-packet --launch -- cargo run -p fret-ui-gallery`
