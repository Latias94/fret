...
- `cargo run -p fretboard -- diag run tools/diag-scripts/ui-gallery/data-table/ui-gallery-data-table-guide-header-screenshot-zinc-light.json --dir target/fret-diag/data-table-guide-header-zinc-light --timeout-ms 240000 --pack --ai-packet --launch -- env CARGO_TARGET_DIR=target-codex-data-table cargo run -p fret-ui-gallery`
