...
- Partial: Upstream includes zoom/slide animations keyed off `data-state` and `data-side`; Fret uses
  deterministic hover intent timing without animation (by design).
