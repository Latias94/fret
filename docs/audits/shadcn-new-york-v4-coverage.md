...
- Golden files (tracked): `534`
- Golden keys (tracked, normalized `.open` suffix): `492`
- Gated keys (string-literal heuristic): `492` (`100%`)
- Targeted gates (excluding `web_vs_fret_layout.rs`, `snapshots.rs`): `492` (`100%`)
