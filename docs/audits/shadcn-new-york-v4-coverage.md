...
- Golden files (tracked): `530`
- Golden keys (tracked, normalized `.open` suffix): `488`
- Gated keys (string-literal heuristic): `488` (`100%`)
- Targeted gates (excluding `web_vs_fret_layout.rs`, `snapshots.rs`): `488` (`100%`)
