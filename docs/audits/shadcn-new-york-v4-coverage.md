...
- Golden files (tracked): `519`
- Golden keys (tracked, normalized `.open` suffix): `477`
- Gated keys (string-literal heuristic): `477` (`100%`)
- Targeted gates (excluding `web_vs_fret_layout.rs`, `snapshots.rs`): `477` (`100%`)
