...
- Golden files (tracked): `533`
- Golden keys (tracked, normalized `.open` suffix): `491`
- Gated keys (string-literal heuristic): `491` (`100%`)
- Targeted gates (excluding `web_vs_fret_layout.rs`, `snapshots.rs`): `491` (`100%`)
