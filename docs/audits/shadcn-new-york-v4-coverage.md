...
- Golden files (tracked): `573`
- Golden keys (tracked, normalized `.open` suffix): `529`
- Gated keys (string-literal heuristic): `529` (`100%`)
- Targeted gates (excluding `web_vs_fret_layout.rs`, `snapshots.rs`): `529` (`100%`)
