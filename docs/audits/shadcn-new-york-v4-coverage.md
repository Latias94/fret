...
- Golden files (tracked): `521`
- Golden keys (tracked, normalized `.open` suffix): `479`
- Gated keys (string-literal heuristic): `479` (`100%`)
- Targeted gates (excluding `web_vs_fret_layout.rs`, `snapshots.rs`): `479` (`100%`)
