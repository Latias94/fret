...
- Golden files (tracked): `618`
- Golden keys (tracked, normalized `.open` suffix): `574`
- Gated keys (string-literal heuristic): `574` (`100%`)
- Targeted gates (excluding `web_vs_fret_layout.rs`, `snapshots.rs`): `574` (`100%`)
