...
- Golden files (tracked): `614`
- Golden keys (tracked, normalized `.open` suffix): `570`
- Gated keys (string-literal heuristic): `570` (`100%`)
- Targeted gates (excluding `web_vs_fret_layout.rs`, `snapshots.rs`): `570` (`100%`)
