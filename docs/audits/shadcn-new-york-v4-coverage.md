...
- Golden files (tracked): `580`
- Golden keys (tracked, normalized `.open` suffix): `536`
- Gated keys (string-literal heuristic): `536` (`100%`)
- Targeted gates (excluding `web_vs_fret_layout.rs`, `snapshots.rs`): `536` (`100%`)
