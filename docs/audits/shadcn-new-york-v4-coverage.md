...
- Golden files (tracked): `532`
- Golden keys (tracked, normalized `.open` suffix): `490`
- Gated keys (string-literal heuristic): `490` (`100%`)
- Targeted gates (excluding `web_vs_fret_layout.rs`, `snapshots.rs`): `490` (`100%`)
