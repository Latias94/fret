...
- Golden files (tracked): `541`
- Golden keys (tracked, normalized `.open` suffix): `497`
- Gated keys (string-literal heuristic): `497` (`100%`)
- Targeted gates (excluding `web_vs_fret_layout.rs`, `snapshots.rs`): `497` (`100%`)
