...
- Golden files (tracked): `552`
- Golden keys (tracked, normalized `.open` suffix): `508`
- Gated keys (string-literal heuristic): `508` (`100%`)
- Targeted gates (excluding `web_vs_fret_layout.rs`, `snapshots.rs`): `508` (`100%`)
