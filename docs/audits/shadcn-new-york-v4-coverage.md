...
- Golden files (tracked): `516`
- Golden keys (tracked, normalized `.open` suffix): `474`
- Gated keys (string-literal heuristic): `474` (`100%`)
- Targeted gates (excluding `web_vs_fret_layout.rs`, `snapshots.rs`): `474` (`100%`)
