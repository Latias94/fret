...
- Golden files (tracked): `517`
- Golden keys (tracked, normalized `.open` suffix): `475`
- Gated keys (string-literal heuristic): `475` (`100%`)
- Targeted gates (excluding `web_vs_fret_layout.rs`, `snapshots.rs`): `475` (`100%`)
