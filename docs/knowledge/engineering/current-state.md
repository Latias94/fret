...
- Last verified: Phase 3 U13 `fret-examples` precise quarantine passed source-policy unit tests,
  source-policy gate, consumption-profile, and execution-surface gates on 2026-07-03. Full
...
- Latest done: Phase 3 U13 sixth slice adds precise `apps/fret-examples/src` source-policy
  quarantine records for high-visibility proof/harness files without adding a broad examples-root
  quarantine.
