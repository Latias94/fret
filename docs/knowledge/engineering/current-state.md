...
- Last verified: U9 view scheduling and layout-query split passed focused AppUi shell/facade nextest gates, the consumption profile gate, formatting, layering/surface gates, and `git diff --check`.
...
- Latest done: U9 view scheduling and layout-query split.
...
- Next action: split the remaining lane-barrier methods and core `AppUi` shell helpers, or pause U9 after the current modularity checkpoint.
