...
- Last verified: U9 view data helpers split passed focused data/action/facade nextest gates, the consumption profile gate, formatting, layering/surface gates, and `git diff --check`.
...
- Latest done: U9 view data helpers split.
...
- Next action: split the remaining raw/advanced escape hatches and AppUi shell helpers into narrow view modules without widening the default app authoring lane.
