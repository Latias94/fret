...
- Next action: continue U8 with the behavior-changing cut: add referenced glyph resource generation keys for scene/chunk cache invalidation, or first remove prepare-time atlas insertion and make residency visible glyph range driven.
