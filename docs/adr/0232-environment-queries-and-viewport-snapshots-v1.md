# ADR 0232: Environment Queries and Viewport Snapshots (v1)

Status: Accepted

## Context

Fret’s container query contract (ADR 0231) addresses **panel/container-driven** responsiveness for
...
- **Container queries** (ADR 0231): “adapt to the width/height of a local container/panel”.
...
keys can incorporate them (similar to ADR 0231’s layout-query deps fingerprint).
