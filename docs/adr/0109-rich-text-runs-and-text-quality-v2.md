# ADR 0109: Rich Text Runs and Text Quality v2 (Runs, Decorations, Subpixel Strategy)
...
surface in ADR 0100) require **inline style variation** that must still participate in wrapping,
...
- Rich content selection contract (Markdown-first): `docs/adr/0110-rich-content-selection-and-clipboard.md`
...
This ADR builds on ADR 0103 (Text Decorations and Markdown Theme Tokens) for the vocabulary, but
...
1) Reconcile ADR 0103 with this ADR:
   - Either mark ADR 0103 as “Superseded by ADR 0109” or merge its vocabulary section as an
