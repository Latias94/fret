...
- ADR 1178 (mutation surface + revisioning rules)
...
- Keep behavior deterministic across refactors and compatible with derived dataset lineage (ADR 1175).
...
- dataset identity + **lineage root dataset id** (ADR 1175),
