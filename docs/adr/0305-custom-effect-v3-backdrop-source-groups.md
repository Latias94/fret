---
title: "ADR 0305: Custom Effect V3 (Backdrop Source Groups for Liquid Glass)"
status: Draft
date: 2026-02-28
---

# ADR 0305: Custom Effect V3 (Backdrop Source Groups for Liquid Glass)

## Context

CustomV3 (ADR 0304) provides renderer-owned sources:
...
- CustomV3 falls back to the ADR 0304 semantics (chain-local `src_raw`/`src_pyramid` behavior and degradations).
...
- ADR 0304: Custom Effect V3 (Renderer-provided Sources: Raw + Optional Pyramid)
