# ADR 0193: `delinea` Marks + Stable Identity + Renderer Contract (2D Cartesian v1)
...
- ADR 0190: introduces `delinea` and establishes “headless engine + UI adapter”.
- ADR 0191: transform pipeline and dataZoom ordering.
...
- Add bar/rect marks (depends on ADR 0192 category semantics).
- Add multi-grid/multi-axis layout decisions (see ADR 0196).
