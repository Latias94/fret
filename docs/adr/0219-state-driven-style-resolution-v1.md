# ADR 0219: State-Driven Style Resolution v1 (WidgetStateProperty)

Status: Proposed

## Context

Fret’s styling contract is token-driven (ADR 0032 / ADR 0050 / ADR 0101). This works well for
...
(e.g. Material/Shadcn defaults) in ecosystem crates (ADR 0066, ADR 0154).
...
- Additional v1 `*Style` surfaces: `ecosystem/fret-ui-shadcn/src/{checkbox,radio_group,select,slider,switch,toggle,toggle_group,tabs,input}.rs`
