# ADR 0139: Viewport Gizmos — Engine-pass Rendering and UI Overlay Boundary
...
- edit transactions (ADR 0136 / ADR 0024 direction).
...
- Edit boundaries: drag interactions should map cleanly to begin/update/commit/cancel phases (ADR 0136 direction).
