# ADR 1175: `delinea` Transform Lineage + Raw-Index Identity (v1)
...
- ADR 1176: define the minimum dataset transform node set for v1 and the spec/model surface.
- ADR 1177: define cache keys and invalidation boundaries for dataset transform nodes.
