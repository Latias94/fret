# ADR 1134: `delinea` Multi-Axis + Layout Contract (Cartesian v1)
...
- ADR 1131: marks identity and renderer contract.
- ADR 1133: interaction and hit testing contract (axis locks / zoom locks).
