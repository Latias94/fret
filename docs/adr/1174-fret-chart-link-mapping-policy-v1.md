# ADR 1174: `fret-chart` Link Mapping Policy v1 (Axis Keyed)
...
- `LinkEvent::AxisPointerChanged { anchor: Option<AxisPointerAnchor> }` (ADR 1172),
- `LinkEvent::DomainWindowChanged { axis, window }` (ADR 1173),
- `LinkEvent::BrushSelectionChanged { selection }` (ADR 1146).
