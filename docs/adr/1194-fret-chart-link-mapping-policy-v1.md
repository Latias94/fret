# ADR 1194: `fret-chart` Link Mapping Policy v1 (Axis Keyed)
...
- `LinkEvent::AxisPointerChanged { anchor: Option<AxisPointerAnchor> }` (ADR 1192),
- `LinkEvent::DomainWindowChanged { axis, window }` (ADR 1193),
