# ADR 0254: `delinea` Dataset Transform Cache Keys + Invalidation (v1)
...
- ADR 0202 / ADR 0210 (dataset storage + append semantics),
- ADR 0252 (raw-index identity),
- ADR 0253 (v1 transform node set).
