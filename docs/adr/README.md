...
- **Paint/Brush primitives (gradients, procedural patterns)**
  - Proposed: `docs/adr/0233-paint-primitives-brushes-and-gradients-v1.md`
  - Decide: minimal paint vocabulary (solid/gradients), coordinate + color space rules, and how this
    layers into controlled `MaterialId` extensibility (ADR 0123).

- **Imported render targets + external texture imports (staged, capability-gated)**
  - Proposed: `docs/adr/0234-imported-render-targets-and-external-texture-imports-v1.md`
  - Decide: end-to-end “contract path” validation, per-frame keepalive/lifetime rules, and how
    capability-gated zero-copy imports layer in without leaking backend handles (ADR 0122 / ADR 0119).

- **Controlled materials registry (Tier B procedural paints)**
  - Proposed: `docs/adr/0235-controlled-materials-registry-and-procedural-paints-v1.md`
...
- **Compositing groups and blend modes (isolated saveLayer blends)**
  - Proposed: `docs/adr/0247-compositing-groups-and-blend-modes-v1.md`
...
- **Sampled materials (v2; fixed binding shapes)**
  - Proposed: `docs/adr/0242-sampled-materials-and-fixed-binding-shapes-v2.md`
...
- **Pointer motion snapshots (velocity + paint-time reads)**
  - Proposed: `docs/adr/0243-pointer-motion-snapshots-and-move-coalescing-v1.md`
...
- **Procedural determinism (explicit seeds + explicit time)**
  - Proposed: `docs/adr/0244-procedural-material-determinism-seeds-and-time-inputs-v1.md`
...
- **Creative authoring surface (ecosystem recipes)**
  - Proposed: `docs/adr/0245-ecosystem-visual-recipes-and-creative-authoring-surface-v1.md`
...
- **Pointer coordinate spaces (window-local vs element-local, transform-aware)**
  - Proposed: `docs/adr/0238-pointer-coordinate-spaces-and-element-local-mapping-v1.md`
...
- **Mask layers (alpha masks beyond rect/rrect clipping)**
  - Proposed: `docs/adr/0239-mask-layers-and-alpha-masks-v1.md`
...
- **Frame clock and reduced-motion gates (animation time base)**
  - Proposed: `docs/adr/0240-frame-clock-and-reduced-motion-gates-v1.md`
...
- **User-facing effect recipes and tier selection (Tier A vs Tier B)**
  - Proposed: `docs/adr/0134-effect-recipes-and-tier-selection-v1.md`
...
- **Renderer budgets (intermediates + streaming uploads)**
  - Proposed: `docs/adr/0118-renderer-intermediate-budgets-and-effect-degradation-v1.md`,
...
- **Streaming surfaces + capture**
  - Proposed: `docs/adr/0119-streaming-images-and-video-surfaces.md`,
...
- **Font discovery + user font loading + stable IDs**
  ...
  - Update: `docs/adr/0147-font-stack-bootstrap-and-textfontstackkey-v1.md`
  - Proposed: `docs/adr/0257-font-selection-fallback-and-variable-font-instances-v1.md`
  ...
  - Implement: `crates/fret-render-wgpu/src/text/mod.rs`, platform font enumeration hooks (future: `crates/fret-platform`).
...
- **Multi-window degradation policy (single-window platforms)**
  - Update: `docs/adr/0083-multi-window-degradation-policy.md` (Accepted)
...
- **Effect vocabulary extensions (color matrix + alpha threshold)**
  - Proposed: `docs/adr/0236-effect-steps-color-matrix-and-alpha-threshold-v1.md`
...
- **Declarative/composable authoring (GPUI-style)**: `docs/adr/0028-declarative-elements-and-element-state.md`, `docs/adr/0039-component-authoring-model-render-renderonce-and-intoelement.md`, `docs/adr/0031-app-owned-models-and-leasing-updates.md`, `docs/adr/0330-retained-runtime-internal-and-compat-surface.md`
...
- **Headless drag-and-drop toolbox (sensors/collision/modifiers)**: `docs/adr/0157-headless-dnd-v1-contract-surface.md`, `docs/adr/0149-headless-dnd-toolbox-and-ui-integration.md`, `docs/adr/0041-drag-and-drop-clipboard-and-cross-window-drag-sessions.md`
- **Pointer identity and multi-pointer dispatch**: `docs/adr/0150-pointer-identity-and-multi-pointer-capture.md`, `docs/adr/0017-multi-window-display-and-dpi.md`, `docs/adr/0041-drag-and-drop-clipboard-and-cross-window-drag-sessions.md`
- **Multi-pointer drag sessions (host + routing keys)**: `docs/adr/0151-multi-pointer-drag-sessions-and-routing-keys.md`, `docs/adr/0150-pointer-identity-and-multi-pointer-capture.md`, `docs/adr/0041-drag-and-drop-clipboard-and-cross-window-drag-sessions.md`
...
- **Color emoji / polychrome glyph pipeline**: `docs/adr/0152-polychrome-glyphs-and-emoji-pipeline-v1.md`, `docs/adr/0029-text-pipeline-and-atlas-strategy.md`, `docs/adr/0142-text-system-v2-parley-attributed-spans-and-quality-baseline.md`
...
- **Portable asset locator + resolver contract**: `docs/adr/0317-portable-asset-locator-and-resolver-contract-v1.md`, `docs/adr/0065-icon-system-and-asset-packaging.md`, `docs/adr/0147-font-stack-bootstrap-and-textfontstackkey-v1.md`
...
- **Viewport tools and overlays**: `docs/adr/0153-viewport-tooling-host-helpers-and-arbitration-v1.md`, `docs/adr/0049-viewport-tools-input-capture-and-overlays.md`
- **Ecosystem crates (glue vs kit vs primitives)**: `docs/adr/0154-ecosystem-crate-taxonomy-glue-and-ui-kit-split-v1.md`
...
- **State-driven style resolution (interactive states)**: `docs/adr/0219-state-driven-style-resolution-v1.md`
...
- **Editor-scale performance**: `docs/adr/0042-virtualization-and-large-lists.md`, `docs/adr/0070-virtualization-contract.md`, `docs/adr/0034-timers-animation-and-redraw-scheduling.md`, `docs/adr/0036-observability-tracing-and-ui-inspector-hooks.md`, `docs/adr/0055-frame-recording-and-subtree-replay-caching.md`, `docs/adr/0213-cache-roots-and-cached-subtree-semantics-v1.md`
...
- `docs/adr/0113-available-space-and-non-reentrant-measurement.md` (constraint-correct measurement, avoid layout re-entry)
- `docs/adr/0114-window-scoped-layout-engine-and-viewport-roots.md` (multi-viewport end-state for declarative flow layout)
...
- `docs/adr/0213-cache-roots-and-cached-subtree-semantics-v1.md` (cache roots / cached subtree semantics for GPUI-style composition)
...
- `docs/adr/0101-semantic-theme-keys-and-extensible-token-registry.md` (semantic-first theming, shadcn alignment)
...
- `docs/adr/0085-model-handle-lifecycle-and-weak-models.md`
- `docs/adr/0086-models-are-main-thread-only-and-not-send.md`
...
- `docs/adr/0186-kurbo-geometry-backend-for-canvas-hit-testing.md`
...
- `docs/adr/0103-layout-driven-anchored-overlays.md`
- `docs/adr/0032-style-tokens-and-theme-resolution.md`
- `docs/adr/0050-theme-config-schema-and-baseline-tokens.md`
- `docs/adr/0101-semantic-theme-keys-and-extensible-token-registry.md`
...
- `docs/adr/0292-a11y-busy-semantics-v1.md`
...
- `docs/adr/0297-a11y-heading-semantics-v1.md`
...
- `docs/adr/0119-streaming-images-and-video-surfaces.md`
- `docs/adr/0120-offscreen-rendering-frame-capture-and-readback.md`
- `docs/adr/0121-streaming-upload-budgets-and-backpressure-v1.md`
- `docs/adr/0122-renderer-capabilities-and-optional-zero-copy-imports.md`
...
- `docs/adr/0153-viewport-tooling-host-helpers-and-arbitration-v1.md`
...
- `docs/adr/0097-plot3d-rendering-strategy.md`
- `docs/adr/0098-plot-architecture-and-performance.md`
- `docs/adr/0190-delinea-headless-chart-engine.md`
- `docs/adr/0191-delinea-transform-pipeline-and-datazoom-semantics.md`
- `docs/adr/0192-delinea-axis-scales-and-coordinate-mapping.md`
- `docs/adr/0193-delinea-marks-identity-and-renderer-contract.md`
- `docs/adr/0194-delinea-large-data-and-progressive-rendering.md`
- `docs/adr/0195-delinea-interaction-and-hit-testing-contract.md`
- `docs/adr/0196-delinea-multi-axis-and-layout-contract.md`
- `docs/adr/0197-delinea-axis-interaction-locks-and-shortcuts.md`
- `docs/adr/0198-delinea-datazoom-y-and-2d-semantics.md`
- `docs/adr/0199-delinea-row-selection-and-filtering-contract.md`
- `docs/adr/0200-delinea-datazoom-component-composition-and-span-policy.md`
...
- `docs/adr/0089-radix-aligned-headless-primitives-in-fret-components-ui.md`
