...
- **User-facing effect recipes and tier selection (Tier A vs Tier B)**
  - Proposed: `docs/adr/0147-effect-recipes-and-tier-selection-v1.md`
...
- `docs/adr/0137-delinea-row-selection-and-filtering-contract.md`
- `docs/adr/0138-delinea-datazoom-component-composition-and-span-policy.md`
