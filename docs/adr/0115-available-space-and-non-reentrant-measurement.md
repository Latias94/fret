# ADR 0115: AvailableSpace Constraints and Non-Reentrant Measurement for Declarative Layout
...
10. Codify explicit layout barriers and their contract with the engine:
   - Docking, virtualization, scroll, and viewport surfaces remain explicit layout systems (ADR
     0035, ADR 0042).
