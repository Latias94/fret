...
ADR 0235 intentionally restricts Tier B materials to “params-only” procedural paints (no
...
- Controlled materials v1: `docs/adr/0235-controlled-materials-registry-and-procedural-paints-v1.md`
- Paint primitives: `docs/adr/0233-paint-primitives-brushes-and-gradients-v1.md`
- Renderer capabilities: `docs/adr/0122-renderer-capabilities-and-optional-zero-copy-imports.md`
- Budgets + deterministic degradation: `docs/adr/0118-renderer-intermediate-budgets-and-effect-degradation-v1.md`
- Trust model / tiers: `docs/adr/0123-renderer-extensibility-materials-effects-and-sandboxing-v1.md`
...
- `params: MaterialParams` (64B; ADR 0235).
...
- Registration of a `BindingShape::ParamsPlusCatalogTexture` material MUST be capability-gated (ADR 0122).
...
do so deterministically and report the degradation path (ADR 0118 / ADR 0036).
