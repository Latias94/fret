# ADR 0252: `delinea` Transform Lineage + Raw-Index Identity (v1)
...
The raw-index contract assumes v1’s dataset storage invariants (ADR 0202 / ADR 0210):
...
- ADR 0253: define the minimum dataset transform node set for v1 and the spec/model surface.
- ADR 0254: define cache keys and invalidation boundaries for dataset transform nodes.
