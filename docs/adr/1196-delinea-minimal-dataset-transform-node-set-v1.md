# ADR 1196: `delinea` Minimal Dataset Transform Node Set (v1)
...
- compatible with raw-index identity (ADR 1195),
...
This keeps raw-index identity stable (ADR 1195) and avoids cloning.
...
- ADR 1197: cache key + invalidation contract for dataset transform nodes.
