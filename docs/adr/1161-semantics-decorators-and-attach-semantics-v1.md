# ADR 1161: Semantics Decorators and `attach_semantics` (v1)
...
- deterministic UI automation and diagnostics selectors (ADR 0174),
...
- Trigger composition without `asChild`: `docs/adr/0117-trigger-composition-and-no-slot-aschild.md`
- Diagnostics + scripted tests: `docs/adr/0174-ui-diagnostics-snapshot-and-scripted-interaction-tests.md`
