...
- Crate boundaries: `docs/adr/0092-crate-structure-core-backends-apps.md`
...
- `Widget::render_transform` for pan/zoom to keep layout bounds authoritative while transforming
  paint and hit-testing (ADR 0082).
...
- Viewport zoom is applied via render transforms (ADR 0082) to keep input and paint consistent.
