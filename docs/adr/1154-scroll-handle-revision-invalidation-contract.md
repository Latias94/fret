# ADR 1154: Scroll Handle Revision-Based Invalidation Contract
...
0005). Some UI behavior is driven imperatively by small handles stored in component-layer code
