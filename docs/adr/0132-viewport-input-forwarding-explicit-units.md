# ADR 0132: Viewport Input Forwarding — Explicit Units, Mapping Geometry, and Scale Factor
...
- Viewport gizmo boundary: `docs/adr/0130-viewport-gizmos-engine-pass-and-ui-overlay-boundary.md`
