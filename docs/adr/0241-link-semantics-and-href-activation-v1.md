# ADR 0241: Link Semantics and `href` Activation (v1)
...
- a semantics stamping mechanism (`AnyElement::attach_semantics(SemanticsDecoration)`, ADR 0222/0227),
...
- Full `asChild`/slot-based prop merging (ADR 0115 explicitly avoids this in v1).
