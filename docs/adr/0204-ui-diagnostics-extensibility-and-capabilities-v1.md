---
title: "ADR 0204: UI Diagnostics Extensibility + Capabilities v1"
---

# ADR 0204: UI Diagnostics Extensibility + Capabilities v1
...
- ADR 0174 (bundles + scripts baseline): `docs/adr/0174-ui-diagnostics-snapshot-and-scripted-interaction-tests.md`
- ADR 0196 (automation + debug recipes): `docs/adr/0196-ui-automation-and-debug-recipes-v1.md`
...
- ADR 1177 (pointer coordinate spaces): `docs/adr/1177-pointer-coordinate-spaces-and-element-local-mapping-v1.md`
...
Fret already has a usable diagnostics + scripted automation workflow (ADR 0174 / ADR 0196) that is effective for
