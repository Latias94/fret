# ADR 0150: Node Graph Canvas Middleware (Tx Gate + Input Interception)
...
4. **Future compatibility**: align with the canvas guidance in ADR 0137 without introducing a
