---
title: "ADR 0172: Headless DnD v1 Contract Surface (Sensors, Registry, Collisions)"
---

# ADR 0172: Headless DnD v1 Contract Surface (Sensors, Registry, Collisions)
...
- ADR 0169: `docs/adr/0169-ecosystem-crate-taxonomy-glue-and-ui-kit-split-v1.md`
...
ADR 0164 established the architectural decision (“a headless toolbox crate + UI integration glue”).
...
This matches the “primitives vs kit” taxonomy (ADR 0169):
...
- input events are keyed by `PointerId` (ADR 0165/0166),
...
1. Keep docking tab dragging aligned (ADR 0170) and reuse rect-based collision selection.
