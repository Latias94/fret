# ADR 0166: Interactivity Pseudoclasses + Structural Stability (Paint-Only by Default)
...
For any component intended to be cache-friendly (ADR 0213) and editor-scale performant:
...
- attribute offenders by `GlobalElementId` path (ADR 0212).

## Consequences

- Eliminates an entire class of hover-induced flicker/layout thrash bugs.
- Makes “view cache” (ADR 0213) practically usable in component-heavy surfaces.
