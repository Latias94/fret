# ADR 1178: Mask Layers and Alpha Masks (v1)
...
- re-encode masks as bespoke shader/effect pipelines (Tier A, ADR 0125), or
...
- has deterministic degradation under renderer budgets (ADR 0120),
- does not leak backend handles into `fret-ui` (ADR 0066 / ADR 0125).

Related ADRs:

- Rounded clipping: `docs/adr/0063-rounded-clipping-and-soft-clip-masks.md`
- Effects and bounds semantics: `docs/adr/0119-effect-layers-and-backdrop-filters-scene-semantics-v1.md`
- Effect clip masks (renderer-internal): `docs/adr/0153-renderer-effect-clip-masks-and-soft-clipping-v1.md`
...
- Image `object-fit`: `docs/adr/1176-image-object-fit-for-sceneop-image-v1.md`
...
**computation bound**, not an implicit clip (align with ADR 0119).
...
These reuse the gradient semantics and stop representation from ADR 1172, but only the **alpha**
...
Mask evaluation is renderer-owned and capability-gated (ADR 0124 / ADR 0125):
...
- layout-invariant,
- observable via renderer telemetry/diagnostics (ADR 0120 / ADR 0036).
