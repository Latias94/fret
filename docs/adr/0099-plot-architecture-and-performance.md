# ADR 0099: Plot Architecture and Performance Baseline (2D Layers + 3D Viewport Surfaces)
...
for implementations that conform to ADR 0097 and ADR 0098.
...
- Series are keyed by `SeriesId` (see ADR 0097).
...
- Plot3D strategy: `docs/adr/0098-plot3d-rendering-strategy.md`
