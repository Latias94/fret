# ADR 1131: `delinea` Marks + Stable Identity + Renderer Contract (2D Cartesian v1)
...
- ADR 1128: introduces `delinea` and establishes “headless engine + UI adapter”.
- ADR 1129: transform pipeline and dataZoom ordering.
...
- Add bar/rect marks (depends on ADR 1130 category semantics).
- Add multi-grid/multi-axis layout decisions (see ADR 1134).
