---
title: "ADR 0165: Pointer Identity (`PointerId`) and Multi-Pointer Capture/Dispatch"
---

# ADR 0165: Pointer Identity (`PointerId`) and Multi-Pointer Capture/Dispatch
...
- multi-pointer-aware DnD/toolbox integration (ADR 0164).
...
- This ADR is a prerequisite for “multi-pointer-ready” ecosystem drag-and-drop (ADR 0164).
