# ADR 0096: Renderer Perf Snapshots and Stress Harnesses
...
We already have a dedicated scene encoding layer and an internal ordered draw stream (ADR 0089), plus a focused SVG
...
- Update ADR 0089 migration plan to reference this snapshot API as the Phase 0 requirement.
