# ADR 0162: Font Stack Bootstrap and `TextFontStackKey` (v1)
...
The renderer text system v2 direction is also locked (Parley shaping + wrapper-owned wrap/ellipsis + attributed spans; ADR 0157).
