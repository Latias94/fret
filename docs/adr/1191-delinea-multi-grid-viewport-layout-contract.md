# ADR 1191: `delinea` Multi-Grid Viewport/Layout Contract (Cartesian v1)
...
- ADR 1134: multi-axis + layout contract (single-grid v1; explicitly calls out multi-grid as a follow-up).
