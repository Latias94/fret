# ADR 0121: Streaming Images and Video Surfaces (Frame Input Without Decoder Ownership)
...
- no `wgpu` types in `fret-core` / `fret-ui` (ADR 0004 / ADR 0093).
...
- Renderer v3 substrate + budgets: `docs/adr/0118-renderer-architecture-v3-render-plan-and-postprocessing-substrate.md`,
