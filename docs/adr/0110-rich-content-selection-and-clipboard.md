...
4) Keep the contract compatible with streaming Markdown (ADR 0100):
...
- ADR 0109 introduces runs so a single shaped layout can carry per-range styling. ADR 0110 defines
