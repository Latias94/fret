# ADR 0122: Offscreen Rendering, Frame Capture, and Readback (v1)
...
- `fret-core` / `fret-ui` remain `wgpu`-free (ADR 0093).
...
This section describes a likely implementation placement consistent with ADR 0093.
...
- Upload backpressure (related): `docs/adr/0123-streaming-upload-budgets-and-backpressure-v1.md`
