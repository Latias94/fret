# ADR 0237: Image Object-Fit for `SceneOp::Image` (v1)
...
- still images,
- streaming video frames (ADR 0117/0124),
...
- Streaming images and video surfaces: `docs/adr/0119-streaming-images-and-video-surfaces.md`
- Streaming update effects and metadata: `docs/adr/0124-streaming-image-update-effects-and-metadata-v1.md`
