# ADR 1179: Frame Clock and Reduced Motion Gates (v1)
...
- makes reduced-motion a first-class gate (ADR 1171),
...
- Environment queries (`prefers_reduced_motion`): `docs/adr/1171-environment-queries-and-viewport-snapshots-v1.md`
...
`prefers_reduced_motion` is provided via environment queries (ADR 1171).
...
For diagnostics and scripted interaction tests (ADR 0174):
