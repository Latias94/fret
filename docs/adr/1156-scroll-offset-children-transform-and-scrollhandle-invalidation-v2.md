# ADR 1156: Scroll Offset Children Transform and ScrollHandle Invalidation (v2)
...
state. ADR 1154 introduced a revision-based binding registry so imperative handle changes can
...
- Supersedes ADR 1154: `docs/adr/1154-scroll-handle-revision-invalidation-contract.md`
- Render transform input contract (related): `docs/adr/0083-render-transform-hit-testing.md`
