# ADR 0124: Renderer Capabilities and Optional Zero-Copy Imports (v1)
...
- apps fall back to byte uploads (ADR 0121), with budgets/backpressure (ADR 0123).
...
- Offscreen capture/readback: `docs/adr/0122-offscreen-rendering-frame-capture-and-readback.md`
- Extensibility (capability-gated shaders): `docs/adr/0125-renderer-extensibility-materials-effects-and-sandboxing-v1.md`
