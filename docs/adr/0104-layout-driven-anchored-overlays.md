# ADR 0104: Layout-Driven Anchored Overlays (Render-Transform Placement)
...
- Uses existing runtime semantics for transforms and outside-press observation (ADR 0083).
