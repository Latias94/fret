# ADR 0227: Semantics Decorations (v2) — states and relations

Status: Proposed

## Context

ADR 0222 introduced `AnyElement::attach_semantics(SemanticsDecoration)` as a **layout-transparent**
...
- This is not a general Radix `Slot/asChild` prop-merging system (ADR 0115).
...
- `docs/adr/0222-semantics-decorators-and-attach-semantics-v1.md`
- `docs/adr/0033-semantics-tree-and-accessibility-bridge.md`
- `docs/adr/0115-trigger-composition-and-no-slot-aschild.md`
