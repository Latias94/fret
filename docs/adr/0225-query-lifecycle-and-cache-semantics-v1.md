# ADR 0225: Query Lifecycle and Cache Semantics (v1)
...
- respect the driver-boundary apply contract (ADR 0175),
...
- **Tokio-first design:** integrates easily with Rust async ecosystems, but reduces portability and
  conflicts with ADR 0175’s capability degradation model.
