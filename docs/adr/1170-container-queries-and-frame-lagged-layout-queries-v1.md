# ADR 1170: Container Queries and Frame-Lagged Layout Queries (v1)
...
- Layout must remain deterministic and non-reentrant (ADR 0115).
...
- Non-reentrant measurement: ADR 0115 (`docs/adr/0115-available-space-and-non-reentrant-measurement.md`)
