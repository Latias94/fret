...
materials (ADR 1174). To be viable for an ecosystem:
...
- Controlled materials registry: `docs/adr/1174-controlled-materials-registry-and-procedural-paints-v1.md`
- Frame clock + reduced motion: `docs/adr/1179-frame-clock-and-reduced-motion-gates-v1.md`
- Environment queries: `docs/adr/1171-environment-queries-and-viewport-snapshots-v1.md`
...
Reduced motion remains policy-owned (ADR 1171), but Tier B materials must allow policy to disable
animation deterministically.

Recommended pattern:

- Recipes derive `t` from the frame clock (ADR 1179) when motion is allowed.
