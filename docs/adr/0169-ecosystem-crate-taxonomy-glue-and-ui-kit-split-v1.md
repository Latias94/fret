# ADR 0169: Ecosystem Crate Taxonomy (Glue vs Kit vs Primitives) and `fret-ui-kit` Split (v1)
...
- `crates/*` are kernel contracts and portable mechanisms (ADR 0093).
...
- Preserve the “golden path” story: small apps should stay easy (ADR 0108 / ADR 0112).
...
- Workspace structure: `docs/adr/0093-crate-structure-core-backends-apps.md`
