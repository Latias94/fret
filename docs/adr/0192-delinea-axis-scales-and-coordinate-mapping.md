...
`delinea` is a headless, ECharts-inspired chart engine (ADR 0190). Today we support a narrow set of
...
- v1: `Value`, `Category`, `Time` (see ADR 0201)
...
- Add multi-grid / multi-axis layout contracts (see ADR 0193 / ADR 0196 follow-ups).
