# ADR 1176: `delinea` Minimal Dataset Transform Node Set (v1)
...
- compatible with raw-index identity (ADR 1175),
...
This keeps raw-index identity stable (ADR 1175) and avoids cloning.
...
- ADR 1177: cache key + invalidation contract for dataset transform nodes.
