# ADR 0230: Router Route Hooks and `fret-query` Seam (v1)
...
- transitions and guard outcomes (ADR 0229)
...
- This is distinct from global guards (ADR 0229): global guards are coarse-grained policy; route
...
- If not, steps 2–3 may run post-navigation with a defined soft-block fallback (ADR 0229).
...
- Transitions/events/guards: `ecosystem/fret-router/src/router_state.rs` (ADR 0229)
