# ADR 0114: UiAssets Facade and Golden-Path Wiring (Images / SVGs)
...
`ecosystem/fret-ui-assets` (ADR 0108), but wiring is still easy to get wrong:
...
- Keep layering intact (ADR 0093 / ADR 0108):
...
- A global “everything crate” that pulls in all defaults (ADR 0108 rejects this).
