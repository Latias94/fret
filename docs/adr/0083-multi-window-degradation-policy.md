# ADR 0083: Multi-Window Degradation Policy (Logical Windows on Single-Window Platforms)
...
- Modal barriers and overlay roots remain correct within that OS window (ADR 0011 / ADR 0067 / ADR 0069).
