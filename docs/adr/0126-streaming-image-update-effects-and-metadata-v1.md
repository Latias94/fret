# ADR 0126: Streaming Image Update Effects and Metadata (v1)

Status: Proposed

## Context

ADR 0121 establishes that Fret supports streaming surfaces without owning decoding by providing a portable
`ImageId` update pathway. ADR 0123 adds upload budgets and backpressure.
...
- Streaming ingestion overview: `docs/adr/0121-streaming-images-and-video-surfaces.md`
...
Coalescing and backpressure must be deterministic (ADR 0121 / ADR 0123).
