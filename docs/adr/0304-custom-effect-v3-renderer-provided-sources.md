---
title: "ADR 0304: Custom Effect V3 (Renderer-provided Sources: Raw + Optional Pyramid)"
status: Draft
date: 2026-02-28
---
...
ADR 0303 extended the ceiling via CustomV2 by adding exactly one optional user image input (`ImageId` +
