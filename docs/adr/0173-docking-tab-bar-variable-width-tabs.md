---
title: "ADR 0173: Docking Tab Bar Variable-Width Tabs and Scroll Semantics"
---

# ADR 0173: Docking Tab Bar Variable-Width Tabs and Scroll Semantics
...
- ADR 0170: `docs/adr/0170-docking-tab-dnd-contract.md`
- ADR 0172: `docs/adr/0172-headless-dnd-v1-contract-surface.md`
...
Insertion uses the stable before/after semantic from ADR 0172:
