# ADR 0195: Web IME and Text Input Bridge (wasm, v1)
...
For a code editor surface that virtualizes visible rows (ADR 0190 / ADR 0192), the bridge MUST NOT
...
- ADR 0190 / ADR 0192: Windowed virtual surfaces and retained hosts (editor-scale virtualization)
- ADR 0093: Crate structure notes for wasm/web integration
