# ADR 1193: `delinea` Link Events for Domain Windows (P0)
...
- ADR 1191: multi-grid routing invariants.
...
Any cross-grid linking policy must be explicitly enabled (ADR 1191 section 5).
