# ADR 0186: macOS About Panel Effect

Status: Proposed

## Context

ADR 0185 defines how we model App menu conventions as command-driven menu items (e.g. `app.about`)
...
- ADR 0185: `docs/adr/0185-menu-roles-system-menus-and-os-actions.md`
