...
- `DrawOrder` non-semantic: `docs/adr/0082-draworder-is-non-semantic.md`
...
- Current renderer v2 "scene compiler" architecture: `docs/adr/0089-renderer-architecture-v2-scene-compiler.md`
...
The existing `SceneEncoding` cache (ADR 0089) remains valuable.
...
- Current Fret renderer v2 scene compiler ADR: `docs/adr/0089-renderer-architecture-v2-scene-compiler.md`
- Rendering refactor roadmap: `docs/renderer-refactor-roadmap.md`
