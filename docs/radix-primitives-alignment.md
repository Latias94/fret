...
| DismissableLayer | Escape / outside press dismissal hooks | Outside-press observer pass (ADR 0069) + key routing | `fret-ui-kit::primitives::dismissable_layer` + overlay policies | Supports branches + focus-outside dismissal via overlay orchestration |
