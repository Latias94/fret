...
| pagination | `pagination` | Present | In review | Root ownership aligns with upstream; list/listitem semantics added; audit: `docs/audits/shadcn-pagination.md`; gates: `ecosystem/fret-ui-shadcn/src/pagination.rs` |
