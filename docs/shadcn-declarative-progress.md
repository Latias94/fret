...
- Machine harness matrix as of 2026-05-26: 59 shadcn registry/non-registry surfaces tracked, 33
  component slices `regression_locked`, 1 component slice in `harness_hardening`, 20 implemented
