...
- Non-curated seams should stay explicit in app code: use `shadcn::raw::*` for surfaces such as
  `extras`, breadcrumb primitives, and low-level icon helpers instead of importing `fret_ui_shadcn::*`
  directly.
