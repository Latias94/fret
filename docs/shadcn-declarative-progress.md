...
- Machine harness matrix as of 2026-05-27: 59 shadcn registry/non-registry surfaces tracked, 49
  component slices `regression_locked`, 1 component slice in `harness_hardening`, 4 implemented
