...
- Keys referenced by tests: `244/448` (`54.5%`)
- Next P0 gaps: open-state date pickers with calendar dropdown caption (`calendar-23..30`, `calendar-32`) and `calendar-hijri`, then forms/field validation chrome and carousel.
