...
- MVP 52: Bridge component recipes to declarative props (e.g. `StyleRefinement` → `ContainerProps`/`RowProps`) to eliminate magic numbers in composable surfaces and keep Tailwind/shadcn semantics component-owned.
