...
- Current gap-closure source audit and prioritization lane:
  ...
  - Scope: rebase the Dear ImGui gap read from current source before any next fearless cleanup,
    product-chain work, perf-discipline work, or helper widening. Treat the old v2 parity audit as
    historical evidence unless this lane revalidates it.
...
- Maintenance umbrella for the remaining Dear ImGui-class maturity gap:
  ...
  - Current status: latest IMUI-side implementation slices are closed, but the umbrella is still
    not complete; keep execution in narrow owner lanes for real-host Wayland hand-feel, broader
    DevTools GUI productization, and broader perf attribution/smoothness.
...
- Closed narrow follow-on for IMUI editor `ColorEdit` alpha preview options:
...
- Closed narrow follow-on for IMUI editor `ColorEdit` drag/drop payload:
...
- Closed narrow follow-on for IMUI editor `ColorEdit` reference preview:
...
- Closed narrow follow-on for IMUI editor `ColorEdit` vertical AlphaBar:
...
- Closed narrow follow-on for IMUI editor `ColorEdit` HueWheel picker:
...
- Closed narrow follow-on for IMUI editor `ColorEdit` eyedropper request:
...
- Closed narrow follow-on for IMUI editor `ColorEdit` history swatches:
...
- Closed narrow follow-on for IMUI editor `ColorEdit` copy-as context menu:
...
- Closed narrow follow-on for IMUI editor `ColorEdit` popup split:
...
- Closed narrow follow-on for IMUI editor `ColorEdit` popup numeric split:
...
- Closed narrow follow-on for IMUI editor `ColorEdit` popup preview split:
...
- Closed narrow follow-on for IMUI editor `ColorEdit` popup swatches split:
...
- Closed narrow follow-on for IMUI debug draw Bezier primitives:
...
- Closed narrow follow-on for IMUI debug draw convex poly fill:
...
- Closed narrow follow-on for IMUI debug draw quad primitives:
...
- Closed narrow follow-on for IMUI debug draw ngon primitives:
...
- Closed narrow follow-on for IMUI debug draw ellipse primitives:
...
- Closed narrow follow-on for IMUI debug draw path builder:
...
- Closed narrow follow-on for IMUI debug draw path Bezier builder:
...
- Closed narrow follow-on for IMUI debug draw path arc builder:
...
- Closed narrow follow-on for IMUI debug draw path elliptical arc builder:
...
- Closed narrow follow-on for IMUI debug draw path rect builder:
...
- Closed narrow follow-on for IMUI debug draw concave polygon fill:
...
- Closed narrow follow-on for IMUI debug draw vertex-level quads:
...
- Closed narrow follow-on for IMUI debug draw channel splitting:
...
- Closed narrow follow-on for IMUI debug draw triangle mesh:
...
- Closed narrow follow-on for IMUI debug draw command metadata:
...
- Closed narrow follow-on for IMUI debug draw clip metadata:
...
- Closed narrow follow-on for IMUI debug draw cookbook proof:
...
- Closed narrow follow-on for IMUI debug draw diagnostics smoke:
...
- Closed narrow follow-on for IMUI debug draw response surface:
