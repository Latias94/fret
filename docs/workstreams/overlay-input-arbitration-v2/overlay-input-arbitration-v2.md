...
`docs/workstreams/input-dispatch-v2/input-dispatch-v2.md` (ADR 0218), and track overlay/pointer-occlusion specific
...
- TODO tracker (main): `docs/workstreams/overlay-input-arbitration-v2/overlay-input-arbitration-v2-todo.md`
- Worktree tracker (input-dispatch-v2 branches): `docs/workstreams/overlay-input-arbitration-v2/overlay-input-arbitration-v2-todo-input-dispatch-v2.md`
...
- `docs/workstreams/overlay-input-arbitration-v2/overlay-input-arbitration-v2-todo.md` (main)
- `docs/workstreams/overlay-input-arbitration-v2/overlay-input-arbitration-v2-todo-input-dispatch-v2.md` (input-dispatch-v2 branches)
