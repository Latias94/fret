...
- M0 lock details are normative in `docs/workstreams/imui-ecosystem-facade-v2/imui-ecosystem-facade-v2-m0-contracts.md`.
...
- M1 response partition and compatibility policy are normative in `docs/workstreams/imui-ecosystem-facade-v2/imui-ecosystem-facade-v2-m1-response-stability.md`.
...
- M2 adapter seam contract and template are normative in `docs/workstreams/imui-ecosystem-facade-v2/imui-ecosystem-facade-v2-m2-adapter-seam.md`.
