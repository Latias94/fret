...
- [x] IMUIECO2-scope-000 Capture v1 frozen baseline and change policy.
  - Evidence: `docs/workstreams/imui-ecosystem-facade-v2/imui-ecosystem-facade-v2-m0-contracts.md` (sections 1 and 2).
- [x] IMUIECO2-scope-001 Define "breaking response behavior" criteria.
  - Evidence: `docs/workstreams/imui-ecosystem-facade-v2/imui-ecosystem-facade-v2-m0-contracts.md` (section 3).
- [x] IMUIECO2-docs-002 Publish wrapper contribution checklist (tests + docs + delegation evidence).
  - Evidence: `docs/workstreams/imui-ecosystem-facade-v2/imui-ecosystem-facade-v2-m0-contracts.md` (sections 4 and 5).
...
- [x] IMUIECO2-resp-010 Define stable-core candidate response fields.
  - Evidence: `docs/workstreams/imui-ecosystem-facade-v2/imui-ecosystem-facade-v2-m1-response-stability.md` (section 1).
- [x] IMUIECO2-resp-011 Define compatibility/deprecation policy for stable core.
  - Evidence: `docs/workstreams/imui-ecosystem-facade-v2/imui-ecosystem-facade-v2-m1-response-stability.md` (sections 2 and 3).
...
- [x] IMUIECO2-adapter-020 Specify minimal signal reporter/delegation contract.
  - Evidence: `docs/workstreams/imui-ecosystem-facade-v2/imui-ecosystem-facade-v2-m2-adapter-seam.md` (section 1).
...
- [x] IMUIECO2-adapter-021 Add one adapter template doc for external widget crates.
  - Evidence: `docs/workstreams/imui-ecosystem-facade-v2/imui-ecosystem-facade-v2-m2-adapter-seam.md` (section 2).
...
- [x] IMUIECO2-float-030 Improve popup/select wrapper choreography under adapter-first rules.
  - Evidence: `docs/workstreams/imui-ecosystem-facade-v2/imui-ecosystem-facade-v2-m3-popup-floating-polish.md` (section 1).
...
- [x] IMUIECO2-perf-040 Convert perf guide into review checklist items.
  - Evidence: `docs/workstreams/imui-ecosystem-facade-v2/imui-ecosystem-facade-v2-m4-perf-gates.md` (section 1).
...
- [x] IMUIECO2-scope-050 Re-audit layering boundaries and dependency ownership.
  - Evidence: `docs/workstreams/imui-ecosystem-facade-v2/imui-ecosystem-facade-v2-m5-readiness-review.md` (section 1).
...
- [x] IMUIECO2-docs-051 Publish v2 stable subset + deferred backlog.
  - Evidence: `docs/workstreams/imui-ecosystem-facade-v2/imui-ecosystem-facade-v2-m5-readiness-review.md` (sections 2 and 3).
