...
- Text undo/redo alias:
  `docs/workstreams/code-editor-public-api-and-architecture-v1/M1_TEXT_UNDO_REDO_ALIAS_2026-05-12.md`
...
- Geometry test module split:
  `docs/workstreams/code-editor-public-api-and-architecture-v1/M3_TEST_GEOMETRY_MODULE_SPLIT_2026-05-12.md`
- Row-text cache test module split:
  `docs/workstreams/code-editor-public-api-and-architecture-v1/M3_TEST_ROW_TEXT_CACHE_MODULE_SPLIT_2026-05-12.md`
- Accessibility test module split:
  `docs/workstreams/code-editor-public-api-and-architecture-v1/M3_TEST_ACCESSIBILITY_MODULE_SPLIT_2026-05-12.md`
- Platform text input test module split:
...
- Pointer selection test module split:
  `docs/workstreams/code-editor-public-api-and-architecture-v1/M3_TEST_POINTER_SELECTION_MODULE_SPLIT_2026-05-12.md`
- Word navigation test module split:
...
- Preedit paint test module split:
  `docs/workstreams/code-editor-public-api-and-architecture-v1/M3_TEST_PREEDIT_PAINT_MODULE_SPLIT_2026-05-12.md`
- Display navigation test module split:
  `docs/workstreams/code-editor-public-api-and-architecture-v1/M3_TEST_DISPLAY_NAVIGATION_MODULE_SPLIT_2026-05-12.md`
- Row geometry cache test module split:
...
- Residual test owner closure:
  `docs/workstreams/code-editor-public-api-and-architecture-v1/M3_TEST_OWNER_RESIDUAL_CLOSURE_2026-05-12.md`
...
- Paint row-text cache module split:
  `docs/workstreams/code-editor-public-api-and-architecture-v1/M3_PAINT_ROW_TEXT_CACHE_MODULE_SPLIT_2026-05-12.md`
- Paint row-geom cache module split:
  `docs/workstreams/code-editor-public-api-and-architecture-v1/M3_PAINT_ROW_GEOM_CACHE_MODULE_SPLIT_2026-05-12.md`
- Paint row-rich module split:
  `docs/workstreams/code-editor-public-api-and-architecture-v1/M3_PAINT_ROW_RICH_MODULE_SPLIT_2026-05-12.md`
...
- Paint row-text owner: `ecosystem/fret-code-editor/src/editor/paint/text.rs`
- Paint row-geom cache owner: `ecosystem/fret-code-editor/src/editor/paint/geom_cache.rs`
- Paint row-rich owner: `ecosystem/fret-code-editor/src/editor/paint/rich.rs`
...
- Syntax prefetch runtime owner: `ecosystem/fret-code-editor/src/editor/syntax.rs`
