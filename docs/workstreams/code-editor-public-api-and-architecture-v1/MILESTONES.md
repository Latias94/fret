...
- Debug-only APIs are either clearly named as debug/staging or moved away from the default public
  ...
  - Module/test ownership improves without changing behavior. (First test split landed in
    ...
    moved in `M3_TEST_PLATFORM_TEXT_INPUT_ROUNDTRIP_MODULE_SPLIT_2026-05-12.md`; pointer helper
    ...
    in `M3_TEST_KEYBOARD_COMMANDS_MODULE_SPLIT_2026-05-12.md`; preedit rich-text paint tests moved
    ...
    `M3_TEST_SCROLL_WINDOW_MODULE_SPLIT_2026-05-12.md`; remaining syntax-window, paint-guard,
    fold-lifecycle, and edit-refresh tests moved in
    `M3_TEST_OWNER_RESIDUAL_CLOSURE_2026-05-12.md`; feature payload store/snapshot split landed in
