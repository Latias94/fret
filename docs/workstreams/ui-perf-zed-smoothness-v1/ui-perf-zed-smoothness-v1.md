...
- Editor resize jitter improvements (wrap-width small-step policy widened):
  - `docs/workstreams/ui-perf-zed-smoothness-v1/ui-perf-zed-smoothness-v1-log.md` entry `2026-02-09 22:54:20` (commit `53aa6534a`).
...
- ensure text atlas behavior has clear budgets and eviction is visible in perf snapshots.
  - Status: implemented in diagnostics bundles + `fretboard` sort modes; see `docs/workstreams/ui-perf-zed-smoothness-v1/ui-perf-zed-smoothness-v1-log.md`.
