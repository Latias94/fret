...
1. add an entry in `docs/workstreams/ui-perf-zed-smoothness-v1/ui-perf-zed-smoothness-v1-log.md` with:
   - commit hash
   - exact command(s)
   - baseline/validation paths
   - delta summary (what tightened/loosened and why)
2. update `docs/workstreams/ui-perf-zed-smoothness-v1/ui-perf-zed-smoothness-v1-todo.md` checkboxes.
