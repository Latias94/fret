...
- Web demo (inspector harness): `apps/fret-examples/src/custom_effect_v2_web_demo.rs` (run via
  ...
  `cargo run -p fretboard-dev -- dev web --demo custom_effect_v2_web_demo`).
  - Note: `fretboard-dev dev web` opens the browser by default; use `--no-open` to disable.
  ...
  `cargo run -p fretboard-dev -- dev web --demo custom_effect_v2_identity_web_demo`).
...
- Web demo (LUT template): `apps/fret-examples/src/custom_effect_v2_lut_web_demo.rs` (run via
  ...
  `cargo run -p fretboard-dev -- dev web --demo custom_effect_v2_lut_web_demo`).
...
- Web demo (glass/chrome template): `apps/fret-examples/src/custom_effect_v2_glass_chrome_web_demo.rs` (run via
  ...
  `cargo run -p fretboard-dev -- dev web --demo custom_effect_v2_glass_chrome_web_demo`).
