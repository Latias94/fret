...
| HoverCard | Radix | `ecosystem/fret-ui-kit/src/primitives/hover_card.rs` | `ecosystem/fret-ui-shadcn/src/hover_card.rs` | - | - | I | I | I | - | - | I | I | G | Audit sheet: `docs/workstreams/primitives-interaction-semantics-alignment-v1-hover-card.md`. Diag gate: `tools/diag-scripts/ui-gallery-hovercard-hover-delayed-close.json`. |
...
| Dialog | Radix | `ecosystem/fret-ui-kit/src/primitives/dialog.rs` | `ecosystem/fret-ui-shadcn/src/dialog.rs` | - | - | I | I | I | - | - | I | - | I | Audit sheet: `docs/workstreams/primitives-interaction-semantics-alignment-v1-dialog.md`. Dismiss + close auto-focus is now reason-aware (`dialog_close_auto_focus_guard_hooks`); gate barrier + escape + restore. |
