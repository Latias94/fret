...
| --- | --- | --- | --- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | --- |
| Select | Radix | `ecosystem/fret-ui-kit/src/primitives/select.rs` | `ecosystem/fret-ui-shadcn/src/select.rs` | M | I | I | I | I | I | I | I | M | G | Audit sheet: `docs/workstreams/primitives-interaction-semantics-alignment-v1-select.md`. Anti-misclick knobs are now explicit (`SelectMousePolicies`); next: add optional cancel-open-on-mouseup-outside. |
...
| DropdownMenu | Radix | `ecosystem/fret-ui-kit/src/primitives/dropdown_menu.rs` | `ecosystem/fret-ui-shadcn/src/dropdown_menu.rs` | M | I | I | I | I | I | - | I | I | G | Audit sheet: `docs/workstreams/primitives-interaction-semantics-alignment-v1-dropdown-menu.md`. Diag gates: `tools/diag-scripts/ui-gallery-dropdown-submenu-safe-corridor-sweep.json`, `tools/diag-scripts/ui-gallery-dropdown-submenu-arrowleft-escape-close.json`. |
| ContextMenu | Radix | `ecosystem/fret-ui-kit/src/primitives/context_menu.rs` | `ecosystem/fret-ui-shadcn/src/context_menu.rs` | - | - | I | I | I | I | - | I | I | G | Audit sheet: `docs/workstreams/primitives-interaction-semantics-alignment-v1-context-menu.md`. Diag gates: `tools/diag-scripts/ui-gallery-context-menu-overlay-right-click-open-close.json`, `tools/diag-scripts/ui-gallery-context-menu-submenu-safe-corridor-sweep.json`. |
...
| NavigationMenu | Radix | `ecosystem/fret-ui-kit/src/primitives/navigation_menu.rs` | `ecosystem/fret-ui-shadcn/src/navigation_menu.rs` | - | - | I | I | - | - | - | I | I | G | Audit sheet: `docs/workstreams/primitives-interaction-semantics-alignment-v1-navigation-menu.md`. Uses popover close auto-focus guard for click-through dismiss; diag gates: `tools/diag-scripts/ui-gallery-navigation-menu-hover-switch-and-escape.json`, `tools/diag-scripts/ui-gallery-navigation-menu-docs-layout-smoke.json`, `tools/diag-scripts/ui-gallery-navigation-menu-viewport-fixed-frame-delta.json`. |
| Tooltip | Radix | `ecosystem/fret-ui-kit/src/primitives/tooltip.rs` | `ecosystem/fret-ui-shadcn/src/tooltip.rs` | M | I | I | I | I | - | - | I | I | G | Audit sheet: `docs/workstreams/primitives-interaction-semantics-alignment-v1-tooltip.md`. Diag gates: `tools/diag-scripts/ui-gallery-tooltip-repeat-hover.json`, `tools/diag-scripts/ui-gallery-tooltip-delay-group-skip-delay.json`. |
| HoverCard | Radix | `ecosystem/fret-ui-kit/src/primitives/hover_card.rs` | `ecosystem/fret-ui-shadcn/src/hover_card.rs` | - | - | I | I | I | - | - | I | I | G | Audit sheet: `docs/workstreams/primitives-interaction-semantics-alignment-v1-hover-card.md`. Diag gates: `tools/diag-scripts/ui-gallery-hovercard-hover-delayed-close.json`, `tools/diag-scripts/ui-gallery-hover-card-trigger-delays.json`. |
| Popover | Radix | `ecosystem/fret-ui-kit/src/primitives/popover.rs` | `ecosystem/fret-ui-shadcn/src/popover.rs` | - | - | I | I | - | - | - | I | - | G | Audit sheet: `docs/workstreams/primitives-interaction-semantics-alignment-v1-popover.md`. Diag gate: `tools/diag-scripts/ui-gallery-popover-click-through-outside-press-focus-underlay.json`. |
| Dialog | Radix | `ecosystem/fret-ui-kit/src/primitives/dialog.rs` | `ecosystem/fret-ui-shadcn/src/dialog.rs` | - | - | I | I | I | - | - | I | - | G | Audit sheet: `docs/workstreams/primitives-interaction-semantics-alignment-v1-dialog.md`. Dismiss + close auto-focus is now reason-aware (`dialog_close_auto_focus_guard_hooks`); gate barrier + escape + restore. |
...
| Sheet | Radix (Dialog) | `ecosystem/fret-ui-kit/src/primitives/dialog.rs` | `ecosystem/fret-ui-shadcn/src/sheet.rs` | - | - | I | I | I | - | - | I | I | G | Audit sheet: `docs/workstreams/primitives-interaction-semantics-alignment-v1-sheet.md`. Uses dialog close auto-focus guard hooks; diag gate: `tools/diag-scripts/ui-gallery-sheet-escape-focus-restore.json`. |
