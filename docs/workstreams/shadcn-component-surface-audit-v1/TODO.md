...
| `data-table` | `repo-ref/ui/apps/v4/content/docs/components/radix/data-table.mdx` | (docs-only) | `ecosystem/fret-ui-shadcn/src/data_table.rs` | `ecosystem/fret-ui-shadcn/tests/data_table_toolbar_faceted_responsive.rs`, `ecosystem/fret-ui-shadcn/tests/web_vs_fret_layout/table.rs` | In progress |
