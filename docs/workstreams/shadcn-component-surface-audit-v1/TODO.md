...
| `data-table` | `repo-ref/ui/apps/v4/content/docs/components/radix/data-table.mdx` | (docs-only) | `ecosystem/fret-ui-shadcn/src/data_table.rs` | `ecosystem/fret-ui-shadcn/tests/data_table_row_click_selection.rs`, `ecosystem/fret-ui-shadcn/tests/data_table_row_range_selection.rs`, `ecosystem/fret-ui-shadcn/tests/data_table_column_actions_menu.rs`, `ecosystem/fret-ui-shadcn/tests/data_table_pagination.rs`, `ecosystem/fret-ui-shadcn/tests/data_table_pagination_page_size.rs`, `ecosystem/fret-ui-shadcn/tests/data_table_toolbar_faceted_responsive.rs`, `ecosystem/fret-ui-shadcn/tests/data_table_toolbar_global_filter.rs`, `ecosystem/fret-ui-shadcn/tests/web_vs_fret_layout/table.rs` | In progress |
...
| `table` | `repo-ref/ui/apps/v4/content/docs/components/radix/table.mdx` | `repo-ref/ui/apps/v4/registry/bases/radix/ui/table.tsx` | `ecosystem/fret-ui-shadcn/src/table.rs` | `ecosystem/fret-ui-shadcn/tests/web_vs_fret_layout/table.rs` | In progress |
