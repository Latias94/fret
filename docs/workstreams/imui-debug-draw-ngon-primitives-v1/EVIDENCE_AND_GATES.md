# ImUi Debug Draw Ngon Primitives v1 Evidence And Gates
...
- `repo-ref/imgui/imgui.h`: `ImDrawList::AddNgon` and `ImDrawList::AddNgonFilled`.
- `repo-ref/imgui/imgui_draw.cpp`: Dear ImGui lowers ngons through path stroke/fill helpers.
...
python -m json.tool docs/workstreams/imui-debug-draw-ngon-primitives-v1/WORKSTREAM.json
