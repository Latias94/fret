# M22 Local Wayland Guard Refresh - 2026-05-31

Status: local guard refresh; no Wayland acceptance claim.

This note records the 2026-05-31 Windows-local continuation check for the remaining
...
3. Confident: refreshing the guard note and source markers is the right local action because there
   was no qualifying Wayland compositor available in this environment.
...
- `imui-p3-wayland-real-host` campaign validation: pass; campaign count 1 and still requires Linux
...
- `fret-launch` Linux windowing capability posture: pass; 2 tests passed, 94 skipped.
- `fret-docking` fallback behavior: pass; 1 test passed, 86 skipped.
