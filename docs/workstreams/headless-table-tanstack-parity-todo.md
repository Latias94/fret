...
- Step 1: Close grouped placeholder/aggregated cell inventory parity (`HTP-grp-010`).
...
- HTP-grp-010: complete grouped placeholder/aggregated cell inventories for deep nesting cases.
