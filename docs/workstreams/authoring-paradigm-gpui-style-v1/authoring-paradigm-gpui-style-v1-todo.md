...
- Workstream: `docs/workstreams/authoring-paradigm-gpui-style-v1/authoring-paradigm-gpui-style-v1.md`
- State management workstream: `docs/workstreams/state-management-v1/state-management-v1.md`
...
- `[x]` Add a workstream plan doc and a milestone tracker.
  - Evidence: `docs/workstreams/authoring-paradigm-gpui-style-v1/authoring-paradigm-gpui-style-v1.md`
  - Evidence: `docs/workstreams/authoring-paradigm-gpui-style-v1/authoring-paradigm-gpui-style-v1-todo.md`
...
- `[x]` Document the current guidance for dynamic item intents in cached subtrees.
  ...
  - Evidence: `docs/workstreams/state-management-v1/state-management-v1.md`
