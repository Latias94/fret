...
- Overview: `docs/workstreams/motion-foundation-v1/motion-foundation-v1.md`
- Task list: `docs/workstreams/motion-foundation-v1/motion-foundation-v1-todo.md`
...
- `docs/workstreams/motion-foundation-v1/motion-foundation-v1.md` (section "Recipe alignment matrix (draft)")
- `tools/diag-scripts/ui-gallery-sidebar-toggle-fixed-frame-delta.json`
...
- `docs/workstreams/motion-foundation-v1/motion-foundation-v1.md` (section "Token taxonomy (v1; conventions we can keep stable)")
- `docs/workstreams/motion-foundation-v1/motion-foundation-v1.md` (section "Pragmatic mapping table (shadcn numeric durations ↔ M3 duration tokens)")
- `ecosystem/fret-ui-kit/src/declarative/overlay_motion.rs`
...
- Layout strategy doc (explicit choreography, no generic FLIP layer): `docs/workstreams/motion-foundation-v1/motion-foundation-v1.md` (section "Layout-affecting motion (v1)")
