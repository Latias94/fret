...
- `docs/workstreams/motion-foundation-v1/motion-foundation-v1-milestones.md`
...
- [x] MF-MOTION-spring-001 Decide the public theme-facing spring token shape (ecosystem-level).
  ...
  - Evidence:
    - `docs/workstreams/motion-foundation-v1/motion-foundation-v1.md` (section "Spring tokens (v1)")
...
- [x] MF-MOTION-spring-002 Add a small “spring cookbook” section with recommended presets.
  ...
  - Evidence:
    - `docs/workstreams/motion-foundation-v1/motion-foundation-v1.md` (section "Spring cookbook (starter presets; tune with diag gates)")
...
- [x] MF-MOTION-layout-001 Choose and document the layout transition strategy (FLIP-like vs explicit choreography).
  ...
  - Evidence:
    - `docs/workstreams/motion-foundation-v1/motion-foundation-v1.md` (section "Layout-affecting motion (v1)")
