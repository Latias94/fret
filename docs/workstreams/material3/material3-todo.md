...
- `docs/workstreams/material3-expressive-alignment-v1/material3-expressive-alignment-v1-milestones.md`
...
Status: Complete (MVP landed; follow-ups tracked in `docs/workstreams/material3/material3-next-wave-v2.md`)
...
- Plan: `docs/workstreams/material3/material3-refactor-plan.md`
- Style API alignment (cross-ecosystem interfaces): `docs/workstreams/material3/material3-style-api-alignment-v1.md`
...
- Post-MVP next wave: `docs/workstreams/material3/material3-next-wave-v2.md`
...
- [x] Align core Material 3 components with the ecosystem `*Style` override surface (ADR 0220).
  - Evidence: `docs/workstreams/material3/material3-style-api-alignment-v1.md`,
