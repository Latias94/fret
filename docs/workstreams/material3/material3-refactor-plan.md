...
Status: Complete (foundation landed; migration complete; follow-ups tracked in `docs/workstreams/material3/material3-next-wave-v2.md`)

This document is the **execution plan** for a “fearless refactor” of Material 3 alignment in Fret.
It complements `docs/workstreams/material3/material3-todo.md`, which remains the broader tracking checklist.
...
- State-driven style resolution v1: `docs/workstreams/standalone/state-driven-style-resolution-v1.md`
...
- [x] Decide the public surface for hoisted interaction sources (if any).
  ...
  - Evidence: `docs/workstreams/material3/material3-todo.md` (Material Foundation Backlog decision),
