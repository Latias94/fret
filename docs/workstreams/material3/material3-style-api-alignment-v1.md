...
- [x] Choose (B): keep `docs/workstreams/standalone/state-driven-style-resolution-v1.md` focused on cross-ecosystem primitives; track Material 3 consumer alignment here.
