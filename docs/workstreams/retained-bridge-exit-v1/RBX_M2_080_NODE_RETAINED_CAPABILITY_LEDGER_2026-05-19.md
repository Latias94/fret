...
1. Continue `RBX-M2-100`/`RBX-M2-105`-style overlay slices: replace retained widget composition
   with declarative elements for minimap, toolbars, and rename, then backfill default
   interaction/focus/paint parity for blackboard and controls before deleting their retained
   oracles.
