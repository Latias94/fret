...
- `docs/workstreams/editor-ecosystem-fearless-refactor-v1/` — first 2026-03-09, latest 2026-05-12, 11 markdown docs (active editor ecosystem orchestration lane; includes `WORKSTREAM.json`)
