...
- `docs/workstreams/editor-canvas-paint-replay-canvas-exclusive-v1/` — first n/a, latest n/a, 6 markdown docs (active follow-on for remaining Canvas exclusive / paint.widget overhead after r65 kept owner=canvas-paint-replay; includes `WORKSTREAM.json`)
- `docs/workstreams/editor-canvas-paint-replay-fast-path-v1/` — first n/a, latest n/a, 6 markdown docs (closed implementation follow-on for no-overlay planned row-scene replay fast return after r65 kept owner=canvas-paint-replay; includes `WORKSTREAM.json`)
...
- `docs/workstreams/fret-node-architecture-fearless-refactor-v2/` — first 2026-05-28, latest 2026-05-28, 5 markdown docs (closed architecture lane that deepened mutation, store, state, patch, canvas, and test seams while deleting historical compatibility where proven; includes `WORKSTREAM.json`)
...
- `docs/workstreams/fret-node-paint-root-cached-edge-fallback-adapter-v1/` — first n/a, latest n/a, 6 markdown docs (closed narrow follow-on that isolated node graph paint-root cached edge fallback route inputs behind an adapter seam; includes `WORKSTREAM.json`)
- `docs/workstreams/fret-node-paint-root-cached-edge-key-helper-v1/` — first n/a, latest n/a, 6 markdown docs (closed narrow follow-on that isolated node graph paint-root cached edge key shared field writes behind a helper seam; includes `WORKSTREAM.json`)
...
- `docs/workstreams/fret-node-paint-root-cached-edge-overlay-adapter-v1/` — first n/a, latest n/a, 6 markdown docs (closed narrow follow-on that isolated node graph paint-root cached edge selected/hovered overlay routing behind an adapter seam; includes `WORKSTREAM.json`)
...
- `docs/workstreams/fret-node-paint-root-frame-background-adapter-v1/` — first n/a, latest n/a, 6 markdown docs (closed narrow follow-on that isolated node graph paint-root frame background scene quad emission behind a minimal adapter seam; includes `WORKSTREAM.json`)
...
- `docs/workstreams/fret-node-paint-root-frame-diagnostics-adapter-v1/` — first n/a, latest n/a, 6 markdown docs (closed narrow follow-on that isolated node graph paint-root frame path-cache diagnostics recording behind a minimal adapter seam; includes `WORKSTREAM.json`)
...
- `docs/workstreams/fret-node-runtime-store-contract-closure-v1/` — first 2026-05-26, latest 2026-05-27, 7 markdown docs (closed runtime/store closure lane for the node graph binding/controller/store contract; includes `WORKSTREAM.json`)
...
- `docs/workstreams/imui-demo-metrics-debug-action-metadata-v1/` — first n/a, latest n/a, 7 markdown docs (closed follow-on for stable Demo/Metrics/Debug route action metadata and DevTools readiness projection without widening `fret-imui`)
...
- `docs/workstreams/material3-visual-behavior-layout-parity-v2/` — first 2026-05-28, latest 2026-05-28, 5 markdown docs (closed fearless-refactor lane for shadcn-level Material3 style/behavior/layout parity axes, v2 matrix, and bounded packet gates; includes `WORKSTREAM.json`)
...
- `docs/workstreams/material3-radio-scene-semantics-packet-v1/` — first 2026-05-28, latest 2026-05-28, 8 markdown docs (closed follow-on for Material3 Radio selector, dot-geometry, ripple-origin, pressed-scene, and recipe/foundation boundary evidence; includes `WORKSTREAM.json`)
