...
- `docs/workstreams/iconify-import-pack-generator-v1/` — first n/a, latest n/a, 9 markdown docs (active follow-on; M1 producer contract frozen, the M2 SVG-directory proof and M4 local Iconify snapshot proof have landed for build-time generated third-party icon-pack crates against the shipped v1 icon contract, and public semantic alias config remains open)
