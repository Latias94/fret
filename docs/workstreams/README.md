...
- `docs/workstreams/editor-canvas-paint-replay-fast-path-v1/` — first n/a, latest n/a, 5 markdown docs (active implementation follow-on for no-overlay planned row-scene replay fast return after r64 kept owner=canvas-paint-replay; includes `WORKSTREAM.json`)
