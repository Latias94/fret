...
- [~] HP-DL-fb-001 Define a single fallback ladder and make it explicit in logs.
  - Evidence: `docs/workstreams/hotpatch-devloop-alignment-v1/hotpatch-devloop-alignment-v1.md` (section 4.3)
...
- [x] HP-DL-theme-001 Define a theme reload contract (data source, watcher, safe apply boundary).
  - Evidence: `docs/workstreams/hotpatch-devloop-alignment-v1/hotpatch-devloop-alignment-v1.md` (section 4.2), `ecosystem/fret-bootstrap/src/dev_reload.rs`
...
- [x] HP-DL-asset-001 Asset invalidation + redraw contract (svg/png/fonts).
  - Evidence: `docs/workstreams/hotpatch-devloop-alignment-v1/hotpatch-devloop-alignment-v1.md` (section 4.2), `crates/fret-runtime/src/asset_reload.rs`
