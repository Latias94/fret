# ImUi Models Text Mode Test Split v1 Evidence And Gates
...
- `docs/workstreams/imui-models-text-filter-test-split-v1/CLOSEOUT_AUDIT_2026-05-04.md`: previous
...
cargo nextest run -p fret-imui models_text_modes --no-fail-fast
cargo nextest run -p fret-imui models_text --no-fail-fast
python tools/check_layering.py
python tools/check_workstream_catalog.py
python -m json.tool docs/workstreams/imui-models-text-mode-test-split-v1/WORKSTREAM.json
