...
| Docking UX polish | ImGui docking demo parity | `DockSpace`, docking flags | Tab labels + close/overflow icons are painted and more robust against theme padding misconfig | Still needs: better hit targets, overflow menu polish, and tab chrome parity | `fret-docking` (policy) | P0/P1 |
