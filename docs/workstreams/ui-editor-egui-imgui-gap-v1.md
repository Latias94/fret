...
| Docking UX polish | ImGui docking demo parity | `DockSpace`, docking flags | Fret has ecosystem docking + proof demo | Needs: stable tab labels, close buttons/icons, overflow menu polish, drag affordances, better hit targets | `fret-docking` (policy) | P0/P1 |
