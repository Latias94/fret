...
- `docs/workstreams/ui-perf-paint-pass-breakdown-v1/ui-perf-paint-pass-breakdown-v1.md`
...
- [ ] Remove per-frame allocations in the `ElementHostWidget` paint path.
  ...
  - Evidence target: `docs/workstreams/ui-perf-zed-smoothness-v1/ui-perf-zed-smoothness-v1-log.md` entry 2026-02-05 20:03 (commit `e1132c95`).
