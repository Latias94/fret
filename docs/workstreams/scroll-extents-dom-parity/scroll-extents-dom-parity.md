...
- `docs/workstreams/standalone/ui-gallery-perf-scroll-measure.md`
...
Short-term mitigation (experimental; evidence tracked in `docs/workstreams/standalone/ui-gallery-perf-scroll-measure.md`):
...
- `docs/workstreams/scroll-extents-dom-parity/scroll-extents-dom-parity-todo.md`
