...
| Layout dirty invalidation | child dirty aggregation, suppressed child boundary, subtree removal, underflow repair, visible sibling preservation | `crates/fret-ui/src/tree/tests/fixtures/layout_dirty_invalidation_v1.json` | `tools/diag-scripts/ui-gallery/checkbox/ui-gallery-checkbox-demo-with-title-toggle-underflow.json` | Add retained/declarative cache root transitions, scroll-contained dirty frontiers, and view-cache root detach cases. |
