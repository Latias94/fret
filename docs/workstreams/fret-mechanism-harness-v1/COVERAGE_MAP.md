...
| Focus | basic observed focus predicates, tree-level focus barrier routing, hit-test-inert focus barriers, modal focus barrier reporting, focus traversal inside focus barriers | `crates/fret-mechanism-harness/src/oracle.rs`; `crates/fret-ui/src/tree/tests/fixtures/focus_barrier_routing_v1.json` | focused gates in `crates/fret-ui/src/tree/tests/focus_barrier_transition.rs`, `crates/fret-ui/src/tree/tests/focus_scope.rs`, and `crates/fret-ui/src/tree/tests/focus_scope_layered.rs` | Add fixture-driven declarative focus scope, focus restore, roving focus, active-descendant, and UI Gallery overlay/focus diagnostics gates. |
