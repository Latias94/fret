# Renderer Render Plan Postprocess Owner v1 - TODO

Status: Closed
Last updated: 2026-05-18

## M0 - Move Postprocess Helpers

- [x] RPPO-010 [owner=codex] [deps=none] [scope=crates/fret-render-wgpu/src/renderer/render_plan]
  Goal: Move debug postprocess lowering helpers out of `render_plan.rs` into a sibling postprocess
  owner module.
  ...
  Evidence: native, release, and wasm compile gates pass with the postprocess owner split.
  Status: Done on 2026-05-18.

## M1 - Catalog And Boundary Guardrails

- [x] RPPO-020 [owner=codex] [deps=RPPO-010] [scope=docs/workstreams,tools/check_layering.py]
