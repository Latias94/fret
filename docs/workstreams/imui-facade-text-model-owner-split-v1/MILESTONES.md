# ImUi Facade Text Model Owner Split v1 - Milestones
...
- The source owner risk is scoped to the text model wrapper cluster.
...
- `facade_writer/text_models.rs` owns the moved inherent wrappers.
...
Result: done in `M1_TEXT_MODEL_FACADE_OWNER_SPLIT_2026-05-13.md`.
