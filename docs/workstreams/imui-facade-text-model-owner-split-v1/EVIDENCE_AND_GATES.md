# ImUi Facade Text Model Owner Split v1 - Evidence & Gates

Goal: move text and textarea model facade wrappers behind a private owner while preserving public
IMUI API and behavior.
...
- `python -m json.tool docs/workstreams/imui-facade-text-model-owner-split-v1/WORKSTREAM.json`
