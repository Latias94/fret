...
- `docs/workstreams/standalone/imui-imgui-parity-audit-v1.md` (behavior-focused parity audit notes)
...
see: `docs/workstreams/standalone/imui-imgui-parity-audit-v1.md` (section `1.1`).
