...
- Design note: `docs/workstreams/authoring-ergonomics-fluent-builder/authoring-ergonomics-fluent-builder.md`
...
- [x] AUE-surface-030 Decide whether `ecosystem/fret-ui-kit/src/styled.rs` should be:
  ...
  - Evidence: `docs/workstreams/authoring-ergonomics-fluent-builder/authoring-ergonomics-fluent-builder.md`
