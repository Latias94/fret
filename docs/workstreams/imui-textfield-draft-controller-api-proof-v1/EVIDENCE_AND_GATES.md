...
- The source-policy gate now lives in `python tools/gate_imui_workstream_source.py` after the
  build-latency source-gate migration moved the closed source freeze out of `fret-examples` Rust
  unit tests.
