...
| 2 | `AppActivateExt` bridge retirement | explicit bridge residue should keep shrinking while native widget action slots expand and extracted `UiCx` helpers stay on grouped `cx.actions()` instead of reintroducing bridge pressure |
