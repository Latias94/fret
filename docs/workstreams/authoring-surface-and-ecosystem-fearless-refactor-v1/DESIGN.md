...
- `FretApp::setup(install_app)` for named installer functions, small tuples, and reusable bundles
- `UiAppBuilder::setup_with(|app| ...)` only for explicit one-off inline closures or captured
  runtime values
