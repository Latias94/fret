...
See:
- Workstream overview: `docs/workstreams/foreground-inheritance-late-binding-v2.md`
...
| Deprecate/phase out v1 provider APIs in authoring docs | `docs/` | P2 | Not started | `docs/workstreams/current-color-inheritance-fearless-refactor-v1.md` |
