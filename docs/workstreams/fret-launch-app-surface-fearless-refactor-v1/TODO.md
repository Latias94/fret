...
- [ ] Migrate the remaining heavy direct `WinitAppDriver` example impls (`components_gallery`, `gizmo3d_demo`, `node_graph_domain_demo`, `node_graph_legacy_demo`) after their local harness glue is split into reviewable free-hook helpers.
