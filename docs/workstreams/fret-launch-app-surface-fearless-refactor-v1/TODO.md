...
- [x] Migrate representative launch examples from direct `WinitAppDriver` impls to `FnDriver` (`chart_demo`, `bars_demo`, `error_bars_demo`, `area_demo`, `candlestick_demo`, `grouped_bars_demo`, `stacked_bars_demo`).
