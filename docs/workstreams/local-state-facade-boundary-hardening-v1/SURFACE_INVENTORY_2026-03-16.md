...
| `use_local*`, `watch_local(...)`, `TrackedStateExt`, `cx.actions().locals::<A>(...)` | Public and already taught in docs/templates/examples | Default app lane | This is the shipped default local-state contract | Keep as the only default story |
