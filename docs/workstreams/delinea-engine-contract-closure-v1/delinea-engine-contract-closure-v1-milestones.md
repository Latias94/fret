...
Source of truth for detailed TODOs: `docs/workstreams/delinea-engine-contract-closure-v1/delinea-engine-contract-closure-v1-todo.md`.
Narrative + scope: `docs/workstreams/delinea-engine-contract-closure-v1/delinea-engine-contract-closure-v1.md`.
...
- ensure the linking `fretboard-dev diag` script remains runnable after refactors and `main` syncs
