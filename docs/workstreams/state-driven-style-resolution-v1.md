...
- SDSR-020: `docs/shadcn-style-override-patterns.md` + exported `*Style` structs in `ecosystem/fret-ui-shadcn/src/{button,checkbox,radio_group,switch,toggle,tabs,input}.rs`
