...
- `docs/workstreams/image-support-v1/image-support-v1.md` (broader image surface: fit semantics, metadata, caching)
- `docs/workstreams/query-lifecycle-v1/query-lifecycle-v1.md` (no implicit polling; model-driven invalidation)
- `docs/workstreams/state-management-v1/state-management-v1.md` (model/selector/query layering)
