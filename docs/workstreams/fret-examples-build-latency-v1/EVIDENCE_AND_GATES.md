...
- Current count after the IMUI collection/pane workstream source migration: 266 `include_str!`
  occurrences and 54 Rust `#[test]` functions remain in `apps/fret-examples/src/lib.rs`.
