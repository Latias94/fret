...
- Current count after the IMUI collection second proof-surface workstream source migration: 202
  `include_str!` occurrences and 42 Rust `#[test]` functions remain in
