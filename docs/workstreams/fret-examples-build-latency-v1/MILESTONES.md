...
## M35 - IMUI Collection Rename Workstream Source Gate

Status: complete

Exit criteria:

- IMUI collection rename workstream freeze markers no longer compile the monolithic `fret-examples`
  unit-test module.
- The closed collection rename workstream points its source-policy gate at the Python gate instead
  of a deleted Rust source-marker test.
- The real `proof_collection_*rename*` unit tests remain in Rust and stay named as the behavior
  floor.
...
## M37 - IMUI Collection Modularization Workstream Source Gate

Status: complete

Exit criteria:

- IMUI collection modularization workstream freeze markers no longer compile the monolithic
  `fret-examples` unit-test module.
- The closed collection modularization workstream points its source-policy gate at the Python gate
  instead of a deleted Rust source-marker test.
- Host/module source-boundary markers live in the Python source gate, while real collection
  behavior unit tests remain in Rust.
...
## M39 - IMUI Collection Second Proof Surface Workstream Source Gate

Status: complete

Exit criteria:

- IMUI collection second proof-surface closeout markers no longer compile the monolithic
  `fret-examples` unit-test module.
- The closed second proof-surface workstream points its source-policy gate at the Python gate
  instead of a deleted Rust source-marker test.
- Real shell-mounted surface integration tests remain in Rust.
...
## M40 - IMUI Collection Helper Readiness Workstream Source Gate

Status: complete

Exit criteria:

- IMUI collection helper-readiness closeout markers no longer compile the monolithic
  `fret-examples` unit-test module.
- The closed helper-readiness workstream points its source-policy gate at the Python gate instead of
  a deleted Rust source-marker test.
- Real proof-surface integration tests remain in Rust.
...
## M44 - IMUI Editor Notes Draft Actions Workstream Source Gate

Status: complete

Exit criteria:

- IMUI editor-notes draft actions closeout markers no longer compile the monolithic
  `fret-examples` unit-test module.
- The closed draft actions workstream points its source-policy gate at the Python gate instead of a
  deleted Rust source-marker test.
- The real editor rail/device shell surface integration tests remain in Rust.
