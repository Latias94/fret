# ImUi Color Edit Palette Customization v1 Evidence and Gates
...
python -m json.tool docs/workstreams/imui-color-edit-palette-customization-v1/WORKSTREAM.json
