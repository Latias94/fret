...
- Add a thumb-drag stability repro script (even if it initially fails).
...
- Add a torture script for wheel input and basic perf telemetry capture.
...
- Add a deterministic gate (diag script + bounded assertions).
