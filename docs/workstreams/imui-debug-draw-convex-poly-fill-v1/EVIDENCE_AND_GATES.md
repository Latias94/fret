# ImUi Debug Draw Convex Poly Fill v1 Evidence And Gates
...
- `repo-ref/imgui/imgui.h`: `ImDrawList::AddConvexPolyFilled`.
- `repo-ref/imgui/imgui_draw.cpp`: Dear ImGui filled polygon support lives in `ImDrawList`.
- `crates/fret-core/src/vector_path.rs`: Fret path commands already support closed fill paths.
...
python -m json.tool docs/workstreams/imui-debug-draw-convex-poly-fill-v1/WORKSTREAM.json
