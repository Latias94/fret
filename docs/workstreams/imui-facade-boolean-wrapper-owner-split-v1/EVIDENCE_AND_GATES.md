# ImUi Facade Boolean Wrapper Owner Split v1 - Evidence & Gates

Goal: move checkbox/radio/switch facade wrappers behind a private owner while preserving public
...
- `python -m json.tool docs/workstreams/imui-facade-boolean-wrapper-owner-split-v1/WORKSTREAM.json`
