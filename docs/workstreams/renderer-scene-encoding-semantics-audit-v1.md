...
- RenderPlan semantics: `docs/workstreams/renderer-render-plan-semantics-audit-v1.md`
- vNext refactor tracker: `docs/workstreams/renderer-vnext-fearless-refactor-v1-todo.md`
