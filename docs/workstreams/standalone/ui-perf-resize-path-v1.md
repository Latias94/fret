...
- TODO: `docs/workstreams/ui-perf-zed-smoothness-v1/ui-perf-zed-smoothness-v1-todo.md`
- Perf log (commit-addressable evidence): `docs/workstreams/ui-perf-zed-smoothness-v1/ui-perf-zed-smoothness-v1-log.md`
...
- Commit `0de40863f` makes small-step interactive resize detection symmetric; this keeps the same bucketing/caching
  ...
  - Evidence: `docs/workstreams/ui-perf-zed-smoothness-v1/ui-perf-zed-smoothness-v1-log.md` entry `2026-02-09 16:37:00`.
