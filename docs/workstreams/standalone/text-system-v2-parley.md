...
- Theme/paint-only changes are intended to **reuse shaping/layout**:
  ...
  - Evidence: `docs/workstreams/standalone/text-system-v2-parley.md` (WP4), `crates/fret-render-wgpu/src/text/mod.rs`
...
- Bundled-only conformance gates for mixed-script + emoji fallback.
  - Evidence: `docs/workstreams/standalone/font-system-v1.md`, `docs/workstreams/standalone/font-fallback-conformance-v1.md`
...
- Multi-page, budgeted, evictable text atlases (mask/color/subpixel).
  - Evidence: `docs/workstreams/standalone/text-system-v2-parley.md` (B4), `crates/fret-render-wgpu/src/text/mod.rs`
