# Default Actions v2 — Mechanism vs Policy Boundary (archived worktree snapshot)

Status: Archived (historical record; canonical tracker: `docs/workstreams/input-dispatch-v2/input-dispatch-v2-todo.md`)
...
- Workstream: `docs/workstreams/input-dispatch-v2/input-dispatch-v2.md`
- Tracker: `docs/workstreams/input-dispatch-v2/input-dispatch-v2-todo.md` (`IDV2-def-006/007`)
