...
- Visual parity tracker: `docs/workstreams/ui-gallery-visual-parity/ui-gallery-visual-parity-todo.md`
- Web golden parity: `docs/workstreams/shadcn-web-goldens-v4/shadcn-web-goldens-v4-todo.md`
- Semantics decorators adoption: `docs/workstreams/standalone/semantics-decorators-adoption-v1-todo.md`
...
- [~] alert - docs-order `Demo/Usage/Examples/API` scaffold landed; multiline-title docs remain a known new-york-v4 chrome gap (`apps/fret-ui-gallery/src/ui/pages/alert.rs`)
...
- [x] kbd — examples mirrored (Demo/Usage/Group/Button/Tooltip/Input Group/RTL; API Reference follows), with docs smoke now asserting the section-scoped `ui-gallery-kbd-*` anchors (`apps/fret-ui-gallery/src/ui/pages/kbd.rs`, `tools/diag-scripts/ui-gallery/kbd/ui-gallery-kbd-docs-smoke.json`)
- [~] label - docs-order examples + Component/Code/Notes scaffold landed (`apps/fret-ui-gallery/src/ui/pages/label.rs`)
- [x] menubar - examples mirrored (Demo/Usage/Checkbox/Radio/Submenu/With Icons/RTL; API Reference + Parts follow), with docs smoke now asserting the section-scoped `ui-gallery-menubar-*` anchors (`apps/fret-ui-gallery/src/ui/pages/menubar.rs`, `tools/diag-scripts/ui-gallery/menubar/ui-gallery-menubar-docs-smoke.json`)
