...
an entry in `docs/workstreams/ui-perf-zed-smoothness-v1/ui-perf-zed-smoothness-v1-log.md` (commit-addressable) so regressions are reversible.
...
3) **Per-frame allocation discipline on hot resize frames**
   ...
   - Negative result: a wrapper-chain memoization attempt using a per-build `HashMap` regressed
     ...
     - Evidence: perf log entry `2026-02-09 15:28:00` in `docs/workstreams/ui-perf-zed-smoothness-v1/ui-perf-zed-smoothness-v1-log.md`.
...
- `ui-resize-probes` and `ui-code-editor-resize-probes` are stable under attempts=3 on the primary dev machine(s).
  - Evidence: perf log entries `2026-02-09 13:31:35` (commit `1778ba563`) and `2026-02-09 13:46:46`
    (commit `007006b28`) in `docs/workstreams/ui-perf-zed-smoothness-v1/ui-perf-zed-smoothness-v1-log.md`.
...
- Still missing: a true “allocate elements in an arena, bulk-clear after draw” model akin to GPUI’s `Arena`.
  - Partial progress: pooled `Vec<AnyElement>` child buffers across frames (arena-adjacent; reduces allocation churn but is not a bump arena).
    ...
    - Evidence: the pool reaches stable “0 misses” steady state on:
      ...
      (see perf log entries under `docs/workstreams/ui-perf-zed-smoothness-v1/ui-perf-zed-smoothness-v1-log.md`)
...
- Evidence (macOS Apple M4):
  ...
  - Details and bundles are recorded in `docs/workstreams/ui-perf-zed-smoothness-v1/ui-perf-zed-smoothness-v1-log.md` (2026-02-06 13:20).
- Additional experiment (env-gated scroll optimization):
  ...
  - Evidence and command are recorded in `docs/workstreams/ui-perf-zed-smoothness-v1/ui-perf-zed-smoothness-v1-log.md` (2026-02-06 13:45).
...
- Latest spot check (commit `5208b6883`, repeat=7; reuse-launch):
  ...
  - Evidence: perf log entry `docs/workstreams/ui-perf-zed-smoothness-v1/ui-perf-zed-smoothness-v1-log.md` (2026-02-07 08:45).
...
- With widget hotspots enabled, the same probe shows `paint_widget_time_us` is almost entirely concentrated in a few
  ...
  - Evidence run: `docs/workstreams/ui-perf-zed-smoothness-v1/ui-perf-zed-smoothness-v1-log.md` entry 2026-02-05 20:03 (commit `e1132c95`).
...
- Workstream doc: `docs/workstreams/ui-perf-paint-pass-breakdown-v1/ui-perf-paint-pass-breakdown-v1.md`
- TODO tracker: `docs/workstreams/ui-perf-paint-pass-breakdown-v1/ui-perf-paint-pass-breakdown-v1-todo.md`
...
- Status: **Partially implemented**.
  ...
  - Non-text upload churn counters are now exported (best-effort):
    ...
    - Evidence: `docs/workstreams/ui-perf-zed-smoothness-v1/ui-perf-zed-smoothness-v1-log.md` entry for commit `dfbc02d3`.
...
- Gate semantics snapshot refresh to the frames that actually require selector resolution.
  ...
  - Evidence: `docs/workstreams/ui-perf-zed-smoothness-v1/ui-perf-zed-smoothness-v1-log.md` (entry for commit `470708b2`).
...
- Add the commit hash + the exact `diag perf` command + p50/p95/max to
  `docs/workstreams/ui-perf-zed-smoothness-v1/ui-perf-zed-smoothness-v1-log.md`.
- Update the corresponding TODO entry in `docs/workstreams/ui-perf-zed-smoothness-v1/ui-perf-zed-smoothness-v1-todo.md`.
