...
- **Current bounds latency caveat**: the v0 world layer derives the transform from a
  ...
  one-frame mismatch on resize/layout changes. See `docs/workstreams/canvas-world-layer-v1/canvas-world-layer-v1.md`.
...
- `docs/workstreams/canvas-world-layer-v1/canvas-world-layer-v1.md` (M2)
