...
- Related: `docs/workstreams/standalone/os-menubar.md`
- Cross-cutting contracts: `docs/adr/0218-input-dispatch-phases-prevent-default-and-action-availability-v2.md`
