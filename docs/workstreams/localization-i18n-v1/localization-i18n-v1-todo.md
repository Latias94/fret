...
- `docs/workstreams/localization-i18n-v1/localization-i18n-v1.md`
...
- `[x]` Add the v1 workstream plan document.
  - Evidence: `docs/workstreams/localization-i18n-v1/localization-i18n-v1.md`
- `[x]` Add this milestone tracker document.
  - Evidence: `docs/workstreams/localization-i18n-v1/localization-i18n-v1-todo.md`
