...
- Narrative plan: `docs/workstreams/input-dispatch-v2/input-dispatch-v2.md`
...
- [x] IDV2-def-006 Decide which behaviors qualify as mechanism-owned default actions (vs ecosystem policy).
  - Decision tracker: `docs/workstreams/standalone/default-actions-v2-todo-input-dispatch-v2.md`
...
- [x] IDV2-def-007 Expand default actions incrementally with tests (e.g. selection start, scroll routing), if justified.
  ...
  - Evidence: `docs/workstreams/standalone/default-actions-v2-todo-input-dispatch-v2.md`
