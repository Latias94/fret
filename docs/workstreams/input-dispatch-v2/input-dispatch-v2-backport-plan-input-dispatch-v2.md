...
- Shadcn: Click-through (`modal=false`) outside-press can be prevented without blocking underlay activation.
  - Evidence:
    ...
    - Tracker: `docs/workstreams/overlay-input-arbitration-v2/overlay-input-arbitration-v2-todo-input-dispatch-v2.md` (OIA2-test-039..041)
...
- Keep overlay arbitration docs split from Input Dispatch v2 contracts:
  - Input Dispatch v2 TODO tracker: `docs/workstreams/input-dispatch-v2/input-dispatch-v2-todo.md`
  - Overlay arbitration TODO tracker: `docs/workstreams/overlay-input-arbitration-v2/overlay-input-arbitration-v2-todo.md`
  - Worktree overlay tracker: `docs/workstreams/overlay-input-arbitration-v2/overlay-input-arbitration-v2-todo-input-dispatch-v2.md`
