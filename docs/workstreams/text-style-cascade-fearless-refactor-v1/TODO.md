...
| shadcn / dialog | `AlertDialogDescription` | `ecosystem/fret-ui-shadcn/src/alert_dialog.rs` | Component-owned muted supporting copy | Prefer subtree-local inherited description refinement on the returned part root | Keeps alert-like overlays on one description path | P1 | `[ ]` | Audit needed |
...
| shadcn / empty state | `EmptyDescription` | `ecosystem/fret-ui-shadcn/src/empty.rs` | Component-owned muted supporting copy | Prefer subtree-local inherited description refinement | Keeps empty-state body copy aligned with other description surfaces | P2 | `[ ]` | Audit needed |
...
| AI / plan | `PlanDescription` | `ecosystem/fret-ui-ai/src/elements/plan.rs` | Component-owned card-description typography | Prefer shared description helper over local card-description text style assembly | Likely same policy as card/description family | P2 | `[ ]` | Audit needed |
