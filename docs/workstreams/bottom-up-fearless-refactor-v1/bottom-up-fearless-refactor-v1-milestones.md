...
- Workstream doc + TODO tracker exist and are linked:
  - `docs/workstreams/bottom-up-fearless-refactor-v1/bottom-up-fearless-refactor-v1.md`
  - `docs/workstreams/bottom-up-fearless-refactor-v1/bottom-up-fearless-refactor-v1-todo.md`
  - `docs/workstreams/bottom-up-fearless-refactor-v1/bottom-up-fearless-refactor-v1-milestones.md`
