...
- A stable template: `docs/workstreams/bottom-up-fearless-refactor-v1/bottom-up-fearless-refactor-v1-crate-audit-template.md`
- A single index for progress tracking: `docs/workstreams/bottom-up-fearless-refactor-v1/bottom-up-fearless-refactor-v1-crate-audits.md`
...
- M0/M2: `docs/workstreams/foundation-closure-p0/foundation-closure-p0.md`
- M2: `docs/layout-engine-refactor-roadmap.md`, `docs/workstreams/overlay-input-arbitration-v2/overlay-input-arbitration-v2.md`,
  `docs/workstreams/gpui-parity-refactor/gpui-parity-refactor.md`, `docs/workstreams/retained-bridge-exit-v1/retained-bridge-exit-v1.md`
- M3: `docs/renderer-refactor-roadmap.md`, `docs/tracy.md`, `docs/renderdoc-inspection.md`
- M4: `docs/shadcn-declarative-progress.md`, `docs/workstreams/standalone/ecosystem-status.md`
...
- Fast: `python tools/gates_fast.py`
