...
- [x] IMUI-docs-034 Add a minimal “Hello World” snippet to `docs/workstreams/imui-authoring-facade-v1/imui-authoring-facade-v1.md`.
...
- [x] IMUI-docs-062 Add a short third-party guide:
  ...
  - (Initial checklist lives in `docs/workstreams/imui-authoring-facade-v1/imui-authoring-facade-v1.md`.)
...
- `docs/workstreams/unified-authoring-builder-v1/unified-authoring-builder-v1.md`
