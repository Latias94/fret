...
- [x] Choose the next 2?3 high-ROI seam extractions for landable follow-up PRs:
  ...
  - [x] artifact resolution/materialization,
    ...
    - next focus: continue inside `commands/resolve` with the remaining bundle-ref/input normalization seam unless a new artifact/materialization holdout appears
