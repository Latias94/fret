...
1. `diag_campaign` summary/finalize execution and report/outcome shaping,
2. artifact resolution and materialization holdouts,
3. presentation-surface reuse over the aggregate artifacts only after campaign seams settle.
