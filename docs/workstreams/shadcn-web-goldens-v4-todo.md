...
- 2026-02-02: added `context-menu-demo.submenu-kbd-vp375x240` + `menubar-demo.submenu-kbd-vp375x240` submenu panel-size + surface-color gates (light/dark) to lock in constrained viewport clamping behavior for nested menus.
