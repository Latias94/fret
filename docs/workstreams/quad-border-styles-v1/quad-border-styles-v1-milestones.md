...
Source of truth for detailed TODOs: `docs/workstreams/quad-border-styles-v1/quad-border-styles-v1-todo.md`.
Narrative + contracts: `docs/workstreams/quad-border-styles-v1/quad-border-styles-v1.md`.
