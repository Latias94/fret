...
Status: Completed (2026-01-31) (tracking UI gallery regressions; complements `docs/workstreams/standalone/text-system-v2-parley.md`).

This workstream is closed: the tracked regressions and baseline integration contracts have landed.
Follow-up work belongs in `docs/workstreams/standalone/text-system-v2-parley.md` (text system v2) and
