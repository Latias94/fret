...
- Track the remaining ergonomics pressure separately:
  ...
  - Batch C progress (as of 2026-03-09): `external_texture_imports_demo` has also moved to `view_with_hooks::<...>(...)`, leaving the platform video-import demos as the main remaining app-entry migration risk.
