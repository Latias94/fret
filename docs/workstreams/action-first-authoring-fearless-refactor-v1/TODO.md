...
- Post-v1 design review (as of 2026-03-06):
  ...
  - Remaining pressure points:
    ...
    3. the query demos now demonstrate builder-first paths via `ui::*_build`, but `ui::children!` remains the dominant composition style elsewhere and some section-level `into_element(cx)` boundaries are still visible in medium demos.
