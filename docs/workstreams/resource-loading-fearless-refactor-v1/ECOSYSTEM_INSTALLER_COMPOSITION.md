...
If the crate has generated asset modules, that generated module can stay the low-level bundle
publication surface, while a higher-level recipe/app crate wraps it in a named installer that also
composes icon packs or UI globals.
