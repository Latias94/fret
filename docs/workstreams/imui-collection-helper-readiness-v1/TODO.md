...
Start conservative: the second proof exists, but current evidence still says app-owned collection
policy should stay explicit until both surfaces demand the same policy-light helper shape.
