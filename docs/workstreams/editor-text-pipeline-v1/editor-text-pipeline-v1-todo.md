...
Scope: `docs/workstreams/editor-text-pipeline-v1/editor-text-pipeline-v1.md`
...
- [x] Coordinate with `docs/workstreams/text-line-breaking-v1/text-line-breaking-v1.md`:
