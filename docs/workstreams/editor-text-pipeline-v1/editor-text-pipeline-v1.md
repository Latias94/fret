...
- Text v2 (Parley) tracker: `docs/workstreams/standalone/text-system-v2-parley.md`
- Line breaking improvements: `docs/workstreams/text-line-breaking-v1/text-line-breaking-v1.md`
- Code editor ecosystem baseline: `docs/workstreams/code-editor-ecosystem-v1/code-editor-ecosystem-v1.md`
...
| Wrap (UI) | `TextWrap::Word` with paragraph line breaking | Supported + gated | `docs/workstreams/text-line-breaking-v1/text-line-breaking-v1.md` + fixtures |
...
- `docs/workstreams/editor-text-pipeline-v1/editor-text-pipeline-v1-milestones.md`
- `docs/workstreams/editor-text-pipeline-v1/editor-text-pipeline-v1-todo.md`
