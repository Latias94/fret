# ImUi Models Text Area Test Split v1 Evidence And Gates
...
- `docs/workstreams/imui-models-text-command-test-split-v1/CLOSEOUT_AUDIT_2026-05-04.md`: previous
...
python -m json.tool docs/workstreams/imui-models-text-area-test-split-v1/WORKSTREAM.json
