...
- [ ] (Ongoing hygiene) When adding a new range-like control, follow the “Closure checklist (range/numeric controls)” in
  `docs/workstreams/a11y-range-semantics-fearless-refactor-v1/a11y-range-semantics-fearless-refactor-v1.md` and add at least one gate per new production path.
