# ImUi Debug Draw Ellipse Primitives v1 Evidence And Gates
...
- `repo-ref/imgui/imgui.h`: `ImDrawList::AddEllipse` and `ImDrawList::AddEllipseFilled`.
- `repo-ref/imgui/imgui_draw.cpp`: Dear ImGui lowers ellipses through `PathEllipticalArcTo`.
- `crates/fret-core/src/vector_path.rs`: Fret path commands already support closed paths.
...
python -m json.tool docs/workstreams/imui-debug-draw-ellipse-primitives-v1/WORKSTREAM.json
