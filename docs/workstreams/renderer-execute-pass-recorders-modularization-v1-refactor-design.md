...
- Workstream overview: `docs/workstreams/renderer-execute-pass-recorders-modularization-v1.md`
...
- vNext fearless refactor umbrella: `docs/workstreams/renderer-vnext-fearless-refactor-v1.md`
