# ImUi Facade Value Model Owner Split v1 - Evidence & Gates

Goal: move slider/combo model facade wrappers behind a private owner while preserving public IMUI
API and behavior.
...
- `python -m json.tool docs/workstreams/imui-facade-value-model-owner-split-v1/WORKSTREAM.json`
