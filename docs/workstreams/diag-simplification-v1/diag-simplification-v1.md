...
- M0 baseline: `docs/workstreams/diag-simplification-v1/diag-simplification-v1-m0-baseline.md`
- AI agent packets + indexing: `docs/workstreams/diag-ai-agent-debugging-v1/diag-ai-agent-debugging-v1.md`
