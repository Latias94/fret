...
- Design: `docs/workstreams/docking-hovered-window-contract-v1/docking-hovered-window-contract-v1.md`
...
- [x] DWHW-P1-macos-001 Decide the “Reliable” strategy for hovered window selection on macOS.
  ...
  - Deliverable:
    - Documented in `docs/workstreams/docking-hovered-window-contract-v1/docking-hovered-window-contract-v1.md` (macOS section) with
...
- [ ] DWHW-P1-wayland-001 Ensure Wayland sessions cannot claim `Reliable`.
  ...
  - Evidence anchors:
    - Existing workstream policy: `docs/workstreams/docking-multiwindow-imgui-parity/docking-multiwindow-imgui-parity-todo.md`
  - Acceptance:
