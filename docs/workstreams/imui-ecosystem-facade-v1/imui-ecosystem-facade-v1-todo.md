...
- `docs/workstreams/imui-authoring-facade-v2/imui-authoring-facade-v2.md` (implemented; authoring frontend baseline)
- `docs/adr/0160-unified-authoring-builder-surface-v1.md` (patch vocabulary)
- Docking parity: `docs/workstreams/docking-multiwindow-imgui-parity/docking-multiwindow-imgui-parity.md`
...
- [x] IMUIECO-scope-010 Decide whether shadcn integration is via an optional feature or a dedicated adapter module/crate.
  ...
  - Evidence: `docs/workstreams/imui-ecosystem-facade-v1/imui-ecosystem-facade-v1.md` (section 5.6.1).
- [x] IMUIECO-scope-011 Choose a canonical delegation seam for returning `Response` from canonical components.
  ...
  - Evidence: `docs/workstreams/imui-ecosystem-facade-v1/imui-ecosystem-facade-v1.md` (section 5.6.2).
- [x] IMUIECO-scope-012 Decide whether "tear-off to OS window" is docking-only for v1 (recommended) or generalized.
  ...
  - Evidence: `docs/workstreams/imui-ecosystem-facade-v1/imui-ecosystem-facade-v1.md` (section 5.6.3).
- [x] IMUIECO-scope-013 Define the `ResponseExt` signal storage model (transient vs element-local state) and document it.
  ...
  - Evidence: `docs/workstreams/imui-ecosystem-facade-v1/imui-ecosystem-facade-v1.md` (section 5.6.4).
- [x] IMUIECO-scope-014 Define a tiered delegation rule for official widgets (primitive wrappers vs canonical component adapters).
  ...
  - Evidence: `docs/workstreams/imui-ecosystem-facade-v1/imui-ecosystem-facade-v1.md` (section 5.6.5).
...
- [x] IMUIECO-resp-013 Document "two-frame stabilization" where geometry is sourced from last-frame bounds.
  - Evidence: `docs/workstreams/imui-ecosystem-facade-v1/imui-ecosystem-facade-v1.md` (section 5.3).
...
- [x] IMUIECO-float-034 Decide OS-window promotion scope:
  ...
  - Evidence: `docs/workstreams/imui-ecosystem-facade-v1/imui-ecosystem-facade-v1.md` (section 5.6.6).
...
- [x] IMUIECO-perf-044 Add a short perf guide (avoid allocations, prefer keyed identity, use virtualization/caching).
  - Evidence: `docs/workstreams/standalone/imui-ecosystem-facade-perf-v1.md`
