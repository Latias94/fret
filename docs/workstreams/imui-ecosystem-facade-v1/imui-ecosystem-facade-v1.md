...
- TODO tracker: `docs/workstreams/imui-ecosystem-facade-v1/imui-ecosystem-facade-v1-todo.md`
- ImGui parity audit notes: `docs/workstreams/standalone/imui-imgui-parity-audit-v1.md`
- State integration note: `docs/workstreams/standalone/imui-state-integration-v1.md`
- v2 follow-up: `docs/workstreams/imui-ecosystem-facade-v2/imui-ecosystem-facade-v2.md`
- v2 tracker: `docs/workstreams/imui-ecosystem-facade-v2/imui-ecosystem-facade-v2-todo.md`
- Perf guide: `docs/workstreams/standalone/imui-ecosystem-facade-perf-v1.md`
- imui authoring facade v2 (implemented): `docs/workstreams/imui-authoring-facade-v2/imui-authoring-facade-v2.md`
- Unified authoring builder surface (ADR): `docs/adr/0160-unified-authoring-builder-surface-v1.md`
- Docking + multi-window parity (ImGui-aligned): `docs/workstreams/docking-multiwindow-imgui-parity/docking-multiwindow-imgui-parity.md`
- macOS multi-window parity anchors: `docs/workstreams/standalone/macos-docking-multiwindow-imgui-parity.md`
...
1) **No second runtime**
   - The facade must still compile to the declarative element taxonomy mounted into `UiTree`
     (see ADR 0028/0039 and `docs/workstreams/imui-authoring-facade-v2/imui-authoring-facade-v2.md`).
