...
- Intrinsic sizing + wrap semantics:
  ...
  - Workstream: `docs/workstreams/text-intrinsic-sizing-and-wrap-v1/text-intrinsic-sizing-and-wrap-v1.md`
- Line breaking quality and conformance:
  - Workstream: `docs/workstreams/text-line-breaking-v1/text-line-breaking-v1.md`
- Interactive spans (links, diagnostics-friendly activation):
  - Workstream: `docs/workstreams/text-interactive-spans-v1/text-interactive-spans-v1.md`
