...
- Status: Landed (docs)
- Evidence anchors:
  - `docs/workstreams/renderer-render-plan-semantics-audit-v1/renderer-render-plan-semantics-audit-v1.md` (Pass semantics summary, Scale/scissor mapping notes)
  - `docs/workstreams/renderer-render-plan-semantics-audit-v1/renderer-render-plan-semantics-audit-v1-todo.md` (audit item checked)
...
- Evidence anchors:
  ...
  - `docs/workstreams/renderer-render-plan-semantics-audit-v1/renderer-render-plan-semantics-audit-v1.md` (Target lifetimes: determinism note)
