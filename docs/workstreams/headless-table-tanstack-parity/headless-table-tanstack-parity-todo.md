...
- Narrative plan: `docs/workstreams/headless-table-tanstack-parity/headless-table-tanstack-parity.md`
...
- Evidence: a short "version stamp" section in `docs/workstreams/headless-table-tanstack-parity/headless-table-tanstack-parity.md`.
...
- [x] HTP-base-003 Add a "feature-by-feature parity matrix" section (one row per upstream feature file).
  ...
  - Evidence: `docs/workstreams/headless-table-tanstack-parity/headless-table-tanstack-parity.md`.
- [x] HTP-base-004 Extend the upstream inventory to include non-option parity surfaces:
  ...
  - Done: expanded the capability doc with:
    ...
    - Evidence: `docs/workstreams/headless-table-tanstack-parity/headless-table-tanstack-parity-capability.md`.
...
- [x] HTP-cap-010 Inventory upstream public APIs and decide the Fret mapping strategy.
  - Evidence target: expand "Capability Inventory" in `docs/workstreams/headless-table-tanstack-parity/headless-table-tanstack-parity.md`
  ...
  - Update: added a raw upstream instance member inventory appendix (table/column/row/header/cell) in
    `docs/workstreams/headless-table-tanstack-parity/headless-table-tanstack-parity-capability.md` to keep the mapping work honest.
  ...
  - Update: started a consumer-driven must-have surface section in
    `docs/workstreams/headless-table-tanstack-parity/headless-table-tanstack-parity-capability.md` (references `fret-ui-kit` virtualized table usage).
  - Update: documented the current TanStack → Fret mapping strategy in
    `docs/workstreams/headless-table-tanstack-parity/headless-table-tanstack-parity-capability.md` (pure models + snapshots + helper surfaces).
...
- [x] HTP-cap-030 Refresh the `fret-ui-shadcn` DataTable must-have surface once it is fully wired to the headless engine.
  - Evidence: `docs/workstreams/headless-table-tanstack-parity/headless-table-tanstack-parity-capability.md` (Consumer-driven must-have surface),
  ...
  - Evidence target: `docs/workstreams/headless-table-tanstack-parity/headless-table-tanstack-parity-capability.md` must-have section + a focused smoke gate.
...
- [x] HTP-core-041 Establish a strict process for expanding core snapshot inventories (strict schema versioning).
  ...
  - Process (apply when new consumers require more):
    ...
    4) update `docs/workstreams/headless-table-tanstack-parity/headless-table-tanstack-parity-capability.md` evidence anchors.
...
- [x] HTP-state-011 Specify normalization vs lossless rules for the JSON surface:
  ...
  - Evidence: `docs/workstreams/headless-table-tanstack-parity/headless-table-tanstack-parity.md` (state JSON schema + rules)
