...
- [x] Re-run the data-table view-cache/filter shrink script with layout node profiling enabled.
- [x] Run `diag stats --sort cpu_cycles --top 30` and save the worst-frame summary.
...
- [x] Re-run the same data-table script after the slice.
- [x] Compare:
  - `top_total_time_us`;
  - `layout_time_us`;
