# ImUi Debug Draw Quad Primitives v1 Evidence And Gates
...
- `repo-ref/imgui/imgui.h`: `ImDrawList::AddQuad` and `ImDrawList::AddQuadFilled`.
- `repo-ref/imgui/imgui_draw.cpp`: Dear ImGui lowers quads through path stroke/fill helpers.
...
python -m json.tool docs/workstreams/imui-debug-draw-quad-primitives-v1/WORKSTREAM.json
