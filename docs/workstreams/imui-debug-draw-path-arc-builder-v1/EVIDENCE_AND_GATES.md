# ImUi Debug Draw Path Arc Builder v1 Evidence And Gates
...
- `repo-ref/imgui/imgui.h`: `ImDrawList::PathArcTo` and `PathArcToFast`.
- `repo-ref/imgui/imgui_draw.cpp`: Dear ImGui appends circular arc points to the current path and
...
python -m json.tool docs/workstreams/imui-debug-draw-path-arc-builder-v1/WORKSTREAM.json
