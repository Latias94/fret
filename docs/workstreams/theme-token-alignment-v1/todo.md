...
| ecosystem | CodeView / Syntax (tokens contrast) | (ecosystem / vscode-theme) | centralize `color.syntax.*` resolution + audit contrast | `color.syntax.*` (+ semantic fallbacks) | diag screenshot (zinc/dark) | [~] | `ecosystem/fret-syntax-theme/src/lib.rs`, `ecosystem/fret-code-view/src/syntax.rs`, `ecosystem/fret-code-editor/src/editor/paint/mod.rs`, `ecosystem/fret-vscode-theme/src/lib.rs` |
