...
| shadcn-ai | AI Elements (messages + code blocks) | TODO: pin ai-elements upstream under `repo-ref/` | audit surface/on-surface and muted/code rules | tbd | diag screenshot (zinc/dark) | [ ] | `ecosystem/fret-ui-ai/src/elements/message.rs`, `ecosystem/fret-ui-ai/src/elements/code_block.rs` |
