...
| shadcn-ai | AI Elements (messages + code blocks) | `repo-ref/ai-elements/packages/elements/src/message.tsx`, `repo-ref/ai-elements/packages/elements/src/code-block.tsx` | bubble `bg-secondary` implies `text-foreground` | `secondary`, `foreground` | diag screenshot (zinc/dark) | [x] | `ecosystem/fret-ui-ai/src/elements/message.rs`, `ecosystem/fret-ui-ai/src/elements/message_parts.rs`, `tools/diag-scripts/ui-gallery/ai/ui-gallery-ai-message-demo-screenshot-zinc-dark.json`, `tools/diag-scripts/ui-gallery/ai/ui-gallery-ai-chat-demo-user-bubble-screenshot-zinc-dark.json`, `tools/diag-scripts/ui-gallery/ai/ui-gallery-ai-code-block-demo-screenshot-zinc-dark.json` |
| shadcn-ai | AI Elements (prompt input) | `repo-ref/ai-elements/packages/elements/src/prompt-input.tsx`, `repo-ref/ai-elements/packages/elements/src/attachments.tsx`, `repo-ref/ai-elements/packages/elements/src/sources.tsx` | action menu trigger must not double-toggle; attachment hover uses `accent` | `accent`, `accent-foreground` (+ menu semantics) | diag screenshot (zinc/dark) | [~] | `ecosystem/fret-ui-ai/src/elements/prompt_input.rs`, `ecosystem/fret-ui-ai/src/elements/attachments.rs`, `tools/diag-scripts/ui-gallery-ai-prompt-input-action-menu-demo-screenshot-zinc-dark.json`, `tools/diag-scripts/ui-gallery-ai-prompt-input-provider-demo-screenshot-zinc-dark.json`, `tools/diag-scripts/ui-gallery-ai-prompt-input-referenced-sources-demo-screenshot-zinc-dark.json`, `target/fret-diag/share/1772183512149.zip`, `target/fret-diag/share/1772183540170.zip`, `target/fret-diag/share/1772183572451.zip` |
