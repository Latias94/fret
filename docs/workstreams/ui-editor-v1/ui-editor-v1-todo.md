...
- Alignment inventory: `docs/workstreams/standalone/ui-editor-imgui-alignment-v1.md`
- Gap matrix (egui/imgui): `docs/workstreams/standalone/ui-editor-egui-imgui-gap-v1.md`
...
- [x] Pick initial `editor.*` token keys (v1 minimal set) and add a short token table to `ui-editor-v1.md`.
  - Evidence: `ecosystem/fret-ui-editor/src/primitives/tokens.rs`, `docs/workstreams/ui-editor-v1/ui-editor-v1.md`
