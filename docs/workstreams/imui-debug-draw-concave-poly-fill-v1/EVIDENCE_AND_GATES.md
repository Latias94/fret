# ImUi Debug Draw Concave Poly Fill v1 Evidence And Gates
...
- `repo-ref/imgui/imgui.h`: `AddConcavePolyFilled` and `PathFillConcave`.
- `repo-ref/imgui/imgui_draw.cpp`: Dear ImGui treats concave polygon fill as a distinct, more
  expensive simple-polygon convenience.
- `crates/fret-core/src/vector_path.rs`: Fret already has fill-rule-backed closed path painting.
...
python -m json.tool docs/workstreams/imui-debug-draw-concave-poly-fill-v1/WORKSTREAM.json
