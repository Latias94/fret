...
- [x] Add label-association closure surfaces for form/trigger controls (gallery examples + focused diag gates).
  - Evidence: `apps/fret-ui-gallery/src/ui/pages/{select,native_select,slider,radio_group,toggle_group,combobox,date_picker,switch,input,textarea,toggle}.rs`,
