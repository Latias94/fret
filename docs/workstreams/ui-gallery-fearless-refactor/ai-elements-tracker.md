...
| `canvas_world_layer_spike` | `PAGE_AI_CANVAS_WORLD_LAYER_SPIKE` | (removed) | `apps/fret-ui-gallery/src/ui/snippets/ai/canvas_world_layer_spike.rs` | `apps/fret-ui-gallery/src/ui/pages/ai_canvas_world_layer_spike.rs` | Snippet-backed |
...
| `chat_demo` | `PAGE_AI_CHAT_DEMO` | (removed) | `apps/fret-ui-gallery/src/ui/snippets/ai/chat_demo.rs` | `apps/fret-ui-gallery/src/ui/pages/ai_chat_demo.rs` | Snippet-backed |
...
| `workflow_chrome_demo` | `PAGE_AI_WORKFLOW_CHROME_DEMO` | (removed) | `apps/fret-ui-gallery/src/ui/snippets/ai/workflow_chrome_demo.rs` | `apps/fret-ui-gallery/src/ui/pages/ai_workflow_chrome_demo.rs` | Snippet-backed |
...
| `workflow_node_graph_demo` | `PAGE_AI_WORKFLOW_NODE_GRAPH_DEMO` | (removed) | `apps/fret-ui-gallery/src/ui/snippets/ai/workflow_node_graph_demo.rs` | `apps/fret-ui-gallery/src/ui/pages/ai_workflow_node_graph_demo.rs` | Snippet-backed |
