...
| `material3_button` | `preview_material3_button` | `apps/fret-ui-gallery/src/ui/previews/material3/buttons.rs` | No | `apps/fret-ui-gallery/src/ui/pages/material3_button.rs` | `apps/fret-ui-gallery/src/ui/snippets/material3/button.rs` | Explicitly showcase state-layer + ripple outcomes; ensure copyable code includes icon imports. |
