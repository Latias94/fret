| File | `.max_w(Px(..))` values |
|---|---|
| `apps/fret-ui-gallery/src/ui/pages/ai_canvas_world_layer_spike.rs` | 1000.0 |
...
| `apps/fret-ui-gallery/src/ui/pages/date_picker.rs` | 780.0, 980.0 |
