...
| `sidebar` | `repo-ref/ui/apps/v4/registry/bases/radix/ui/sidebar.tsx` | `ecosystem/fret-ui-shadcn/src/sidebar.rs` | parts | No | Yes | Motion + width invariants are gated by unit tests; includes `use_sidebar` for provider state access. |
