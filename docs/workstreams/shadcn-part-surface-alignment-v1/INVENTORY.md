...
| `alert` | `repo-ref/ui/apps/v4/registry/bases/radix/ui/alert.tsx` | `ecosystem/fret-ui-shadcn/src/alert.rs` | parts | No | No | Not audited yet. |
...
| `aspect-ratio` | `repo-ref/ui/apps/v4/registry/bases/radix/ui/aspect-ratio.tsx` | `ecosystem/fret-ui-shadcn/src/aspect_ratio.rs` | parts | No | No | Not audited yet. |
...
| `badge` | `repo-ref/ui/apps/v4/registry/bases/radix/ui/badge.tsx` | `ecosystem/fret-ui-shadcn/src/badge.rs` | parts | No | No | Not audited yet. |
...
| `carousel` | `repo-ref/ui/apps/v4/registry/bases/radix/ui/carousel.tsx` | `ecosystem/fret-ui-shadcn/src/carousel.rs` | parts + adapter | Yes | No | `into_element_parts` exists; audit/gates live in carousel workstreams. |
| `chart` | `repo-ref/ui/apps/v4/registry/bases/radix/ui/chart.tsx` | `ecosystem/fret-ui-shadcn/src/chart.rs` | parts | No | No | Not audited yet. |
| `checkbox` | `repo-ref/ui/apps/v4/registry/bases/radix/ui/checkbox.tsx` | `ecosystem/fret-ui-shadcn/src/checkbox.rs` | parts | No | No | Not audited yet. |
...
| `field` | `repo-ref/ui/apps/v4/registry/bases/radix/ui/field.tsx` | `ecosystem/fret-ui-shadcn/src/field.rs` | parts | No | No | Not audited yet. |
| `hover-card` | `repo-ref/ui/apps/v4/registry/bases/radix/ui/hover-card.tsx` | `ecosystem/fret-ui-shadcn/src/hover_card.rs` | parts | No | No | Not audited yet. |
| `input` | `repo-ref/ui/apps/v4/registry/bases/radix/ui/input.tsx` | `ecosystem/fret-ui-shadcn/src/input.rs` | parts | No | No | Not audited yet. |
...
| `label` | `repo-ref/ui/apps/v4/registry/bases/radix/ui/label.tsx` | `ecosystem/fret-ui-shadcn/src/label.rs` | parts | No | No | Not audited yet. |
...
| `pagination` | `repo-ref/ui/apps/v4/registry/bases/radix/ui/pagination.tsx` | `ecosystem/fret-ui-shadcn/src/pagination.rs` | parts | No | No | Not audited yet. |
| `popover` | `repo-ref/ui/apps/v4/registry/bases/radix/ui/popover.tsx` | `ecosystem/fret-ui-shadcn/src/popover.rs` | parts | No | No | Not audited yet. |
| `progress` | `repo-ref/ui/apps/v4/registry/bases/radix/ui/progress.tsx` | `ecosystem/fret-ui-shadcn/src/progress.rs` | parts | No | No | Not audited yet. |
| `radio-group` | `repo-ref/ui/apps/v4/registry/bases/radix/ui/radio-group.tsx` | `ecosystem/fret-ui-shadcn/src/radio_group.rs` | parts | No | No | Not audited yet. |
...
| `separator` | `repo-ref/ui/apps/v4/registry/bases/radix/ui/separator.tsx` | `ecosystem/fret-ui-shadcn/src/separator.rs` | parts | No | No | Not audited yet. |
...
| `sidebar` | `repo-ref/ui/apps/v4/registry/bases/radix/ui/sidebar.tsx` | `ecosystem/fret-ui-shadcn/src/sidebar.rs` | parts | No | No | Has `useSidebar` + `use_sidebar` alias. Not audited yet. |
| `skeleton` | `repo-ref/ui/apps/v4/registry/bases/radix/ui/skeleton.tsx` | `ecosystem/fret-ui-shadcn/src/skeleton.rs` | parts | No | No | Not audited yet. |
...
| `spinner` | `repo-ref/ui/apps/v4/registry/bases/radix/ui/spinner.tsx` | `ecosystem/fret-ui-shadcn/src/spinner.rs` | parts | No | No | Not audited yet. |
| `switch` | `repo-ref/ui/apps/v4/registry/bases/radix/ui/switch.tsx` | `ecosystem/fret-ui-shadcn/src/switch.rs` | parts | No | No | Not audited yet. |
...
| `tabs` | `repo-ref/ui/apps/v4/registry/bases/radix/ui/tabs.tsx` | `ecosystem/fret-ui-shadcn/src/tabs.rs` | parts (+ helper) | No | No | Has `tabs_list_variants(...)` mapping; not audited yet. |
| `textarea` | `repo-ref/ui/apps/v4/registry/bases/radix/ui/textarea.tsx` | `ecosystem/fret-ui-shadcn/src/textarea.rs` | parts | No | No | Not audited yet. |
...
| `tooltip` | `repo-ref/ui/apps/v4/registry/bases/radix/ui/tooltip.tsx` | `ecosystem/fret-ui-shadcn/src/tooltip.rs` | parts | No | No | Not audited yet. |
