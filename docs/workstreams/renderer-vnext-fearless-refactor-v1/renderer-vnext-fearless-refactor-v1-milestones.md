...
- The baseline gate set and baseline snapshot are reproducible by another contributor.
  - Evidence: `docs/workstreams/renderer-vnext-fearless-refactor-v1/renderer-vnext-fearless-refactor-v1.md` (Appendix A — invariants checklist).
...
- Evidence anchors:
  - `docs/workstreams/renderer-vnext-fearless-refactor-v1/renderer-vnext-fearless-refactor-v1.md` (Appendix C)
...
- Evidence:
  ...
  - `docs/workstreams/external-texture-imports-v1/external-texture-imports-v1-todo.md` (`EXT-web-perf-131`)
