...
- `docs/workstreams/renderer-vnext-fearless-refactor-v1/renderer-vnext-fearless-refactor-v1-milestones.md`
...
- [x] REN-VNEXT-docs-001 Add a short “invariants checklist” appendix for renderer refactors (what must never change).
  - Evidence: `docs/workstreams/renderer-vnext-fearless-refactor-v1/renderer-vnext-fearless-refactor-v1.md` (Appendix A).
...
- [x] REN-VNEXT-plan-001 Define the internal RenderPlan IR (segments, sequence points, state snapshots).
  - Draft: `docs/workstreams/renderer-vnext-fearless-refactor-v1/renderer-vnext-fearless-refactor-v1.md` (3.1.1–3.1.5).
...
- [x] REN-VNEXT-paint-001 Inventory where `Paint` is supported vs missing (quad/path/stroke/mask).
  - Evidence: `docs/workstreams/renderer-vnext-fearless-refactor-v1/renderer-vnext-fearless-refactor-v1.md` (Appendix B).
...
- [x] REN-VNEXT-mat-001 Document the renderer’s MaterialId capability matrix and deterministic fallbacks for wasm/mobile.
  - Evidence: `docs/workstreams/renderer-vnext-fearless-refactor-v1/renderer-vnext-fearless-refactor-v1.md` (Appendix C).
...
- [x] REN-VNEXT-refactor-001 Add a renderer-internals refactor design doc (staged plan + gates).
  - Evidence: `docs/workstreams/renderer-vnext-fearless-refactor-v1/renderer-vnext-fearless-refactor-v1-refactor-design.md`
...
- [x] REN-VNEXT-sem-010 Path fill paint surface: allow `SceneOp::Path` to accept `Paint` (gradients/materials).
  ...
  - Tracking: `docs/workstreams/path-paint-surface-v1/path-paint-surface-v1.md`
- [x] REN-VNEXT-sem-020 General path stroke: introduce a “stroke arbitrary vector paths” surface with bounded stroke style.
  ...
  - Evidence: `docs/workstreams/path-stroke-style-v2/path-stroke-style-v2.md`, `crates/fret-core/src/vector_path.rs`.
- [x] REN-VNEXT-sem-030 `StrokeStyleV2`: join/cap/miter + dash semantics (and constant-px stroke width semantics as an explicit follow-up).
  ...
  - Tracking: `docs/workstreams/path-stroke-style-v2/path-stroke-style-v2.md`.
  - Evidence:
...
- [x] REN-VNEXT-sem-060 Text paint expansion: gradient/material text, text outline/stroke, and/or text shadow semantics.
  - Status (2026-02-18): v1 landed for painted text fills (solid + gradients) and a bounded text shadow surface.
    ...
    - Tracking workstream (outline/stroke):
      ...
      - Audit is recorded (atlas is coverage, not SDF/MSDF): `docs/workstreams/text-outline-stroke-surface-v1/text-outline-stroke-surface-v1-todo.md` (`TOS-audit-010`)
  - Tracking: `docs/workstreams/text-paint-surface-v1/text-paint-surface-v1.md` (purpose/TODO/milestones)
  - ADRs:
...
- [x] REN-VNEXT-sem-090 Backdrop warp/refraction (bounded): add a “backdrop warp” effect step to enable
  ...
  - Tracking:
    - `docs/workstreams/renderer-effect-backdrop-warp-v1/renderer-effect-backdrop-warp-v1.md`
    - `docs/workstreams/renderer-effect-backdrop-warp-v1/renderer-effect-backdrop-warp-v1-todo.md`
    - `docs/workstreams/renderer-effect-backdrop-warp-v1/renderer-effect-backdrop-warp-v1-milestones.md`
  - Evidence:
  ...
  - Extension (v2, texture-driven warp field):
    ...
    - Tracking:
      ...
      - `docs/workstreams/renderer-effect-backdrop-warp-v2/renderer-effect-backdrop-warp-v2-todo.md`
      - `docs/workstreams/renderer-effect-backdrop-warp-v2/renderer-effect-backdrop-warp-v2-milestones.md`
    - Evidence:
...
- [x] REN-VNEXT-sem-110 Clip-path + mask closure: keep rect scissor fast paths hot, and make slow-path
  ...
  - Tracking:
    - `docs/workstreams/renderer-clip-mask-closure-v1/renderer-clip-mask-closure-v1.md`
    - `docs/workstreams/renderer-clip-mask-closure-v1/renderer-clip-mask-closure-v1-todo.md`
    - `docs/workstreams/renderer-clip-mask-closure-v1/renderer-clip-mask-closure-v1-milestones.md`
  - Evidence:
...
- [~] REN-VNEXT-guard-003 Record a perf snapshot baseline and keep “worst bundles” attachable to milestones.
  ...
  - Evidence: `docs/workstreams/renderer-vnext-fearless-refactor-v1/renderer-vnext-fearless-refactor-v1-milestones.md` (Perf snapshot record).
...
- [~] REN-VNEXT-guard-005 Keep external texture imports perf baselines from regressing.
  ...
  - Tracking: `docs/workstreams/external-texture-imports-v1/external-texture-imports-v1.md` (see `EXT-web-perf-131`).
