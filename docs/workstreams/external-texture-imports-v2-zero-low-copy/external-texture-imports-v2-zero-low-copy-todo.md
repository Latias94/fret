...
- [x] EXTV2-adr-010 Lock ADR 0282 to “executable” detail:
  ...
  - Evidence anchors:
    ...
    - `docs/workstreams/external-texture-imports-v2-zero-low-copy/external-texture-imports-v2-zero-low-copy.md` (execution order + web WS notes)
...
- [x] EXTV2-mobile-110 Define iOS/Android capability-gated plans:
  ...
  - Evidence anchors:
    ...
    - `docs/workstreams/external-texture-imports-v2-zero-low-copy/external-texture-imports-v2-zero-low-copy.md` (Mobile plan section)
