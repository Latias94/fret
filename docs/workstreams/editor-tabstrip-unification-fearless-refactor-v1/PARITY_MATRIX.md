...
| Tab close button does **not** activate inactive tab | ✅ | ✅ | ✅ | ⚠️ unknown | Adapter policy | Workspace gate: `tools/diag-scripts/workspace/shell-demo/workspace-shell-demo-tab-close-button-does-not-activate.json`. Docking still needs an explicit non-overflow close gate. |
