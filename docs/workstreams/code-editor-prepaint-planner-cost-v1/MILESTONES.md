...
This lane should close only when the remaining planner cost is no longer the dominant tail or when
the next dominant hotspot clearly belongs in a different owner lane.
