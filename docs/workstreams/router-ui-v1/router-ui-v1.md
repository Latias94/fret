...
- `docs/workstreams/router-tanstack-parity-v1/router-tanstack-parity-v1.md` (router core + hooks + query seam)
- `docs/workstreams/state-management-v1/state-management-v1.md` (models + selectors)
- `docs/workstreams/component-ecosystem-state-integration-v1/component-ecosystem-state-integration-v1.md` (ecosystem state glue)
