...
- Workstream spec + status table:
  - `docs/workstreams/current-color-inheritance-fearless-refactor-v1/current-color-inheritance-fearless-refactor-v1.md`
- TODO list:
  - `docs/workstreams/current-color-inheritance-fearless-refactor-v1/current-color-inheritance-fearless-refactor-v1-todo.md`
