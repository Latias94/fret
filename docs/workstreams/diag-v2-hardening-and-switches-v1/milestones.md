...
- Scripts: `tools/diag-scripts/index.json`, `fretboard-dev diag registry` (`crates/fret-diag/src/commands/registry.rs`, legacy: `python tools/check_diag_scripts_registry.py`)
