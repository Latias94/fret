...
- `docs/workstreams/docking-nary-split-graph-v1/docking-nary-split-graph-v1.md` finalized.
...
- Update:
  ...
  - `docs/workstreams/docking-nary-split-graph-v1/docking-nary-split-graph-v1-todo.md` (mark done items; keep it honest).
