...
- `docs/workstreams/docking-nary-split-graph-v1/docking-nary-split-graph-v1.md`
...
- [ ] DN-P2-declarative-001 Track retained-bridge exit impact on docking UI authoring.
  - Workstream: `docs/workstreams/retained-bridge-exit-v1/retained-bridge-exit-v1.md`
