...
- Optional accelerator: Subsecond hotpatch (covered by `docs/workstreams/hotpatch-devloop-alignment-v1.md`).
...
- Workstream for Subsecond UX + no-compile channels: `docs/workstreams/hotpatch-devloop-alignment-v1.md`
...
- TODO list: `docs/workstreams/app-iteration-fast-restart-v1-todo.md`
- Milestones: `docs/workstreams/app-iteration-fast-restart-v1-milestones.md`
