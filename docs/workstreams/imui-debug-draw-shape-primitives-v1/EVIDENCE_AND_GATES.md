# ImUi Debug Draw Shape Primitives v1 Evidence And Gates
...
- `docs/workstreams/imui-debug-draw-baseline-v1/CLOSEOUT_AUDIT_2026-05-04.md`: the baseline lane
  intentionally left richer shape primitives to follow-ons.
- `docs/audits/imui-imgui-gap-audit-2026-04-22.md`: the IMUI gap audit tracks debug-draw parity
...
python -m json.tool docs/workstreams/imui-debug-draw-shape-primitives-v1/WORKSTREAM.json
