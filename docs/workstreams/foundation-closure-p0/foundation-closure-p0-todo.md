...
This document tracks cross-workstream TODOs for `docs/workstreams/foundation-closure-p0/foundation-closure-p0.md`.
...
- [ ] FC-P0-overlay-010 Add a single “conformance suite entry list” section to `docs/overlay-and-input-arbitration-v2-refactor-roadmap.md`
  ...
  - Workstream tracker: `docs/workstreams/overlay-input-arbitration-v2/overlay-input-arbitration-v2-todo.md`
...
- [ ] FC-P0-virt-030 Add a “VirtualList window derivation roadmap snapshot” section to the GPUI parity TODO tracker:
  ...
  - Workstream: `docs/workstreams/gpui-parity-refactor/gpui-parity-refactor-todo.md`
  - Contract gate: `docs/adr/0175-prepaint-windowed-virtual-surfaces.md`

## M3 — Text system v2 (UI surfaces + quality baseline)

- [ ] FC-P0-text-040 Add an “ecosystem migration checklist” table to `docs/workstreams/standalone/text-system-v2-parley.md`
...
- [x] FC-P0-mw-050 Decide where the “hovered window / set_outer_position / z-level reliability” capability quality signals live.
  ...
  - Workstream context: `docs/workstreams/docking-multiwindow-imgui-parity/docking-multiwindow-imgui-parity.md`
  - Follow-up: implement and populate them (tracked by `docs/workstreams/docking-multiwindow-imgui-parity/docking-multiwindow-imgui-parity-todo.md` `DW-P1-caps-001`).
