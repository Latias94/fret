...
- GPUI parity workstream: `docs/workstreams/gpui-parity-refactor/gpui-parity-refactor.md`

Tracking:

- TODO tracker (keep updated): `docs/workstreams/foundation-closure-p0/foundation-closure-p0-todo.md`
...
- Workstream: `docs/workstreams/overlay-input-arbitration-v2/overlay-input-arbitration-v2.md`
- TODO tracker: `docs/workstreams/overlay-input-arbitration-v2/overlay-input-arbitration-v2-todo.md`
...
- TODO tracker: `docs/workstreams/gpui-parity-refactor/gpui-parity-refactor-todo.md`
- Contract gates:
...
- Workstream: `docs/workstreams/docking-multiwindow-imgui-parity/docking-multiwindow-imgui-parity.md`
