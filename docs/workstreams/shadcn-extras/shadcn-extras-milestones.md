...
Narrative + boundaries: `docs/workstreams/shadcn-extras/shadcn-extras.md`
TODO tracker: `docs/workstreams/shadcn-extras/shadcn-extras-todo.md`
...
Decision note: documented in `docs/workstreams/shadcn-extras/shadcn-extras.md` (“Ownership decision: `Snippet` / `CodeBlock`”).
