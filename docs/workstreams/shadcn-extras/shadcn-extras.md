...
- AI-native, policy-heavy surfaces are **out of scope** here. They are owned by
  `ecosystem/fret-ui-ai` and tracked in `docs/workstreams/ai-elements-port/ai-elements-port.md`.
...
6. Attribution:
   - Add a short rustdoc note with upstream inspiration + license, and record the source in the
     `docs/workstreams/shadcn-extras/shadcn-extras-todo.md` “sources table” if/when created.
...
Milestones are tracked in `docs/workstreams/shadcn-extras/shadcn-extras-milestones.md`.
Executable TODOs live in `docs/workstreams/shadcn-extras/shadcn-extras-todo.md`.
...
- For each extras component, record its upstream inspiration in rustdoc (short) and in a small
  “sources table” in `docs/workstreams/shadcn-extras/shadcn-extras-todo.md`.
...
- The “Snippet / CodeBlock” product surface is usually policy-heavy:
  ...
  - `ecosystem/fret-ui-ai` for AI/chat-driven “message parts” (see `docs/workstreams/ai-elements-port/ai-elements-port.md`), and
