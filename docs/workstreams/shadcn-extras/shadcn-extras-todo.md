...
Milestones (one-screen): `docs/workstreams/shadcn-extras/shadcn-extras-milestones.md`
...
- [x] Add a small “component template” section to `docs/workstreams/shadcn-extras/shadcn-extras.md` (or a dedicated
