...
- Initial scaffolding landed:
  ...
  - `CheckRegistry` now owns additional post-run gates (generic + markdown/code-editor UI gallery gates, including folds/inlays) to reduce `post_run_checks.rs` churn.
