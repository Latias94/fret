...
- Layout sidecar viewer affordance (CLI): `crates/fret-diag/src/commands/layout_sidecar.rs`
...
- Runtime snapshot extensions registry: `ecosystem/fret-bootstrap/src/ui_diagnostics/extensions.rs`
