...
Workstream narrative: `docs/workstreams/ai-elements-port/ai-elements-port.md`
Milestone board (one-screen): `docs/workstreams/ai-elements-port/ai-elements-port-milestones.md`
Upstream inventory + mapping: `docs/workstreams/standalone/ai-elements-upstream-alignment.md`
...
- [x] AIEL-MVP0-audit-013 Record a docs-parity + text-infra migration matrix for `fret-ui-ai`.
  - Evidence: `docs/workstreams/standalone/ai-elements-upstream-alignment.md` (`2026-03-07 closure audit`).
...
- [x] AIEL-FLOW-001 Land a declarative “world layer” substrate for canvas-space element subtrees.
  ...
  - Workstream: `docs/workstreams/canvas-world-layer-v1/canvas-world-layer-v1.md`
...
- [x] AIEL-FLOW-005 Add a bounds reporting seam for world-layer nodes (fit view + selection queries).
  ...
  - Anchor: `docs/workstreams/standalone/xyflow-gap-analysis.md` (Gap F)
  - Workstream: `docs/workstreams/canvas-world-layer-v1/canvas-world-layer-v1.md` (M2)
...
| `web-preview` | Prototype | `fret-ui-ai` | Chrome port exists (`WebPreview*`) with UI Gallery demo + diag gate: `tools/diag-scripts/ui-gallery-ai-web-preview-demo-commit-console.json`. Embedded native webview backend is host-owned and available behind `fret-launch/webview-wry` + `fret-ui-gallery/webview-wry` (see `docs/workstreams/webview-wry-v1/webview-wry-v1.md`), with additional gates: `tools/diag-scripts/ui-gallery-ai-web-preview-demo-webview-wry-nav.json`, `tools/diag-scripts/ui-gallery-ai-web-preview-demo-webview-wry-console.json`, `tools/diag-scripts/ui-gallery-ai-web-preview-demo-webview-wry-console-clear.json`. |
...
- [x] AIEL-MVP3-code-003 `Commit` / `StackTrace` / `TestResults` surfaces (only after CodeBlock is solid).
  ...
  - Parity polish checklist (make it measurable):
    ...
    - [x] Re-audit upstream TS (`commit.tsx`, `stack-trace.tsx`, `test-results.tsx`) and document known deltas in `docs/workstreams/ai-elements-port/ai-elements-port.md`.
...
- [x] AIEL-MVP0-foundation-013 Add a short “Public API rules” section to the workstream and keep it updated.
  - Target: `docs/workstreams/ai-elements-port/ai-elements-port.md` (parts, controlled/uncontrolled, intents not effects, stable selectors).
- [x] AIEL-MVP0-foundation-014 Add “Version stamp” update rules (pinned upstream commit must be updated first).
  - Target: `docs/workstreams/ai-elements-port/ai-elements-port.md`
...
- [~] AIEL-MVP0-webpreview-002 Close the v1 backend loop (navigation state + URL reflection) and document limitations.
  - Source of truth: `docs/workstreams/webview-wry-v1/webview-wry-v1.md` + TODO tracker.
- [x] AIEL-MVP0-webpreview-002 Define WebView integration plan and crate boundaries (contract + wry backend).
  ...
  - TODOs: `docs/workstreams/webview-wry-v1/webview-wry-v1-todo.md`
