...
Milestone board (one-screen): `docs/workstreams/ai-elements-port/ai-elements-port-milestones.md`.

Related workstreams:

- WebView backend plan (native, `wry`): `docs/workstreams/webview-wry-v1/webview-wry-v1.md` and
  `docs/workstreams/webview-wry-v1/webview-wry-v1-todo.md`.
- XYFlow/ReactFlow backend gap analysis (workflow editor substrate): `docs/workstreams/standalone/xyflow-gap-analysis.md`.

## Next up (priority order)

Upstream coverage is now **complete at the “ported (prototype)” level** (see
`docs/workstreams/standalone/ai-elements-upstream-alignment.md`). The next focus is tightening parity and
...
3. Track deeper XYFlow/ReactFlow parity gaps (world-layer element subtrees, dash patterns, markers)
   as a separate optional workstream (`docs/workstreams/standalone/xyflow-gap-analysis.md`).
...
- `WebPreview`: AI Elements-aligned web preview chrome (navigation + URL input + console disclosure). Feature-gated native embedding exists via `wry` (see `docs/workstreams/webview-wry-v1/webview-wry-v1.md`); chrome-only remains the default when the backend is not enabled.
...
`docs/workstreams/ai-elements-port/ai-elements-port-todo.md`.
...
Tracking and milestones live in: `docs/workstreams/ai-elements-port/ai-elements-port-todo.md`.
...
- A TODO tracker with milestones and regression gates: `docs/workstreams/ai-elements-port/ai-elements-port-todo.md`.
