...
Source of truth for detailed TODOs: `docs/workstreams/ai-elements-port/ai-elements-port-todo.md`.
Narrative + contracts: `docs/workstreams/ai-elements-port/ai-elements-port.md`.
...
- `WebPreview` chrome v0 is ported with a UI Gallery demo + diag gate:
  ...
  - Optional native embedding is available behind `wry` (see `docs/workstreams/webview-wry-v1/webview-wry-v1.md`) with gates:
...
- Keep `docs/workstreams/ai-elements-port/ai-elements-port-todo.md` honest (mark blockers with a concrete bundle + step id).
