...
- v1 baseline: `docs/workstreams/imui-authoring-facade-v1/imui-authoring-facade-v1.md`
- v1 tracker: `docs/workstreams/imui-authoring-facade-v1/imui-authoring-facade-v1-todo.md`
- unified patch chain ADR: `docs/adr/0160-unified-authoring-builder-surface-v1.md`
- unified builder workstream: `docs/workstreams/unified-authoring-builder-v1/unified-authoring-builder-v1.md`
...
- [x] IMUI2-bridge-021 Decide and document where token/preset helpers live (kit vs shadcn vs app).
  ...
  - Evidence: `docs/workstreams/imui-authoring-facade-v2/imui-authoring-facade-v2.md` (decision snapshot).
...
- [x] IMUI2-docs-051 Update workstream docs and demos to point to v2.
  - Evidence: `docs/workstreams/imui-authoring-facade-v2/imui-authoring-facade-v2.md`, `docs/workstreams/imui-authoring-facade-v1/imui-authoring-facade-v1.md`, `apps/fret-examples/src/imui_hello_demo.rs`.
