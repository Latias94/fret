...
| --- | --- | --- | --- | --- | --- | --- |
| App installer composition | mixed `install_app`, `install`, and ad-hoc bundle patterns | canonical installer functions plus `InstallIntoApp` for composition | add a thin trait adapter over existing installer functions | official examples use one consistent app wiring story | Scaffolding only | `docs/adr/0148-component-ecosystem-authoring-conventions-v1.md`, `ecosystem/fret/src/lib.rs`, `DESIGN.md` |
