...
- Workstream narrative: `docs/workstreams/canvas-world-layer-v1/canvas-world-layer-v1.md`
...
- [x] CWL-M3-001 Document an input arbitration recipe:
  ...
  - Reference: `docs/workstreams/standalone/xyflow-gap-analysis.md` (Gap B)
