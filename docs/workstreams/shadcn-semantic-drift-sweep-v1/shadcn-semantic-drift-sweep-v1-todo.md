...
- `docs/workstreams/shadcn-semantic-drift-sweep-v1/shadcn-semantic-drift-sweep-v1.md`
...
- [ ] Update the drift inventory in `docs/workstreams/shadcn-semantic-drift-sweep-v1/shadcn-semantic-drift-sweep-v1.md` as new
  issues are found.
