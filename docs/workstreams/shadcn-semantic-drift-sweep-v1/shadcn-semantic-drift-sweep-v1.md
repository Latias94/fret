...
- Started converting shadcn recipe callsites to `Theme::snapshot()` where only token reads are needed.
  ...
  - Tracking: `docs/workstreams/shadcn-semantic-drift-sweep-v1/shadcn-semantic-drift-sweep-v1-todo.md` (Token read sweep section)
...
- Milestones: `docs/workstreams/shadcn-semantic-drift-sweep-v1/shadcn-semantic-drift-sweep-v1-milestones.md`
- TODO list: `docs/workstreams/shadcn-semantic-drift-sweep-v1/shadcn-semantic-drift-sweep-v1-todo.md`
...
- 2026-02-26: Wired the new responsive semantics conformance scripts into the built-in diag suites
  (`fretboard-dev diag suite ui-gallery-shadcn-conformance`) to keep the drift gates executable.
