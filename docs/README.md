...
- Action write surface follow-on (active planning lane for the remaining default app-lane write budget):
  ...
  - Scope note: default app-lane `cx.actions()` write budget only; selector/query/router stay out
