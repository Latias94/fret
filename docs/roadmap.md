...
- Iconify acquisition pre-step follow-on (active narrow lane for explicit remote/pinned acquisition that produces local artifacts for the closed generator lane, without hiding network inside `icons import`): `docs/workstreams/iconify-acquisition-prestep-v1/DESIGN.md`, `docs/workstreams/iconify-acquisition-prestep-v1/TODO.md`, `docs/workstreams/iconify-acquisition-prestep-v1/MILESTONES.md`, and `docs/workstreams/iconify-acquisition-prestep-v1/EVIDENCE_AND_GATES.md`.
