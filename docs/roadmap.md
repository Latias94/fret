...
- Immediate-mode stack fearless refactor v2 (current in-tree `imui` source of truth): `docs/workstreams/imui-stack-fearless-refactor-v2/DESIGN.md`, `docs/workstreams/imui-stack-fearless-refactor-v2/TODO.md`, `docs/workstreams/imui-stack-fearless-refactor-v2/MILESTONES.md`, and `docs/workstreams/imui-stack-fearless-refactor-v2/BASELINE_AUDIT_2026-03-31.md`.
