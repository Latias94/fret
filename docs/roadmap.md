...
- Public authoring state lanes + identity contract (closed closeout lane for LocalState-first default teaching, explicit raw-model naming, kernel/facade substrate convergence, full example migration, and the default app-facing render-authoring closure; deprecated `UiCx` removal now lives on an explicit narrower release-facing follow-on): `docs/workstreams/public-authoring-state-lanes-and-identity-fearless-refactor-v1/DESIGN.md`, `docs/workstreams/public-authoring-state-lanes-and-identity-fearless-refactor-v1/TODO.md`, `docs/workstreams/public-authoring-state-lanes-and-identity-fearless-refactor-v1/MILESTONES.md`, `docs/workstreams/public-authoring-state-lanes-and-identity-fearless-refactor-v1/MIGRATION_MATRIX.md`, `docs/workstreams/public-authoring-state-lanes-and-identity-fearless-refactor-v1/CLOSEOUT_AUDIT_2026-04-19.md`, and `docs/adr/0319-public-authoring-state-lanes-and-identity-contract-v1.md`.
- UiCx compat alias release retirement (active narrow release-facing follow-on that freezes the remaining deprecated compatibility alias family on the published `fret` surface, keeps canonical teaching on `AppComponentCx` / `AppRender*`, and decides the removal window + migration criteria explicitly instead of reopening the broad authoring lane): `docs/workstreams/uicx-compat-alias-release-retirement-v1/DESIGN.md`, `docs/workstreams/uicx-compat-alias-release-retirement-v1/M0_BASELINE_AUDIT_2026-04-19.md`, `docs/workstreams/uicx-compat-alias-release-retirement-v1/EVIDENCE_AND_GATES.md`, and `docs/workstreams/uicx-compat-alias-release-retirement-v1/WORKSTREAM.json`.
...
9. keep `public-authoring-state-lanes-and-identity-fearless-refactor-v1` closed as the current
   closeout record for the default render-authoring surface, and use
   `uicx-compat-alias-release-retirement-v1` as the only active release-facing follow-on before
   reconsidering deprecated `UiCx` removal or reopening broader storage-model / mutation-owner
   debates,
