...
- Immediate-mode stack reset (current in-tree `imui` source of truth): `docs/workstreams/imui-stack-fearless-refactor-v1/DESIGN.md`, `docs/workstreams/imui-stack-fearless-refactor-v1/TODO.md`, and `docs/workstreams/imui-stack-fearless-refactor-v1/MILESTONES.md`.
