...
use fret_diag::regression_summary::{
    ...
    RegressionSummaryV1, regression_bundle_followup_command_lines,
...
use followup_panel::{
    followup_history_list, materialize_baseline_compare_followup_command,
    runnable_followup_command_actions, selected_followup_readiness_lines,
};
