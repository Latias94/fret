...
fn paint_viewport_translate_gizmo(
    ...
    scene.push(SceneOp::Quad {
        order: DrawOrder(6),
        rect: x_axis,
        background: Paint::Solid(x_color).into(),
        border: Edges::all(Px(0.0)),
        border_paint: Paint::TRANSPARENT.into(),
        corner_radii: Corners::all(Px(0.0)),
    });
    scene.push(SceneOp::Quad {
        order: DrawOrder(6),
        rect: y_axis,
        background: Paint::Solid(y_color).into(),
        border: Edges::all(Px(0.0)),
        border_paint: Paint::TRANSPARENT.into(),
        corner_radii: Corners::all(Px(0.0)),
    });
...
fn paint_viewport_selection_rect(content: Rect, rect: ViewportSelectionRect, scene: &mut Scene) {
    ...
    scene.push(SceneOp::Quad {
        order: DrawOrder(4),
        rect: inner,
        background: Paint::Solid(rect.fill).into(),
        border: Edges::all(Px(0.0)),
        border_paint: Paint::TRANSPARENT.into(),
        corner_radii: Corners::all(Px(0.0)),
    });
    ...
    for r in [top_rect, bottom_rect, left_rect, right_rect] {
        scene.push(SceneOp::Quad {
            order: DrawOrder(5),
            rect: r,
            background: Paint::Solid(rect.stroke).into(),
            border: Edges::all(Px(0.0)),
            border_paint: Paint::TRANSPARENT.into(),
            corner_radii: Corners::all(Px(0.0)),
        });
...
fn paint_viewport_marquee(
    ...
    for r in [top_rect, bottom_rect, left_rect, right_rect] {
        scene.push(SceneOp::Quad {
            order: DrawOrder(7),
            rect: r,
            background: Paint::Solid(stroke).into(),
            border: Edges::all(Px(0.0)),
            border_paint: Paint::TRANSPARENT.into(),
            corner_radii: Corners::all(Px(0.0)),
        });
