...
Examples:
  ...
  fretboard diag perf ui-gallery --repeat 5 --warmup-frames 5 --perf-baseline-out .fret/perf.baseline.json --perf-baseline-headroom-pct 20 --perf-baseline-seed tools/diag-scripts/ui-gallery-window-resize-stress-steady.json@top_total_time_us=p90 --launch -- cargo run -p fret-ui-gallery --release
