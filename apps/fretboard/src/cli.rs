...
Usage:
  ...
  fretboard diag triage <bundle_dir|bundle.json> [--top <n>] [--sort <invalidation|time|dispatch|hit_test|encode_scene|prepare_text|draw_calls|pipeline_switches|bind_group_switches>] [--warmup-frames <n>] [--json] [--out <path>]
