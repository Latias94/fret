...
Usage:
  ...
  fretboard diag run <script.json> [--dir <dir>] [--timeout-ms <ms>] [--poll-ms <ms>] [--script-path <path>] [--script-trigger-path <path>] [--script-result-path <path>] [--script-result-trigger-path <path>] [--pack] [--pack-out <path>] [--include-all] [--include-root-artifacts] [--include-triage] [--include-screenshots] [--json] [--check-stale-paint <test_id>] [--check-stale-paint-eps <px>] [--check-stale-scene <test_id>] [--check-stale-scene-eps <px>] [--check-wheel-scroll <test_id>] [--check-drag-cache-root-paint-only <test_id>] [--check-hover-layout] [--check-hover-layout-max <n>] [--check-gc-sweep-liveness] [--check-view-cache-reuse-min <n>] [--check-prepaint-actions-min <n>] [--check-layout-fast-path-min <n>] [--check-vlist-policy-key-stable] [--check-vlist-window-mismatch-min <n>] [--check-vlist-window-prefetch-min <n>] [--check-overlay-synthesis-min <n>] [--check-viewport-input-min <n>] [--check-dock-drag-min <n>] [--check-viewport-capture-min <n>] [--check-retained-vlist-reconcile-no-notify <n>] [--check-retained-vlist-prefetch-reconciles-min <n>] [--check-retained-vlist-prefetch-reconciles-max <n>] [--check-retained-vlist-attach-detach-max <n>] [--check-retained-vlist-scroll-window-dirty-max <n>] [--check-vlist-scroll-window-dirty-max <n>] [--check-vlist-prefetch-window-dirty-max <n>] [--env <KEY=VALUE>...] [--launch -- <cmd...>]
  fretboard diag suite <ui-gallery|ui-gallery-layout|ui-gallery-virt-retained|ui-gallery-tree-retained|ui-gallery-data-table-retained|ui-gallery-table-retained|ui-gallery-retained-measured|ui-gallery-vlist-window-boundary|ui-gallery-ui-kit-list-retained|docking-arbitration|components-gallery-file-tree|components-gallery-table|script.json...> [--dir <dir>] [--timeout-ms <ms>] [--poll-ms <ms>] [--script-path <path>] [--script-trigger-path <path>] [--script-result-path <path>] [--script-result-trigger-path <path>] [--json] [--check-stale-paint <test_id>] [--check-stale-paint-eps <px>] [--check-stale-scene <test_id>] [--check-stale-scene-eps <px>] [--check-wheel-scroll <test_id>] [--check-drag-cache-root-paint-only <test_id>] [--check-hover-layout] [--check-hover-layout-max <n>] [--check-gc-sweep-liveness] [--check-view-cache-reuse-min <n>] [--check-prepaint-actions-min <n>] [--check-layout-fast-path-min <n>] [--check-vlist-policy-key-stable] [--check-vlist-window-mismatch-min <n>] [--check-vlist-window-prefetch-min <n>] [--check-overlay-synthesis-min <n>] [--check-viewport-input-min <n>] [--check-dock-drag-min <n>] [--check-viewport-capture-min <n>] [--check-retained-vlist-reconcile-no-notify <n>] [--check-retained-vlist-prefetch-reconciles-min <n>] [--check-retained-vlist-prefetch-reconciles-max <n>] [--check-retained-vlist-attach-detach-max <n>] [--check-retained-vlist-scroll-window-dirty-max <n>] [--check-vlist-scroll-window-dirty-max <n>] [--check-vlist-prefetch-window-dirty-max <n>] [--env <KEY=VALUE>...] [--launch -- <cmd...>]
  fretboard diag stats <bundle_dir|bundle.json> [--top <n>] [--sort <invalidation|time>] [--json] [--check-stale-paint <test_id>] [--check-stale-paint-eps <px>] [--check-stale-scene <test_id>] [--check-stale-scene-eps <px>] [--check-wheel-scroll <test_id>] [--check-drag-cache-root-paint-only <test_id>] [--check-hover-layout] [--check-hover-layout-max <n>] [--check-gc-sweep-liveness] [--check-view-cache-reuse-min <n>] [--check-prepaint-actions-min <n>] [--check-layout-fast-path-min <n>] [--check-vlist-policy-key-stable] [--check-vlist-window-mismatch-min <n>] [--check-vlist-window-prefetch-min <n>] [--check-overlay-synthesis-min <n>] [--check-viewport-input-min <n>] [--check-dock-drag-min <n>] [--check-viewport-capture-min <n>] [--check-retained-vlist-reconcile-no-notify <n>] [--check-retained-vlist-prefetch-reconciles-min <n>] [--check-retained-vlist-prefetch-reconciles-max <n>] [--check-retained-vlist-attach-detach-max <n>] [--check-retained-vlist-scroll-window-dirty-max <n>] [--check-vlist-scroll-window-dirty-max <n>] [--check-vlist-prefetch-window-dirty-max <n>]
  fretboard diag matrix ui-gallery [--dir <dir>] [--timeout-ms <ms>] [--poll-ms <ms>] [--warmup-frames <n>] [--compare-eps-px <px>] [--compare-ignore-bounds] [--compare-ignore-scene-fingerprint] [--check-view-cache-reuse-min <n>] [--check-overlay-synthesis-min <n>] [--check-viewport-input-min <n>] [--check-dock-drag-min <n>] [--check-viewport-capture-min <n>] [--check-retained-vlist-reconcile-no-notify <n>] [--check-retained-vlist-prefetch-reconciles-min <n>] [--check-retained-vlist-prefetch-reconciles-max <n>] [--check-retained-vlist-attach-detach-max <n>] [--env <KEY=VALUE>...] [--launch -- <cmd...>] [--json]
  ...
  fretboard diag perf <ui-gallery|script.json...> [--top <n>] [--sort <invalidation|time>] [--repeat <n>] [--timeout-ms <ms>] [--poll-ms <ms>] [--dir <dir>] [--json] [--check-stale-paint <test_id>] [--check-stale-paint-eps <px>] [--check-wheel-scroll <test_id>] [--check-drag-cache-root-paint-only <test_id>] [--check-hover-layout] [--check-hover-layout-max <n>] [--check-gc-sweep-liveness] [--check-view-cache-reuse-min <n>] [--check-prepaint-actions-min <n>] [--check-layout-fast-path-min <n>] [--check-vlist-policy-key-stable] [--check-vlist-window-mismatch-min <n>] [--check-overlay-synthesis-min <n>] [--check-viewport-input-min <n>] [--check-dock-drag-min <n>] [--check-viewport-capture-min <n>] [--check-retained-vlist-reconcile-no-notify <n>] [--check-retained-vlist-prefetch-reconciles-min <n>] [--check-retained-vlist-attach-detach-max <n>] [--env <KEY=VALUE>...] [--launch -- <cmd...>]
