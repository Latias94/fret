...
Usage:
  ...
  fretboard diag pack [<bundle_dir|bundle.json|bundle.schema2.json>] [--dir <dir>] [--pack-out <path>] [--include-all] [--include-root-artifacts] [--include-triage] [--include-screenshots]
  ...
  fretboard dev web --open [--port <port>] [--demo <demo> | --choose]
...
Examples:
  ...
  fretboard dev web --open --demo custom_effect_v2_web_demo
"#
    );
    Ok(())
}
