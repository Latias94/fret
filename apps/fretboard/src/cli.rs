...
Usage:
  ...
  fretboard diag trace <bundle_dir|bundle.json> [--trace-out <path>]
  ...
  fretboard diag triage <bundle_dir|bundle.json> [--top <n>] [--sort <key>] [--warmup-frames <n>] [--json] [--out <path>]
    fretboard diag lint <bundle_dir|bundle.json> [--warmup-frames <n>] [--all-test-ids] [--lint-eps-px <px>] [--json] [--out <path>]
    fretboard diag hotspots [<bundle_dir|bundle.json>] [--hotspots-top <n>] [--max-depth <n>] [--min-bytes <n>] [--force] [--json] [--out <path>]
    fretboard diag bundle-v2 [<bundle_dir|bundle.json>] [--mode <all|changed|last|off>] [--pretty] [--force] [--json] [--out <path>]
    fretboard diag meta <bundle_dir|bundle.json> [--warmup-frames <n>] [--json] [--out <path>]
    fretboard diag index <bundle_dir|bundle.json> [--warmup-frames <n>] [--json] [--out <path>]
    fretboard diag test-ids <bundle_dir|bundle.json> [--warmup-frames <n>] [--max-test-ids <n>] [--json] [--out <path>]
  fretboard diag ai-packet [<bundle_dir|bundle.json>] [--test-id <test_id>] [--packet-out <dir>] [--include-triage] [--warmup-frames <n>]
  fretboard diag query test-id [<bundle_dir|bundle.json>] <pattern> [--mode <contains|prefix|glob>] [--top <n>] [--case-sensitive] [--json] [--out <path>]
  fretboard diag slice [<bundle_dir|bundle.json>] --test-id <test_id> [--frame-id <n>] [--snapshot-seq <n>] [--window <id>] [--max-matches <n>] [--max-ancestors <n>] [--json] [--out <path>]
