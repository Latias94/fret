...
Usage:
  ...
  fretboard diag triage <bundle_dir|bundle.json> [--top <n>] [--sort <invalidation|time|dispatch|hit_test|encode_scene|prepare_text|draw_calls|pipeline_switches|bind_group_switches|atlas_upload_bytes|atlas_evicted_pages|intermediate_peak_bytes|pool_evictions>] [--warmup-frames <n>] [--json] [--out <path>]
  fretboard diag script <script.json> [--dir <dir>] [--script-path <path>] [--script-trigger-path <path>]
  fretboard diag run <script.json> [--dir <dir>] [--timeout-ms <ms>] [--poll-ms <ms>] [--script-path <path>] [--script-trigger-path <path>] [--script-result-path <path>] [--script-result-trigger-path <path>] [--pack] [--pack-out <path>] [--include-all] [--include-root-artifacts] [--include-triage] [--include-screenshots] [--json] [--check-stale-paint <test_id>] [--check-stale-paint-eps <px>] [--check-stale-scene <test_id>] [--check-stale-scene-eps <px>] [--check-idle-no-paint-min <n>] [--check-pixels-changed <test_id>] [--check-semantics-changed-repainted] [--dump-semantics-changed-repainted-json] [--check-wheel-scroll <test_id>] [--check-drag-cache-root-paint-only <test_id>] [--check-hover-layout] [--check-hover-layout-max <n>] [--check-gc-sweep-liveness] [--check-view-cache-reuse-min <n>] [--check-view-cache-reuse-stable-min <n>] [--check-overlay-synthesis-min <n>] [--check-viewport-input-min <n>] [--check-dock-drag-min <n>] [--check-viewport-capture-min <n>] [--check-retained-vlist-reconcile-no-notify <n>] [--check-retained-vlist-attach-detach-max <n>] [--env <KEY=VALUE>...] [--launch -- <cmd...>]
  fretboard diag repro <ui-gallery|docking-arbitration|script.json...> [--dir <dir>] [--timeout-ms <ms>] [--poll-ms <ms>] [--max-working-set-bytes <n>] [--max-peak-working-set-bytes <n>] [--max-cpu-avg-percent-total-cores <pct>] [--script-path <path>] [--script-trigger-path <path>] [--script-result-path <path>] [--script-result-trigger-path <path>] [--pack-out <path>] [--include-all] [--include-root-artifacts] [--include-triage] [--include-screenshots] [--json] [--check-stale-paint <test_id>] [--check-stale-paint-eps <px>] [--check-stale-scene <test_id>] [--check-stale-scene-eps <px>] [--check-idle-no-paint-min <n>] [--check-pixels-changed <test_id>] [--check-semantics-changed-repainted] [--dump-semantics-changed-repainted-json] [--check-wheel-scroll <test_id>] [--check-drag-cache-root-paint-only <test_id>] [--check-hover-layout] [--check-hover-layout-max <n>] [--check-gc-sweep-liveness] [--check-view-cache-reuse-min <n>] [--check-view-cache-reuse-stable-min <n>] [--check-overlay-synthesis-min <n>] [--check-viewport-input-min <n>] [--check-dock-drag-min <n>] [--check-viewport-capture-min <n>] [--check-retained-vlist-reconcile-no-notify <n>] [--check-retained-vlist-attach-detach-max <n>] [--with <tracy|renderdoc>] [--renderdoc-after-frames <n>] [--renderdoc-marker <substring>] [--renderdoc-no-outputs-png] [--env <KEY=VALUE>...] [--launch -- <cmd...>]
  fretboard diag suite <ui-gallery|ui-gallery-layout|ui-gallery-virt-retained|ui-gallery-tree-retained|ui-gallery-data-table-retained|ui-gallery-table-retained|ui-gallery-retained-measured|ui-gallery-vlist-window-boundary|ui-gallery-ui-kit-list-retained|docking-arbitration|components-gallery-file-tree|components-gallery-table|script.json...> [--dir <dir>] [--timeout-ms <ms>] [--poll-ms <ms>] [--script-path <path>] [--script-trigger-path <path>] [--script-result-path <path>] [--script-result-trigger-path <path>] [--json] [--check-stale-paint <test_id>] [--check-stale-paint-eps <px>] [--check-stale-scene <test_id>] [--check-stale-scene-eps <px>] [--check-idle-no-paint-min <n>] [--check-pixels-changed <test_id>] [--check-semantics-changed-repainted] [--dump-semantics-changed-repainted-json] [--check-wheel-scroll <test_id>] [--check-drag-cache-root-paint-only <test_id>] [--check-hover-layout] [--check-hover-layout-max <n>] [--check-gc-sweep-liveness] [--check-view-cache-reuse-min <n>] [--check-view-cache-reuse-stable-min <n>] [--check-overlay-synthesis-min <n>] [--check-viewport-input-min <n>] [--check-dock-drag-min <n>] [--check-viewport-capture-min <n>] [--check-retained-vlist-reconcile-no-notify <n>] [--check-retained-vlist-attach-detach-max <n>] [--env <KEY=VALUE>...] [--launch -- <cmd...>]
  fretboard diag stats <bundle_dir|bundle.json> [--top <n>] [--sort <invalidation|time|dispatch|hit_test|encode_scene|prepare_text|draw_calls|pipeline_switches|bind_group_switches|atlas_upload_bytes|atlas_evicted_pages|intermediate_peak_bytes|pool_evictions>] [--json] [--check-stale-paint <test_id>] [--check-stale-paint-eps <px>] [--check-stale-scene <test_id>] [--check-stale-scene-eps <px>] [--check-idle-no-paint-min <n>] [--check-pixels-changed <test_id>] [--check-semantics-changed-repainted] [--dump-semantics-changed-repainted-json] [--check-wheel-scroll <test_id>] [--check-drag-cache-root-paint-only <test_id>] [--check-hover-layout] [--check-hover-layout-max <n>] [--check-gc-sweep-liveness] [--check-view-cache-reuse-min <n>] [--check-view-cache-reuse-stable-min <n>] [--check-overlay-synthesis-min <n>] [--check-viewport-input-min <n>] [--check-dock-drag-min <n>] [--check-viewport-capture-min <n>] [--check-retained-vlist-reconcile-no-notify <n>] [--check-retained-vlist-attach-detach-max <n>]
  fretboard diag matrix ui-gallery [--dir <dir>] [--timeout-ms <ms>] [--poll-ms <ms>] [--warmup-frames <n>] [--compare-eps-px <px>] [--compare-ignore-bounds] [--compare-ignore-scene-fingerprint] [--check-view-cache-reuse-min <n>] [--check-view-cache-reuse-stable-min <n>] [--check-overlay-synthesis-min <n>] [--check-viewport-input-min <n>] [--check-dock-drag-min <n>] [--check-viewport-capture-min <n>] [--check-retained-vlist-reconcile-no-notify <n>] [--check-retained-vlist-attach-detach-max <n>] [--env <KEY=VALUE>...] [--launch -- <cmd...>] [--json]
  ...
  fretboard diag perf <ui-gallery|ui-gallery-steady|script.json...> [--top <n>] [--sort <invalidation|time|dispatch|hit_test|encode_scene|prepare_text|draw_calls|pipeline_switches|bind_group_switches|atlas_upload_bytes|atlas_evicted_pages|intermediate_peak_bytes|pool_evictions>] [--repeat <n>] [--max-top-total-us <n>] [--max-top-layout-us <n>] [--max-top-solve-us <n>] [--perf-baseline <path>] [--perf-baseline-out <path>] [--perf-baseline-headroom-pct <n>] [--timeout-ms <ms>] [--poll-ms <ms>] [--dir <dir>] [--json] [--check-stale-paint <test_id>] [--check-stale-paint-eps <px>] [--check-stale-scene <test_id>] [--check-stale-scene-eps <px>] [--check-pixels-changed <test_id>] [--check-wheel-scroll <test_id>] [--check-drag-cache-root-paint-only <test_id>] [--check-hover-layout] [--check-hover-layout-max <n>] [--check-gc-sweep-liveness] [--check-view-cache-reuse-min <n>] [--check-view-cache-reuse-stable-min <n>] [--check-overlay-synthesis-min <n>] [--check-viewport-input-min <n>] [--check-dock-drag-min <n>] [--check-viewport-capture-min <n>] [--check-retained-vlist-reconcile-no-notify <n>] [--check-retained-vlist-attach-detach-max <n>] [--reuse-launch] [--env <KEY=VALUE>...] [--launch -- <cmd...>]
...
Examples:
  ...
  fretboard diag perf ui-gallery --repeat 5 --warmup-frames 5 --perf-baseline-out .fret/perf.baseline.json --perf-baseline-headroom-pct 20 --launch -- cargo run -p fret-ui-gallery --release
  ...
  fretboard diag perf ui-gallery-steady --reuse-launch --repeat 7 --sort time --json --launch -- cargo run -p fret-ui-gallery --release
