...
Usage:
  ...
  fretboard diag triage <bundle_dir|bundle.json|bundle.schema2.json> [--top <n>] [--sort <key>] [--warmup-frames <n>] [--json] [--out <path>]
    ...
    fretboard diag dock-routing <bundle_dir|bundle.json|bundle.schema2.json> [--warmup-frames <n>] [--json]
    fretboard diag screenshots <bundle_dir|bundle.json|bundle.schema2.json> [--json]
