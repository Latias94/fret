...
mod authoring_surface_policy_tests {
    ...
    fn mutation_toast_feedback_example_keeps_submit_and_feedback_projection_split() {
        ...
        assert!(normalized.contains("cx.data().update_locals_after_mutation_completion("));
        assert!(normalized.contains("cx.actions().mutation_submit::<act::SavePreset"));
    ...
    fn cookbook_imui_example_keeps_current_facade_teaching_surface() {
        assert_current_imui_teaching_surface(
            ...
            &[
                ...
                "cookbook.imui_action_basics.button.imui.payload.row",
    ...
    fn cookbook_imui_debug_draw_example_keeps_current_facade_teaching_surface() {
        assert_current_imui_teaching_surface(
            ...
            &[
                ...
                "response.command_summaries()",
                "response.list_summary()",
    ...
    fn cookbook_imui_editor_example_keeps_public_editor_facade_teaching_surface() {
        assert_current_imui_teaching_surface(
            ...
            &[
                ...
                "fret_cookbook::scaffold::centered_page_muted(cx, TEST_ID_ROOT, surface)",
                "imui_in(cx, move |ui| {",
    ...
    fn advanced_examples_use_the_explicit_advanced_surface() {
        ...
        assert!(DOCKING_EXAMPLE.contains("surface.driver().on_dock_op(app, op)"));
