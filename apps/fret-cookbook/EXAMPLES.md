...
[`imui_editor_controls_basics.rs`](./examples/imui_editor_controls_basics.rs) | Official | `cookbook-imui` | `cargo run -p fretboard-dev -- dev native --example imui_editor_controls_basics` | `cookbook-imui-editor-controls-basics`
