    ...
    app.with_global_mut(UiGalleryHarnessDiagnosticsStore::default, |store, _app| {
        store.per_window.insert(
            ...
            UiGalleryHarnessModelIds {
                ...
                motion_preset: state.motion_preset.clone(),
                motion_preset_open: state.motion_preset_open.clone(),
                view_cache_enabled: state.view_cache_enabled.clone(),
                view_cache_cache_shell: state.view_cache_cache_shell.clone(),
                view_cache_cache_content: state.view_cache_cache_content.clone(),
                view_cache_inner_enabled: state.view_cache_inner_enabled.clone(),
                view_cache_popover_open: state.view_cache_popover_open.clone(),
                view_cache_continuous: state.view_cache_continuous.clone(),
                view_cache_counter: state.view_cache_counter.clone(),
