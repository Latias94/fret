...
pub(super) fn word_boundary_controls(
    ...
    ui::h_row(move |cx| {
        ...
        *word_debug.borrow_mut() = format_word_boundary_debug(text.as_str(), caret);
        ...
        let prev_char: fret_ui::action::OnActivate = Arc::new(move |host, action_cx, _reason| {
        ...
        let next_char: fret_ui::action::OnActivate = Arc::new(move |host, action_cx, _reason| {
        ...
        let prev_word: fret_ui::action::OnActivate = Arc::new(move |host, action_cx, _reason| {
        ...
        let next_word: fret_ui::action::OnActivate = Arc::new(move |host, action_cx, _reason| {
        ...
        let apply_caret: fret_ui::action::OnActivate = Arc::new(move |host, action_cx, _reason| {
        ...
        let apply_word: fret_ui::action::OnActivate = Arc::new(move |host, action_cx, _reason| {
...
pub(super) fn word_boundary_debug_view(
    ...
    ui::v_flex(move |cx| {
        ...
        let lines: Vec<Arc<str>> = debug
            ...
            .collect();
        let debug_lines = ui::v_flex(move |cx| {
            lines
                .iter()
                .cloned()
                .map(|line| {
