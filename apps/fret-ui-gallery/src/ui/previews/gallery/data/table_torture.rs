...
pub(in crate::ui) fn preview_data_table_torture(
    ...
    cx.keyed(
        ("data_table_torture_reset_epoch", reset_epoch_value),
        |cx| {
            ...
            let status_filter_text: Arc<str> = {
                ...
                match value {
                    ...
                    Some(serde_json::Value::String(s)) => {
                        Arc::<str>::from(format!("StatusFilter: {s}"))
                    }
            ...
            let toolbar = shadcn::DataTableToolbar::new(
                state.clone(),
                toolbar_columns,
                |col: &ColumnDef<Row>| Arc::<str>::from(col.id.as_ref()),
            )
            .column_filter("name")
            ...
            let header = ui::v_flex(move |cx| {
                vec![
                    ...
                    doc_layout::control_readout_text(cx, global_filter_text.clone())
                        .attach_semantics(
                            SemanticsDecoration::default()
                                .role(fret_core::SemanticsRole::Text)
                    ...
                    doc_layout::control_readout_text(cx, name_filter_text.clone())
                        .attach_semantics(
                            SemanticsDecoration::default()
                                .role(fret_core::SemanticsRole::Text)
                    ...
                    doc_layout::control_readout_text(cx, status_filter_text.clone())
                        .attach_semantics(
                            SemanticsDecoration::default()
                                .role(fret_core::SemanticsRole::Text)
