    ...
    ui::h_row(|cx| {
        vec![
            shadcn::toggle_uncontrolled(
                cx,
                false,
                |cx| ui::children![cx; decl_text::text_button_label(cx, "Small")],
            )
            ...
            shadcn::toggle_uncontrolled(
                cx,
                false,
                |cx| ui::children![cx; decl_text::text_button_label(cx, "Default")],
            )
            .variant(shadcn::ToggleVariant::Outline)
            ...
            shadcn::toggle_uncontrolled(
                cx,
                false,
                |cx| ui::children![cx; decl_text::text_button_label(cx, "Large")],
            )
            .variant(shadcn::ToggleVariant::Outline)
