...
pub fn render(cx: &mut AppComponentCx<'_>) -> impl UiChild + use<> {
    ui::v_flex(|cx| {
        vec![
            story_block(
                shadcn::typography::h1("Taxing Laughter: The Joke Tax Chronicles"),
                None,
            )
            .into_element(cx),
            story_block(
            ...
            .into_element(cx),
            story_block(
                shadcn::typography::h2("The King's Plan"),
                Some(Px(40.0)),
            )
            .into_element(cx),
            story_block(
            ...
            .into_element(cx),
            story_block(
                shadcn::typography::h3("The Joke Tax")
                    .into_element(cx)
            ...
            .into_element(cx),
            story_block(
                shadcn::typography::h3("Jokester's Revolt"),
                Some(Px(32.0)),
            )
            .into_element(cx),
            story_block(
            ...
            .into_element(cx),
            story_block(
                shadcn::typography::h3("The People's Rebellion"),
                Some(Px(32.0)),
            )
            .into_element(cx),
            story_block(
