pub const SOURCE: &str = include_str!("natural_language_picker.rs");
...
pub fn render(cx: &mut UiCx<'_>) -> impl UiChild + use<> {
        ...
        .into_element_with(
            ...
            move |cx| {
                shadcn::PopoverContent::new([calendar(cx)])
                    ...
                    .into_element(cx)
                    .test_id("ui-gallery.calendar.natural-language.content")
            },
        );
    ...
    shadcn::Field::new([
        ...
        shadcn::InputGroup::new(value)
            ...
            .control_test_id("ui-gallery.calendar.natural-language.control")
    ...
    .into_element(cx)
    .test_id("ui-gallery.calendar.natural-language")
}
// endregion: example
