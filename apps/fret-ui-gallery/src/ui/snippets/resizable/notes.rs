...
pub fn render(cx: &mut AppComponentCx<'_>) -> impl UiChild + use<> {
    ui::v_flex(|cx| {
            vec![
                ...
                shadcn::typography::muted(
                    "`Adaptive Panel Proof`, `Multi-Viewport Combobox`, `Multi-Viewport Select`, `Moving Cached Combobox`, and `Moving Cached Popover` stay diagnostics opt-in because they are mechanism proofs, not default docs smoke content.",
                ).into_element(cx),
                shadcn::typography::muted(
                    "Resizable groups expose their own semantics; keep an eye on focus order and hit-testing near handles.",
                ).into_element(cx),
                shadcn::typography::muted(
                    "Evidence anchors: `ecosystem/fret-ui-shadcn/tests/web_vs_fret_layout/resizable.rs`, `apps/fret-ui-gallery/src/driver/render_flow.rs`, `tools/diag-scripts/ui-gallery/resizable/ui-gallery-resizable-adaptive-panel-proof.json`, `tools/diag-scripts/ui-gallery/resizable/ui-gallery-resizable-multi-viewport-combobox-placement.json`, `tools/diag-scripts/ui-gallery/resizable/ui-gallery-resizable-multi-viewport-select-placement.json`, `tools/diag-scripts/ui-gallery/resizable/ui-gallery-resizable-view-cache-moving-combobox-root-boundary.json`, `tools/diag-scripts/ui-gallery/resizable/ui-gallery-resizable-view-cache-moving-popover-outside-press.json`, and `tools/diag-scripts/ui-gallery/resizable/`.",
                ).into_element(cx),
                shadcn::typography::muted(
