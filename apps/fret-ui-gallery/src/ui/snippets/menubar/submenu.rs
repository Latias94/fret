...
pub fn render(cx: &mut UiCx<'_>) -> impl UiChild + use<> {
    ...
    let file = shadcn::MenubarMenu::new("File").entries([
        shadcn::MenubarEntry::Submenu(
            shadcn::MenubarItem::new("Share").submenu([
                shadcn::MenubarEntry::Item(shadcn::MenubarItem::new("Email link").action(
                    CommandId::new("ui_gallery.menubar.submenu.share.email_link"),
                )),
    ...
    let edit = shadcn::MenubarMenu::new("Edit").entries([
        ...
        shadcn::MenubarEntry::Separator,
        shadcn::MenubarEntry::Submenu(
            shadcn::MenubarItem::new("Find").submenu([
                shadcn::MenubarEntry::Item(
