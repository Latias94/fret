    ...
    let body = doc_layout::render_doc_page(
        ...
        vec![
            DocSection::new("Sizes", sizes)
                ...
                .code_rust_from_file_region(include_str!("../snippets/spinner/sizes.rs"), "example"),
            DocSection::new("Buttons", buttons)
                .max_w(Px(980.0))
                .test_id_prefix("ui-gallery-spinner-buttons")
                .code_rust_from_file_region(
                    include_str!("../snippets/spinner/buttons.rs"),
                    "example",
                ),
            DocSection::new("Badges", badges)
                ...
                .code_rust_from_file_region(
                    include_str!("../snippets/spinner/badges.rs"),
                    "example",
                ),
            DocSection::new("Input Group", input_group)
                ...
                .code_rust_from_file_region(
                    include_str!("../snippets/spinner/input_group.rs"),
                    "example",
                ),
            DocSection::new("Empty", empty)
                .max_w(Px(980.0))
                .test_id_prefix("ui-gallery-spinner-empty")
                .code_rust_from_file_region(include_str!("../snippets/spinner/empty.rs"), "example"),
            DocSection::new("RTL", rtl)
                .max_w(Px(760.0))
                .test_id_prefix("ui-gallery-spinner-rtl")
                .code_rust_from_file_region(include_str!("../snippets/spinner/rtl.rs"), "example"),
            DocSection::new("Extras", extras)
                .no_shell()
                .test_id_prefix("ui-gallery-spinner-extras")
                .code_rust_from_file_region(include_str!("../snippets/spinner/extras.rs"), "example"),
