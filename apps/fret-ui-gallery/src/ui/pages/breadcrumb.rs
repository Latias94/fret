    ...
    let body = doc_layout::render_doc_page(
        ...
        vec![
            DocSection::new("Demo", demo)
                ...
                .code_rust_from_file_region(include_str!("../snippets/breadcrumb/demo.rs"), "example"),
            DocSection::new("Basic", basic)
                .title_test_id("ui-gallery-breadcrumb-section-title-basic")
                .description("A minimal breadcrumb list with three items.")
                .code_rust_from_file_region(include_str!("../snippets/breadcrumb/basic.rs"), "example"),
            DocSection::new("Custom Separator", custom_separator)
                ...
                .code_rust_from_file_region(
                    include_str!("../snippets/breadcrumb/custom_separator.rs"),
                    "example",
                ),
            DocSection::new("Dropdown", dropdown)
                ...
                .code_rust_from_file_region(
                    include_str!("../snippets/breadcrumb/dropdown.rs"),
                    "example",
                ),
            DocSection::new("Collapsed", collapsed)
                ...
                .code_rust_from_file_region(
                    include_str!("../snippets/breadcrumb/collapsed.rs"),
                    "example",
                ),
            DocSection::new("Link Component", link_component)
                ...
                .code_rust_from_file_region(
                    include_str!("../snippets/breadcrumb/link_component.rs"),
                    "example",
                ),
            DocSection::new("RTL", rtl)
                ...
                .code_rust_from_file_region(include_str!("../snippets/breadcrumb/rtl.rs"), "example"),
