    ...
    let body = doc_layout::render_doc_page(
        ...
        vec![
            DocSection::new("Demo", demo)
                ...
                .code_rust_from_file_region(include_str!("../snippets/aspect_ratio/demo.rs"), "example"),
            ...
            DocSection::new("RTL", rtl)
                ...
                .code_rust_from_file_region(include_str!("../snippets/aspect_ratio/rtl.rs"), "example"),
