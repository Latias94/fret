    ...
    let body = doc_layout::render_doc_page(
        ...
        vec![
            DocSection::new("Setup", setup)
                ...
                .code_rust_from_file_region(include_str!("../snippets/sonner/setup.rs"), "example"),
            DocSection::new("Demo", demo)
                .description("Buttons that fire different toast styles and actions.")
                .max_w(Px(980.0))
                .test_id_prefix("ui-gallery-sonner-demo")
                .code_rust_from_file_region(include_str!("../snippets/sonner/demo.rs"), "example"),
            DocSection::new("Position", position)
                ...
                .code_rust_from_file_region(
                    include_str!("../snippets/sonner/position.rs"),
                    "example",
                ),
            DocSection::new("Extras", extras)
                ...
                .code_rust_from_file_region(include_str!("../snippets/sonner/extras.rs"), "example"),
