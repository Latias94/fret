    ...
    let body = doc_layout::render_doc_page(
        ...
        vec![
            DocSection::new("Announcement", announcement)
                ...
                .code(
                    "rust",
                    r#"shadcn::extras::Announcement::new([
    shadcn::extras::AnnouncementTag::new("New").into_element(cx),
    shadcn::extras::AnnouncementTitle::new([cx.text("Shadcn Extras landed in Fret")])
        .into_element(cx),
])
.into_element(cx);"#,
            ...
            DocSection::new("Banner (dismissible)", banner)
                ...
                .code(
                    "rust",
                    r#"let icon = shadcn::icon::icon(cx, fret_icons::IconId::new_static("lucide.info"));
shadcn::extras::Banner::new([
    shadcn::extras::BannerIcon::new(icon).into_element(cx),
    shadcn::extras::BannerTitle::new("A new version is available.").into_element(cx),
    shadcn::extras::BannerAction::new("Upgrade").into_element(cx),
...
.into_element(cx);"#,
            ...
            DocSection::new("Tags", tags)
                ...
                .code(
                    "rust",
                    r#"shadcn::extras::Tags::new(["Alpha", "Beta", "Gamma", "A much longer tag label"])
    .into_element(cx);"#,
                ),
            DocSection::new("Marquee (pause on hover)", marquee)
                ...
                .code(
                    "rust",
                    r#"shadcn::extras::Marquee::new(["Alpha", "Beta", "Gamma", "Delta", "Epsilon"])
    .pause_on_hover(true)
    .refine_layout(LayoutRefinement::default().w_full())
    .into_element(cx);"#,
                ),
            DocSection::new("Kanban (drag & drop)", kanban)
                ...
                .code(
                    "rust",
                    r#"let items = cx.app.models_mut().insert(vec![
    shadcn::extras::KanbanItem::new("card-1", "Write docs", "backlog"),
    shadcn::extras::KanbanItem::new("card-2", "Ship", "done"),
]);
let columns = vec![
    shadcn::extras::KanbanColumn::new("backlog", "Backlog"),
    shadcn::extras::KanbanColumn::new("done", "Done"),
...
shadcn::extras::Kanban::new(columns, items)
    .into_element_with(cx, |_cx, item, _ctx| {
        // Provide card body per item
        ui::text(_cx, item.name.clone()).into_element(_cx)
    });"#,
                ),
            DocSection::new("Ticker", ticker_row)
                ...
                .code(
                    "rust",
                    r#"shadcn::extras::Ticker::new("AAPL")
    .price("$199.18")
    .change("+1.01%")
    .change_kind(shadcn::extras::TickerChangeKind::Up)
    .into_element(cx);"#,
            ...
            DocSection::new("Relative time", relative_time)
                ...
                .code(
                    "rust",
                    r#"shadcn::extras::RelativeTime::new([
    shadcn::extras::RelativeTimeZone::new("UTC", "February 9, 2026", "15:04:05").into_element(cx),
    shadcn::extras::RelativeTimeZone::new("PST", "February 9, 2026", "07:04:05").into_element(cx),
])
.into_element(cx);"#,
                ),
            DocSection::new("Rating", rating)
                ...
                .code(
                    "rust",
                    r#"shadcn::extras::Rating::uncontrolled(3)
    .count(5)
    .into_element(cx);"#,
                ),
            DocSection::new("Avatar stack", avatar_stack)
                ...
                .code(
                    "rust",
                    r#"let a = shadcn::Avatar::new([shadcn::AvatarFallback::new("A").into_element(cx)]);
let b = shadcn::Avatar::new([shadcn::AvatarFallback::new("B").into_element(cx)]);
let c = shadcn::Avatar::new([shadcn::AvatarFallback::new("C").into_element(cx)]);

shadcn::extras::AvatarStack::new([a, b, c])
    .size_px(Px(40.0))
    .max_visible(4)
    .into_element(cx);"#,
                ),
