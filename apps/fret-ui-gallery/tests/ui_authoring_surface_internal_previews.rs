...
fn harness_virtual_list_torture_uses_fixed_row_text_roles() {
    let normalized = assert_normalized_markers_present(
        ...
        &[
            ...
            "fnvirtual_list_row_label_action<T,I>(cx:&mutAppComponentCx<'_>,theme:&Theme,label:T,test_id:I,on_activate:fret_ui::action::OnActivate,)->AnyElement",
            "cx.pressable(fret_ui::element::PressableProps{",
            "fret_ui_kit::declarative::text::text_button_label_fill(cx,label.clone())",
            "fnvirtual_list_row_action_button<T,I>(cx:&mutAppComponentCx<'_>,theme:&Theme,label:T,test_id:I,variant:shadcn::ButtonVariant,layout:LayoutRefinement,on_activate:fret_ui::action::OnActivate,)->AnyElement",
