...
pub(super) struct EditorAdvancedModels {
    pub(super) pos_x: Model<f64>,
    pub(super) pos_y: Model<f64>,
    pub(super) pos_z: Model<f64>,
    pub(super) position_outcome: Model<String>,
    pub(super) rot_x: Model<f64>,
    pub(super) rot_y: Model<f64>,
    pub(super) rot_z: Model<f64>,
    pub(super) scl_x: Model<f64>,
    pub(super) scl_y: Model<f64>,
    pub(super) scl_z: Model<f64>,
    pub(super) transform_outcome: Model<String>,
    pub(super) iterations: Model<i32>,
    pub(super) exposure: Model<f64>,
}
