...
fn create_window_state(
    driver: &mut DataTableDemoDriver,
    app: &mut App,
    window: AppWindowId,
) -> DemoWindowState {
    <DataTableDemoDriver as WinitAppDriver>::create_window_state(driver, app, window)
}
...
fn hot_reload_window(
    ...
    <DataTableDemoDriver as WinitAppDriver>::hot_reload_window(driver, app, services, window, state)
}
...
fn handle_model_changes(
    ...
    <DataTableDemoDriver as WinitAppDriver>::handle_model_changes(driver, context, changed)
}
...
fn handle_global_changes(
    ...
    <DataTableDemoDriver as WinitAppDriver>::handle_global_changes(driver, context, changed)
}
...
fn handle_command(
    ...
    <DataTableDemoDriver as WinitAppDriver>::handle_command(driver, context, command)
}
...
fn handle_event(
    ...
    <DataTableDemoDriver as WinitAppDriver>::handle_event(driver, context, event)
}

fn render(driver: &mut DataTableDemoDriver, context: WinitRenderContext<'_, DemoWindowState>) {
    <DataTableDemoDriver as WinitAppDriver>::render(driver, context)
}
...
pub fn run() -> anyhow::Result<()> {
    ...
    crate::run_native_with_compat_driver(config, app, driver).context("run datatable_demo app")
}
