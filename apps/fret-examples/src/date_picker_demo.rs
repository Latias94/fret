...
fn render(_driver: &mut DatePickerDemoDriver, context: WinitRenderContext<'_, DemoWindowState>) {
    ...
    let root = render_root_with_app_ui(
        ...
        move |cx| {
            ...
            let instructions = text::paragraph(
                cx,
                Arc::from(
