...
fn create_window_state(
    driver: &mut DatePickerDemoDriver,
    app: &mut App,
    window: AppWindowId,
) -> DemoWindowState {
    <DatePickerDemoDriver as WinitAppDriver>::create_window_state(driver, app, window)
}
...
fn hot_reload_window(
    ...
    <DatePickerDemoDriver as WinitAppDriver>::hot_reload_window(
...
fn handle_model_changes(
    ...
    <DatePickerDemoDriver as WinitAppDriver>::handle_model_changes(driver, context, changed)
}
...
fn handle_global_changes(
    ...
    <DatePickerDemoDriver as WinitAppDriver>::handle_global_changes(driver, context, changed)
}
...
fn handle_command(
    ...
    <DatePickerDemoDriver as WinitAppDriver>::handle_command(driver, context, command)
}
...
fn handle_event(
    ...
    <DatePickerDemoDriver as WinitAppDriver>::handle_event(driver, context, event)
}

fn render(driver: &mut DatePickerDemoDriver, context: WinitRenderContext<'_, DemoWindowState>) {
    <DatePickerDemoDriver as WinitAppDriver>::render(driver, context)
}
...
pub fn run() -> anyhow::Result<()> {
    ...
    crate::run_native_with_compat_driver(config, app, driver).context("run date_picker_demo app")
}
