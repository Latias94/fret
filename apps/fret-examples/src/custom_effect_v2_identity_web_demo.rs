...
struct CustomEffectV2IdentityWebModelOwner<'a> {
    models: &'a mut CustomEffectV2IdentityWebModelStore,
}

impl<'a> CustomEffectV2IdentityWebModelOwner<'a> {
    fn new(models: &'a mut CustomEffectV2IdentityWebModelStore) -> Self {
        Self { models }
    }
    ...
    fn reset_controls(&mut self, controls: &DemoControls) -> bool {
        ...
        changed = self.set_model(&controls.mix01, vec![0.65]) || changed;
...
#[derive(Clone)]
struct CustomEffectV2IdentityWebViewSettings {
    enabled: bool,
    mode_value: String,
    ...
    fn lens(
        ...
        cx.container(
            ...
            move |cx| {
                ...
                let badge_text = Self::overlay_label_text(cx, "Custom Effect V2 (Starter)");
            ...
            let stage = cx.container(
                ...
                move |cx| {
                    ...
                    let hint_text = Self::overlay_readout_text(
                        cx,
                        "Press V to toggle the lens. Press R to reset controls.",
