...
fn view(cx: &mut ElementContext<'_, App>, _st: &mut ()) -> Vec<AnyElement> {
    ...
    let content = shadcn::CardContent::new(vec![
        stack::hstack(
            cx,
...
fn render_image_panel(
    ...
    stack::vstack(
        cx,
        stack::VStackProps::default()
            .layout(LayoutRefinement::default().flex_1())
            .gap(Space::N3)
            .items_start(),
        |cx| {
        ...
        |cx| {
            ...
            vec![
                ...
                cx.container(
                    ...
                    |cx| match icon.as_ref() {
                        Some(props) => vec![cx.svg_icon_props(props.clone())],
                        None => vec![cx.spinner()],
                    },
                ),
            ]
