...
fn editor_notes_device_shell_demo_keeps_shell_switch_explicit_and_reuses_inner_editor_content() {
    ...
    for needle in [
        ...
        "fn device_shell_section_text<'a, Cx, T>",
        "fn device_shell_paragraph_text<'a, Cx, T>",
        ...
        "editor_notes_demo::editor_asset_paint_snapshot(cx, &mobile_asset)",
