...
fn assert_custom_effect_v2_web_shared_control_binding_helper(source: &str) {
    ...
    for needle in [
        ...
        "pub(crate)structCustomEffectV2ScalarControl{",
        "model:Model<Vec<f32>>,",
        "default:f32,",
        ...
        "pub(crate)fnuv_span(&self)->&CustomEffectV2ScalarControl",
    ...
    for needle in [
        ...
        "owner.set_model(&self.uv_span,vec![defaults.uv_span])",
        "models.insert(vec![defaults.uv_span])",
    ] {
        assert!(
            !compact_source.contains(needle),
...
fn assert_custom_effect_v2_web_common_controls_use_binding(
    ...
    for needle in [
        ...
        "CustomEffectV2ScalarControl,".to_string(),
        ...
        "binding.uv_span().values()".to_string(),
        "binding.uv_span().clamped_value(uv_span,0.05,1.0)".to_string(),
...
fn custom_effect_v2_web_common_controls_use_binding() {
    ...
    assert_custom_effect_v2_web_common_controls_use_binding(CustomEffectV2WebBindingContract {
        ...
        variant_reset_markers: &[
            ...
            "CustomEffectV2ScalarControl::new(app.models_mut(), 14.0)",
            "CustomEffectV2ScalarControl::new(app.models_mut(), 18.0)",
            "CustomEffectV2ScalarControl::new(app.models_mut(), 0.8)",
            "self.strength_px.reset(reset)",
            "self.max_sample_offset_px.reset(reset)",
            "controls.strength_px.values()",
            "controls.max_sample_offset_px.values()",
            "controls.strength_px.clamped_value(strength_px, 0.0, 24.0)",
            "controls.blur_downsample.rounded_u32_value(",
...
fn custom_effect_v2_identity_web_common_controls_use_binding() {
    ...
    assert_custom_effect_v2_web_common_controls_use_binding(CustomEffectV2WebBindingContract {
        ...
        variant_reset_markers: &[
            ...
            "CustomEffectV2ScalarControl::new(app.models_mut(), 0.65)",
            "self.mix01.reset(reset)",
            "controls.mix01.values()",
            "controls.mix01.clamped_value(mix01, 0.0, 1.0)",
...
fn custom_effect_v2_lut_web_common_controls_use_binding() {
    ...
    assert_custom_effect_v2_web_common_controls_use_binding(CustomEffectV2WebBindingContract {
        ...
        variant_reset_markers: &[
            ...
            "const PARAM_DEBUG_INPUT: CustomEffectV2ParamSlot = CustomEffectV2ParamSlot::new(0, 2);",
            "strength_px: CustomEffectV2ScalarControl,",
            "CustomEffectV2ScalarControl::new(app.models_mut(), 0.85)",
            "CustomEffectV2ScalarControl::new(app.models_mut(), 0.0)",
            "CustomEffectV2ScalarControl::new(app.models_mut(), 0.5)",
            "self.strength_px.reset(reset)",
            "self.max_sample_offset_px.reset(reset)",
            "controls.strength_px.values()",
            "controls.max_sample_offset_px.values()",
            "controls.strength_px.clamped_value(strength_px, 0.0, 1.0)",
            "controls.blur_downsample.rounded_u32_value(",
...
fn custom_effect_v2_glass_chrome_web_common_controls_use_binding() {
    ...
    assert_custom_effect_v2_web_common_controls_use_binding(CustomEffectV2WebBindingContract {
        ...
        variant_reset_markers: &[
            ...
            "CustomEffectV2ScalarControl::new(app.models_mut(), 0.95)",
            "CustomEffectV2ScalarControl::new(app.models_mut(), 36.0)",
            "CustomEffectV2ScalarControl::new(app.models_mut(), 1.0)",
            "self.strength.reset(reset)",
            "self.shininess.reset(reset)",
            "controls.strength.values()",
            "controls.shininess.values()",
            "controls.strength.clamped_value(strength, 0.0, 2.0)",
