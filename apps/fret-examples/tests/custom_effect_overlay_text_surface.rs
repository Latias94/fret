...
fn assert_custom_effect_v2_web_shared_control_binding_helper(source: &str) {
    ...
    for needle in [
        ...
        "pub(crate)structCustomEffectV2ScalarSpec{",
        "pub(crate)structCustomEffectV2ScalarControl{",
        "model:Model<Vec<f32>>,",
        "spec:CustomEffectV2ScalarSpec,",
        "pub(crate)fnslider(&self)->Slider",
        "pub(crate)traitCustomEffectV2ScalarControlFactory{",
        "fnscalar_control(&mutself,spec:CustomEffectV2ScalarSpec)->CustomEffectV2ScalarControl;",
        "implCustomEffectV2ScalarControlFactoryforModelStore{",
...
fn assert_custom_effect_v2_web_common_controls_use_binding(
    ...
    for needle in [
        ...
        "CustomEffectV2ScalarSpec,".to_string(),
        ...
        "CustomEffectV2ScalarControlFactory,CustomEffectV2ScalarSpec,CustomEffectV2WebControlBinding,"
            .to_string(),
        "fnnew(models:&mutimplCustomEffectV2ScalarControlFactory)->Self".to_string(),
        "models.scalar_control(".to_string(),
        "CustomEffectV2WebControlBinding::new(app.models_mut())".to_string(),
        "letcontrols=DemoControls::new(app.models_mut());".to_string(),
        ...
        "binding.uv_span().clamped_value(uv_span)".to_string(),
    ...
    for needle in [
        ...
        "state.show",
        "ModelStore",
        "CustomEffectV2ScalarControl::new(",
...
fn custom_effect_v2_web_common_controls_use_binding() {
    ...
    assert_custom_effect_v2_web_common_controls_use_binding(CustomEffectV2WebBindingContract {
        ...
        variant_reset_markers: &[
            ...
            "controls.strength_px.clamped_value(strength_px)",
            "controls.blur_downsample.rounded_u32_value(blur_downsample)",
...
fn custom_effect_v2_identity_web_common_controls_use_binding() {
    ...
    assert_custom_effect_v2_web_common_controls_use_binding(CustomEffectV2WebBindingContract {
        ...
        variant_reset_markers: &[
            ...
            "controls.mix01.clamped_value(mix01)",
            "binding.uv_span().slider().into_element(cx)",
...
fn custom_effect_v2_glass_chrome_web_common_controls_use_binding() {
    ...
    assert_custom_effect_v2_web_common_controls_use_binding(CustomEffectV2WebBindingContract {
        ...
        variant_reset_markers: &[
            ...
            "controls.strength.clamped_value(strength)",
