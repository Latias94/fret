...
# Intentional cookbook-only exceptions. Keep this aligned with the workstream docs when the
# allowlist changes.
ALLOWED: dict[str, dict[str, str]] = {
    "apps/fret-cookbook/examples/async_inbox_basics.rs": {
        "act::Start": "background dispatcher/inbox scheduling and wake integration",
    },
    "apps/fret-cookbook/examples/router_basics.rs": {
        "act::RouterBack": "router command availability sync on the host path",
        "act::RouterForward": "router command availability sync on the host path",
    },
    "apps/fret-cookbook/examples/toast_basics.rs": {
        "act::DefaultToast": "Sonner toast dispatch requires UiActionHost + window",
        "act::SuccessToast": "Sonner toast dispatch requires UiActionHost + window",
        "act::DismissAll": "Sonner toast dispatch requires UiActionHost + window",
    },
    "apps/fret-cookbook/examples/undo_basics.rs": {
        "act::Undo": "history traversal is coupled to a RAF effect",
