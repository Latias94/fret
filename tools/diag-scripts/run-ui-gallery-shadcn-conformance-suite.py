...
Cross-platform helper that wraps:
  `cargo run -p fretboard-dev -- diag suite ui-gallery-shadcn-conformance`
...
def main(argv: list[str]) -> int:
    ap = argparse.ArgumentParser(
        description="Run `fretboard-dev diag suite ui-gallery-shadcn-conformance` (optionally launching UI Gallery).",
