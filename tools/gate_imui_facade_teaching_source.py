...
def main() -> None:
    checks = [
        ...
        SourceCheck(
            Path("apps/fret-examples/src/imui_editor_proof_demo/authoring_parity/common.rs"),
            required=[
        ...
        SourceCheck(
            ...
            required=[
                ...
                "render_editor_inspector_surface(",
        ...
        SourceCheck(
            Path("apps/fret-examples/src/imui_editor_proof_demo/editor_text_assist.rs"),
            required=[
                "pub(super) fn render_editor_name_assist_surface(",
                "editor_demo_name_assist_items(cx)",
                "TextAssistField::new(",
                "TextAssistFieldOptions {",
        ...
        SourceCheck(
            Path("apps/fret-examples/src/imui_editor_proof_demo/authoring_parity/surface.rs"),
            required=[
                "use super::common::{",
                ...
                "render_authoring_parity_imui_host<H, F>(",
                "common_build_authoring_parity_gradient_editor(",
                "common_render_authoring_parity_imui_host(cx, f)",
                "authoring_parity_shading_items()",
            ],
            forbidden=COMMON_DELETED_OR_NON_TEACHING,
        ),
        SourceCheck(
            Path("apps/fret-examples/src/imui_editor_proof_demo/authoring_parity/declarative.rs"),
            required=[
        ...
        SourceCheck(
            Path("apps/fret-examples/src/imui_editor_proof_demo/authoring_parity/imui.rs"),
            required=[
