...
def main() -> None:
    ...
    collection_rename_commit_tests_fixtures = Path(
        "apps/fret-examples/src/imui_editor_proof_demo/collection/rename/commit/tests/fixtures.rs"
    )
    ...
    collection_selection_keyboard_navigation_tests_fixtures = Path(
        "apps/fret-examples/src/imui_editor_proof_demo/collection/selection/keyboard/navigation/tests/fixtures.rs"
    )
    ...
    collection_children = (
        ...
        collection_rename_commit_tests_fixtures,
        ...
        collection_selection_keyboard_navigation_tests_fixtures,
    ...
    checks = [
        ...
        SourceCheck(
            "collection inline rename commit tests fixtures owner",
            collection_rename_commit_tests_fixtures,
            required=[
        ...
        SourceCheck(
            "collection selection keyboard navigation tests fixtures owner",
            collection_selection_keyboard_navigation_tests_fixtures,
            required=[
