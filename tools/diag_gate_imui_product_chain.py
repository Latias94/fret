...
def _validate_devtools_gui_product_workflow_source(repo_root: Path) -> None:
    ...
    for marker in (
        ...
        "fn selected_followup_latest_result_path_from_state(",
        "fn selected_followup_latest_result_json_from_state(",
...
def _validate_devtools_gui_followup_source(repo_root: Path) -> None:
    ...
    for marker in (
        ...
        "pub(crate) fn followup_result_history_latest_path",
        "pub(crate) fn followup_result_history_latest_json",
