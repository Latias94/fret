    ...
    checks = [
        ...
        SourceCheck(
            ...
            required=[
                ...
                "Covered for basic/sort/resize/striped-row, static column visibility, and explicit row/cell background proof paths",
                ...
                "runtime hideable-column policy, persistence, header-menu policy, and old columns",
