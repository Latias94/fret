...
use support::headless_overlay_cases::{
    Material3OverlayTooltipKindV1, load_material3_overlay_golden_suite_v1,
};
...
fn material3_headless_overlays_suite_goldens_v1() {
    ...
    fn select_from_fixture(
        ...
        trigger: &support::headless_overlay_cases::Material3OverlaySelectTriggerV1,
