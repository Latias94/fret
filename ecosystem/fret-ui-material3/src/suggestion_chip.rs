//! Material 3 suggestion chip (MVP).
//!
//! Outcome-oriented implementation:
//! - Token-driven shape/colors via `md.comp.suggestion-chip.*` (v30 sassvars subset).
...
pub enum SuggestionChipVariant {
    #[default]
    Flat,
    Elevated,
}
...
pub struct SuggestionChipStyle {
...
impl std::fmt::Debug for SuggestionChip {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("SuggestionChip")
...
impl SuggestionChip {
    pub fn new(label: impl Into<Arc<str>>) -> Self {
        Self {
            label: label.into(),
            leading_icon: None,
            variant: SuggestionChipVariant::default(),
            action: None,
            on_activate: None,
            style: SuggestionChipStyle::default(),
            disabled: false,
            a11y_label: None,
            test_id: None,
    ...
    pub fn variant(mut self, variant: SuggestionChipVariant) -> Self {
        self.variant = variant;
        self
    }

    /// Bind a stable action ID to this suggestion chip (action-first authoring).
    ...
    pub fn style(mut self, style: SuggestionChipStyle) -> Self {
