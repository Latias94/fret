...
use fret_workspace::commands::{
    CMD_WORKSPACE_PANE_FOCUS_CONTENT, CMD_WORKSPACE_PANE_TOGGLE_TAB_STRIP_FOCUS,
};
use fret_workspace::layout::{WorkspacePaneTree, WorkspaceWindowLayout};
use fret_workspace::{
    WorkspaceCommandScope, WorkspacePaneContentFocusTarget, WorkspaceTabStrip,
                ...
                let content = cx.pressable(
                    PressableProps {
                        ...
                        a11y: PressableA11y {
                            ...
                            test_id: Some(Arc::from(format!("pane-{}-content", pane.id.as_ref()))),
                            ..Default::default()
                        },
                        ..Default::default()
                    },
