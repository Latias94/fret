...
use fret_workspace::commands::CMD_WORKSPACE_PANE_TOGGLE_TAB_STRIP_FOCUS;
...
fn render_frame(
    ...
    let root = fret_ui::declarative::render_root(
        ...
        window,
        bounds,
        "workspace-command-scope-toggle-tabstrip",
        move |cx| {
...
#[test]
fn toggle_tab_strip_focus_toggles_between_content_and_tab_strip() {
    ...
    // Render another frame so `WorkspaceCommandScope` records the focused element before toggling
