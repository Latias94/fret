...
#[test]
fn tanstack_v8_selection_parity() {
    ...
    assert_eq!(fixture.case_id, "selection");
    ...
    for snap in fixture.snapshots {
        ...
        for action in &snap.actions {
            ...
            // Keep a stable column order for the remaining engine outputs.
            // (Selection fixtures focus on row selection; other states are set via `snap.state`.)
