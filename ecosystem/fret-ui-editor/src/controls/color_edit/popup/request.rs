...
use super::super::state::{draft_model, error_model};
use super::super::{
...
use super::body::{ColorPopupBodyArgs, color_popup_body};

pub(in crate::controls::color_edit) fn request_popup_overlay<H: UiHost>(
    ...
    text_input_text_style: fret_core::TextStyle,
    error_color: Color,
