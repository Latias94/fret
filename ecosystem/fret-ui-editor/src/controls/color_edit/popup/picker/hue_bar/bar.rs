...
use super::super::super::super::model::{hsv_from_color, hue_percent_text};
use super::super::{HSV_PICKER_SIZE, picker_border_and_ring};
use super::interaction::apply_hue_bar_position;
use super::preview::hue_bar_preview_stack;

pub(in crate::controls::color_edit::popup) fn hue_bar<H: UiHost>(
