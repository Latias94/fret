//! TextField single-line entry mount and session wiring owner.
...
use super::super::super::buffered::{self, BufferedTextFieldState, TextFieldDraftController};
use super::super::super::{
    OnTextFieldOutcome, TextFieldAssistiveSemantics, TextFieldBlurBehavior, TextFieldMode,
};
use super::super::buffered_keys::{
    TextFieldBufferedKeyHandlerArgs, TextFieldBufferedKeyMode,
    install_buffered_text_field_key_handler,
};
use super::super::entry_props::{TextFieldInputPropsArgs, text_field_input_props};
use super::super::focus::{TextFieldFocusSelectionArgs, sync_text_field_focus_selection};

pub(super) struct TextFieldSingleLineEntryArgs {
...
pub(super) fn text_field_single_line_entry<H: UiHost>(
    ...
    args: TextFieldSingleLineEntryArgs,
) -> AnyElement {
    let TextFieldSingleLineEntryArgs {
        model,
        draft,
        buffered_state,
