//! TextField multiline entry mount and session wiring owner.
...
use super::super::super::{OnTextFieldOutcome, TextFieldBlurBehavior};
...
use super::super::entry_props::{TextFieldAreaPropsArgs, text_field_area_props};
use super::super::escape_clear::install_text_field_escape_clear_handler;
use super::super::focus::{TextFieldFocusSelectionArgs, sync_text_field_focus_selection};

pub(super) struct TextFieldMultilineEntryArgs {
...
pub(super) fn text_field_multiline_entry<H: UiHost>(
    cx: &mut ElementContext<'_, H>,
    args: TextFieldMultilineEntryArgs,
) -> AnyElement {
    let TextFieldMultilineEntryArgs {
        model,
        draft,
        buffered_state,
