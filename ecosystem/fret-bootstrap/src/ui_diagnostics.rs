...
use fret_diag_protocol::{
    ...
    UiShortcutRoutingTraceEntryV1, UiShortcutRoutingTraceQueryV1,
    UiSizeV1, UiTaskbarVisibilityV1, UiTextInputSnapshotV1, UiTextInputVisualSnapshotV1,
            ...
            resource_loading: Some(UiResourceLoadingDiagnosticsSnapshotV1 {
                ...
                font_environment: Some(UiFontEnvironmentDiagnosticsSnapshotV1 {
                    ...
                    bundled_asset_keys: vec![
                        ...
                        "fonts/JetBrainsMono-roman-subset.ttf".to_string(),
                        "fonts/JetBrainsMono-italic-subset.ttf".to_string(),
                        "fonts/FiraMono-subset.ttf".to_string(),
                    ],
                    bundled_roles: vec![
                        "UiSans".to_string(),
                        "UiSerif".to_string(),
                    ...
                    renderer_font_sources: vec![UiRendererFontSourceSnapshotV1 {
                        ...
                        asset_key: Some("fonts/Inter-roman-subset.ttf".to_string()),
