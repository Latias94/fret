//! Thin diagnostics WebSocket bridge for `fret-bootstrap`.
...
use fret_diag_ws::client::{devtools_ws_config_from_window_query, ClientKindV1, DevtoolsWsClient, DevtoolsWsClientConfig};

/// Resolve devtools WebSocket configuration from the current host environment.
pub fn devtools_ws_config() -> (Option<String>, Option<String>) {
    #[cfg(target_arch = "wasm32")]
    {
...
pub struct UiDiagnosticsWsBridge {
