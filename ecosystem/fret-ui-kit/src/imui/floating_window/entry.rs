...
pub(in crate::imui::floating_window) fn floating_window_show_with_options<
    H: UiHost,
...
>(
    ...
    if !super::state::floating_window_is_open(ui, open.as_ref()) {
        return super::closed::closed_floating_window_response(initial_position, initial_size);
    }

    let chrome = Rc::new(Cell::new(
        super::super::FloatingWindowChromeResponse::default(),
    ));
    ...
    super::state::floating_window_response(area, chrome)
}
