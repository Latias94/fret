use super::visual::tab_trigger_visual;
...
#[test]
fn tab_trigger_visual_uses_button_label_text_role() {
    ...
    let text = el
        .children
        .first()
        .expect("expected tab trigger text child");
    let ElementKind::Text(props) = &text.kind else {
        panic!("expected tab trigger label to be text");
    };
