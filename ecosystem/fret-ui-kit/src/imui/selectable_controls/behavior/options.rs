...
pub(in crate::imui::selectable_controls) struct SelectableBehaviorOptions {
    pub(in crate::imui::selectable_controls) enabled: bool,
    pub(in crate::imui::selectable_controls) focusable: bool,
