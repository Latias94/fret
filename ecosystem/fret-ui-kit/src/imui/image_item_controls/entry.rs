...
use super::super::{ImageItemOptions, ResponseExt, UiWriterImUiFacadeExt};
use super::visual::{image_item_chrome, image_props_for_item};
use super::{behavior, props};
use crate::declarative::chrome::control_chrome_pressable_with_id_props;

pub(super) fn image_item_with_options_inner<H: UiHost, W: UiWriterImUiFacadeExt<H> + ?Sized>(
    ui: &mut W,
    image: ImageId,
    size: Size,
