...
pub use options::{
    ...
    TabItemOptions, TableColumn, TableColumnResizeOptions, TableColumnWidth, TableOptions,
    TableRowOptions, TableSortDirection, TextAreaOptions, TextAreaSubmitKey, TooltipOptions,
