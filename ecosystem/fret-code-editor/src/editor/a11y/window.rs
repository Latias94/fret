...
pub(in crate::editor) fn a11y_composed_text_window(
...
#[derive(Debug, Clone)]
pub(super) struct A11yDisplayRow {
...
#[derive(Debug, Clone)]
pub(super) struct A11yDisplayWindow {
    pub(super) rows: Vec<A11yDisplayRow>,
    pub(super) row_global_starts: Vec<usize>,
    pub(super) newline_after_row: Vec<bool>,
...
pub(super) fn build_a11y_display_window(
    st: &mut CodeEditorState,
    caret_row: usize,
    text_cache_max_entries: usize,
) -> A11yDisplayWindow {
...
pub(super) fn map_buffer_offset_to_a11y_global(
...
pub(in crate::editor) fn a11y_text_window_bounds(buf: &TextBuffer, caret: usize) -> (usize, usize) {
