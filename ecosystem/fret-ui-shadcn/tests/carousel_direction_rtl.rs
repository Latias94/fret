use fret_app::App;
use fret_core::{
    AppWindowId, Event, FrameId, LayoutDirection, Modifiers, MouseButton, Point, PointerEvent,
...
#[test]
fn carousel_drag_right_advances_in_rtl() {
    ...
    let moved = Point::new(Px(180.0), Px(60.0));
    ...
    assert_eq!(
        ...
        "expected dragging right to advance in RTL; snapshot={snapshot:?}"
    );
}
