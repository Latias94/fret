...
#[path = "web_vs_fret_overlay_placement/breadcrumb.rs"]
mod breadcrumb;
#[path = "web_vs_fret_overlay_placement/button_group.rs"]
mod button_group;
#[path = "web_vs_fret_overlay_placement/calendar.rs"]
mod calendar;
#[path = "web_vs_fret_overlay_placement/combobox.rs"]
mod combobox;
#[path = "web_vs_fret_overlay_placement/context_menu.rs"]
mod context_menu;
#[path = "web_vs_fret_overlay_placement/date_picker.rs"]
mod date_picker;
#[path = "web_vs_fret_overlay_placement/dropdown_menu_checkboxes.rs"]
mod dropdown_menu_checkboxes;
#[path = "web_vs_fret_overlay_placement/dropdown_menu_demo.rs"]
mod dropdown_menu_demo;
#[path = "web_vs_fret_overlay_placement/dropdown_menu_dialog.rs"]
mod dropdown_menu_dialog;
#[path = "web_vs_fret_overlay_placement/dropdown_menu_misc.rs"]
mod dropdown_menu_misc;
#[path = "web_vs_fret_overlay_placement/dropdown_menu_radio_group.rs"]
mod dropdown_menu_radio_group;
#[path = "web_vs_fret_overlay_placement/item_dropdown.rs"]
mod item_dropdown;
#[path = "web_vs_fret_overlay_placement/menubar.rs"]
mod menubar;
#[path = "web_vs_fret_overlay_placement/misc_overlays.rs"]
mod misc_overlays;
#[path = "web_vs_fret_overlay_placement/mode_toggle.rs"]
mod mode_toggle;
#[path = "web_vs_fret_overlay_placement/navigation_menu.rs"]
mod navigation_menu;
#[path = "web_vs_fret_overlay_placement/select.rs"]
mod select;
#[path = "web_vs_fret_overlay_placement/smoke.rs"]
mod smoke;
#[path = "web_vs_fret_overlay_placement/sonner.rs"]
mod sonner;
