use fret_app::App;
use fret_core::{
    AppWindowId, FrameId, PathCommand, PathConstraints, PathId, PathMetrics, PathService, PathStyle,
...
fn combobox_v4_parts_produce_listbox_semantics_when_open() {
    ...
    render_frame(
        ...
        move |cx| {
            ...
            vec![Combobox::new(value_frame_1.clone(), open_frame_1.clone()).into_element_parts(
                cx,
                |_cx| {
                vec![
    ...
    render_frame(
        ...
        move |cx| {
            ...
            vec![Combobox::new(value_frame_2.clone(), open_frame_2.clone()).into_element_parts(
                cx,
                |_cx| {
                vec![
                    ComboboxPart::from(ComboboxInput::new().placeholder("Select a framework")),
...
fn combobox_chips_v4_parts_produce_listbox_semantics_when_open() {
    ...
    render_frame(
        ...
        move |cx| {
            ...
            vec![ComboboxChips::new(values_frame_1.clone(), open_frame_1.clone())
                .into_element_parts(cx, |_cx| {
                vec![
                    ComboboxChipsPart::from(ComboboxValue::new([ComboboxChip::new("next")])),
    ...
    render_frame(
        ...
        move |cx| {
            ...
            vec![ComboboxChips::new(values_frame_2.clone(), open_frame_2.clone())
                .into_element_parts(cx, |_cx| {
                vec![
                    ComboboxChipsPart::from(ComboboxValue::new([ComboboxChip::new("next")])),
                    ComboboxChipsPart::from(ComboboxChipsInput::new().placeholder("Add framework")),
