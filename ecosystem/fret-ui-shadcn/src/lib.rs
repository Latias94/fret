...
pub mod facade {
    ...
    pub use crate::tabs::{
        Tabs, TabsContent, TabsItem, TabsList, TabsListHeightOverride, TabsListVariant,
        TabsListVariants, TabsOrientation, TabsRoot, TabsStyle, TabsTrigger, tabs,
        tabs_list_variants, tabs_uncontrolled,
    };
