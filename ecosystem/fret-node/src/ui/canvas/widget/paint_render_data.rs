...
pub(super) struct RenderData {
    pub(super) groups: Vec<(Rect, Arc<str>, bool)>,
    pub(super) edges: Vec<EdgeRender>,
    pub(super) nodes: Vec<(
        GraphNodeId,
        Rect,
        bool,
    ...
    pub(super) pins: Vec<(PortId, Rect, Color)>,
    pub(super) port_labels: HashMap<PortId, PortLabelRender>,
    pub(super) port_centers: HashMap<PortId, Point>,
}
...
pub(super) struct EdgeRender {
    ...
    pub(super) hint: EdgeRenderHint,
    pub(super) selected: bool,
    pub(super) hovered: bool,
}

#[derive(Debug, Clone)]
pub(super) struct PortLabelRender {
    pub(super) label: Arc<str>,
    pub(super) dir: PortDirection,
    pub(super) max_width: Px,
}

impl<M: NodeGraphCanvasMiddleware> NodeGraphCanvasWith<M> {
    pub(super) fn collect_selected_nodes_render_data<H: UiHost>(
        &self,
        host: &H,
    ...
    pub(super) fn collect_render_data<H: UiHost>(
        &self,
        host: &H,
        snapshot: &ViewSnapshot,
