...
fn cached_edge_base_key(
    scope: &'static str,
    base_key: DerivedBaseKey,
    style_key: u64,
    edges_cache_tile_size_canvas: f32,
) -> u64 {
    cached_edge_key_builder(scope, base_key, style_key, edges_cache_tile_size_canvas).finish()
}

fn cached_edge_single_rect_key(
    scope: &'static str,
    base_key: DerivedBaseKey,
    style_key: u64,
    edges_cache_tile_size_canvas: f32,
    ...
    let mut b = cached_edge_key_builder(scope, base_key, style_key, edges_cache_tile_size_canvas);
