...
impl<M: NodeGraphCanvasMiddleware> NodeGraphCanvasWith<M> {
    pub(super) fn apply_transaction_result<H: UiHost>(
        &mut self,
        host: &mut H,
        tx: &GraphTransaction,
    ...
    pub(super) fn commit_ops<H: UiHost>(
        &mut self,
        host: &mut H,
    ...
    pub(super) fn commit_transaction<H: UiHost>(
        &mut self,
        host: &mut H,
        window: Option<AppWindowId>,
        tx: &GraphTransaction,
    ...
    pub(super) fn undo_last<H: UiHost>(
        &mut self,
        host: &mut H,
        window: Option<AppWindowId>,
    ) -> bool {
    ...
    pub(super) fn redo_last<H: UiHost>(
        &mut self,
        host: &mut H,
        window: Option<AppWindowId>,
    ) -> bool {
