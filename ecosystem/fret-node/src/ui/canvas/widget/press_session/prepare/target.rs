...
fn clear_target_pointer_sessions(interaction: &mut InteractionState, clear_node_resize: bool) {
    clear::clear_group_drag(interaction);
    clear::clear_group_resize(interaction);
    clear::clear_node_drag(interaction);
    if clear_node_resize {
...
pub(in super::super::super) fn prepare_for_port_hit(interaction: &mut InteractionState) {
    clear_target_pointer_sessions(interaction, false);
    super::super::super::focus_session::clear_edge_focus_and_hover_port_hints(interaction);
}

pub(in super::super::super) fn prepare_for_edge_anchor_hit(interaction: &mut InteractionState) {
    clear_target_pointer_sessions(interaction, true);
    super::super::super::focus_session::clear_hover_port_hints(interaction);
    interaction.hover_edge = None;
}

pub(in super::super::super) fn prepare_for_resize_hit(interaction: &mut InteractionState) {
    clear_target_pointer_sessions(interaction, true);
    super::super::super::focus_session::clear_hover_port_hints(interaction);
}

pub(in super::super::super) fn prepare_for_node_hit(interaction: &mut InteractionState) {
    clear_target_pointer_sessions(interaction, true);
    super::super::super::focus_session::clear_edge_focus_and_hover_port_hints(interaction);
}

pub(in super::super::super) fn prepare_for_edge_hit(interaction: &mut InteractionState) {
    clear::clear_group_drag(interaction);
    clear::clear_group_resize(interaction);
    clear::clear_node_drag(interaction);
    clear::clear_node_resize(interaction);
...
mod tests {
    ...
    #[test]
    fn prepare_for_edge_anchor_hit_clears_hover_edge_and_node_resize() {
        let mut interaction = sample_interaction();
