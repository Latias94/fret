...
impl<M: NodeGraphCanvasMiddleware> NodeGraphCanvasWith<M> {
    ...
    #[allow(dead_code)]
    fn apply_transaction_result_legacy<H: UiHost>(
        &mut self,
        host: &mut H,
        tx: &GraphTransaction,
    ...
    #[allow(dead_code)]
    fn commit_transaction_legacy<H: UiHost>(
        &mut self,
        host: &mut H,
        window: Option<AppWindowId>,
        tx: &GraphTransaction,
    ...
    #[allow(dead_code)]
    fn undo_last_legacy<H: UiHost>(&mut self, host: &mut H, window: Option<AppWindowId>) -> bool {
    ...
    #[allow(dead_code)]
    fn redo_last_legacy<H: UiHost>(&mut self, host: &mut H, window: Option<AppWindowId>) -> bool {
        let preferred_focus = self.interaction.focused_edge;
    ...
    fn box_select_edges_for_nodes<H: UiHost>(
        &self,
        host: &mut H,
        interaction: &NodeGraphInteractionState,
