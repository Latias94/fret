...
const UI_OVERLAY_CONTROLS_PAINT_PLAN_RS: &str = include_str!("ui/overlays/controls_paint_plan.rs");
...
const UI_OVERLAY_MINIMAP_DECLARATIVE_RS: &str = include_str!("ui/overlays/minimap_declarative.rs");
...
const UI_CANVAS_WIDGET_MARQUEE_BEGIN_RS: &str = include_str!("ui/canvas/widget/marquee_begin.rs");
const UI_CANVAS_WIDGET_MARQUEE_CX_RS: &str = include_str!("ui/canvas/widget/marquee_cx.rs");
const UI_CANVAS_WIDGET_MARQUEE_FINISH_RS: &str = include_str!("ui/canvas/widget/marquee_finish.rs");
...
const UI_CANVAS_WIDGET_PAN_ZOOM_BEGIN_RS: &str = include_str!("ui/canvas/widget/pan_zoom_begin.rs");
const UI_CANVAS_WIDGET_PAN_ZOOM_BEGIN_CX_RS: &str =
    include_str!("ui/canvas/widget/pan_zoom_begin_cx.rs");
const UI_CANVAS_WIDGET_PAN_ZOOM_MOVE_RS: &str = include_str!("ui/canvas/widget/pan_zoom_move.rs");
...
const UI_CANVAS_WIDGET_REDRAW_REQUEST_RS: &str = include_str!("ui/canvas/widget/redraw_request.rs");
...
const UI_CANVAS_LOW_LEVEL_ADAPTER_RS: &str = include_str!("ui/canvas/widget/low_level_adapter.rs");
...
const UI_CANVAS_WIDGET_HOVER_MOVE_CX_RS: &str = include_str!("ui/canvas/widget/hover_move_cx.rs");
const UI_CANVAS_WIDGET_CANCEL_CLEANUP_RS: &str = include_str!("ui/canvas/widget/cancel_cleanup.rs");
...
const UI_CANVAS_WIDGET_EVENT_KEYBOARD_RS: &str = include_str!("ui/canvas/widget/event_keyboard.rs");
...
const UI_CANVAS_WIDGET_NODE_DRAG_SNAP_RS: &str = include_str!("ui/canvas/widget/node_drag_snap.rs");
...
const UI_CANVAS_WIDGET_NODE_DRAG_TAIL_RS: &str = include_str!("ui/canvas/widget/node_drag/tail.rs");
...
const UI_CANVAS_WIDGET_PENDING_RESIZE_RS: &str = include_str!("ui/canvas/widget/pending_resize.rs");
...
const UI_CANVAS_WIDGET_CONTEXT_MENU_RS: &str = include_str!("ui/canvas/widget/context_menu/mod.rs");
...
const UI_CANVAS_WIDGET_SEARCHER_INPUT_RS: &str = include_str!("ui/canvas/widget/searcher_input.rs");
...
fn pointer_move_hover_fallback_stays_off_retained_bridge() {
    let hover_sources = [UI_CANVAS_WIDGET_HOVER_RS, UI_CANVAS_WIDGET_HOVER_MOVE_CX_RS].join("\n");
...
fn paint_root_cache_plan_adapter_keeps_route_inputs_off_retained_cx() {
    ...
    assert!(
        UI_CANVAS_WIDGET_PAINT_ROOT_CACHE_PLAN_ADAPTER_RS.contains("trait PaintRootCachePlanCx"),
...
fn paint_root_frame_viewport_adapter_keeps_bounds_route_off_retained_cx() {
    ...
    assert!(
        UI_CANVAS_WIDGET_PAINT_ROOT_FRAME_VIEWPORT_RETAINED_CX_RS
            .contains("impl<H: UiHost> super::frame_viewport_adapter::PaintRootFrameViewportCx<H>"),
        "retained frame viewport binding should implement the adapter explicitly"
    );
    assert!(
        UI_CANVAS_WIDGET_PAINT_ROOT_FRAME_VIEWPORT_RETAINED_CX_RS.contains("for PaintCx<'_, H>"),
...
fn paint_root_frame_clip_adapter_keeps_root_clip_emission_off_retained_cx() {
    ...
    assert!(
        UI_CANVAS_WIDGET_PAINT_ROOT_FRAME_CLIP_ADAPTER_RS.contains("trait PaintRootFrameClipCx"),
...
fn paint_root_frame_diagnostics_adapter_keeps_path_cache_stats_off_retained_cx() {
    ...
    assert!(
        UI_CANVAS_WIDGET_PAINT_ROOT_FRAME_DIAGNOSTICS_RETAINED_CX_RS.contains("for PaintCx<'_, H>"),
...
fn paint_root_frame_background_adapter_keeps_background_quad_off_retained_cx() {
    ...
    assert!(
        UI_CANVAS_WIDGET_PAINT_ROOT_FRAME_BACKGROUND_RETAINED_CX_RS.contains("for PaintCx<'_, H>"),
...
fn paint_grid_cache_adapter_keeps_tile_warmup_scene_sink_off_retained_cx() {
    ...
    assert!(
        UI_CANVAS_WIDGET_PAINT_GRID_CACHE_RETAINED_CX_RS
            .contains("impl<H: UiHost> super::paint_grid_cache_adapter::PaintGridTileCacheCx<H>"),
...
fn paint_grid_diagnostics_adapter_keeps_tile_cache_stats_off_retained_cx() {
    ...
    assert!(
        UI_CANVAS_WIDGET_PAINT_GRID_DIAGNOSTICS_ADAPTER_RS.contains("trait PaintGridDiagnosticsCx"),
...
fn paint_root_pass_scene_adapter_keeps_immediate_scene_sink_off_retained_cx() {
    ...
    assert!(
        UI_CANVAS_WIDGET_PAINT_ROOT_PASS_SCENE_ADAPTER_RS.contains("trait PaintRootPassSceneCx"),
...
fn paint_root_cached_edge_build_state_adapter_keeps_route_inputs_off_retained_cx() {
    for forbidden in [
        ...
        assert!(
            !UI_CANVAS_WIDGET_PAINT_ROOT_CACHED_EDGES_BUILD_STATE_ADAPTER_RS.contains(forbidden),
    ...
    for required in ["self.app", "self.services", "self.scale_factor"] {
        assert!(
            UI_CANVAS_WIDGET_PAINT_ROOT_CACHED_EDGES_BUILD_STATE_RETAINED_CX_RS.contains(required),
...
fn paint_root_cached_edge_build_state_temp_scene_adapter_keeps_construction_out_of_route_helpers() {
    for forbidden in [
        ...
        assert!(
            !UI_CANVAS_WIDGET_PAINT_ROOT_CACHED_EDGES_BUILD_STATE_TEMP_SCENE_RS.contains(forbidden),
...
fn paint_root_cached_edge_build_state_clip_ops_adapter_keeps_clip_policy_behind_helper() {
    for forbidden in [
        ...
        assert!(
            !UI_CANVAS_WIDGET_PAINT_ROOT_CACHED_EDGES_BUILD_STATE_CLIP_OPS_RS.contains(forbidden),
...
fn paint_root_cached_edge_anchor_target_adapter_keeps_direct_anchor_route_off_cached_helper() {
    for forbidden in [
        ...
        assert!(
            !UI_CANVAS_WIDGET_PAINT_ROOT_CACHED_EDGES_ANCHOR_TARGET_ADAPTER_RS.contains(forbidden),
    ...
    for required in [
        ...
        assert!(
            UI_CANVAS_WIDGET_PAINT_ROOT_CACHED_EDGES_ANCHOR_TARGET_ADAPTER_RS.contains(required),
...
fn paint_root_cached_edge_fallback_adapter_keeps_route_inputs_off_fallback_helpers() {
    ...
    assert!(
        UI_CANVAS_WIDGET_PAINT_ROOT_CACHED_EDGES_FALLBACK_RETAINED_CX_RS
            .contains("impl<H: UiHost> super::fallback_adapter::PaintRootCachedEdgeFallbackCx<H>"),
...
fn paint_root_cached_edge_overlay_adapter_keeps_direct_overlay_route_off_cached_paths() {
    ...
    assert!(
        UI_CANVAS_WIDGET_PAINT_ROOT_CACHED_EDGES_OVERLAY_RETAINED_CX_RS
            .contains("impl<H: UiHost> super::overlay_adapter::PaintRootCachedEdgeOverlayCx<H>"),
