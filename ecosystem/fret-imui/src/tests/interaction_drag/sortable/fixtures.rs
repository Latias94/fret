...
pub(super) struct TestSortableItem {
    id: Arc<str>,
    label: Arc<str>,
}
...
pub(super) fn test_sortable_items() -> Vec<TestSortableItem> {
    vec![
        TestSortableItem {
            id: Arc::from("camera"),
...
pub(super) fn render_test_sortable_rows(
...
#[test]
fn sortable_order_line_formats_visible_labels() {
    assert_eq!(
        test_sortable_order_line(&test_sortable_items()),
