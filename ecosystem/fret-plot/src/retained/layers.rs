...
use crate::plot::readout::{
    PlotCursorReadoutArgs as SharedPlotCursorReadoutArgs, cursor_readout_y_at_x,
...
impl PlotLayer for LinePlotLayer {
    ...
    fn cursor_readout(
        ...
        let rows = line_plot_cursor_readout(
            model,
            SharedPlotCursorReadoutArgs {
                x: args.x,
                plot_size: args.plot_size,
                view_bounds: args.view_bounds,
