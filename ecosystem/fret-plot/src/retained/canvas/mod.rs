                ...
                || !overlays.text.is_empty()
            {
                    ...
                    || !overlays.drag_rects.is_empty()
                {
                    ...
                    for line in &overlays.drag_lines_x {
                        ...
                        let value = if line.show_value {
                            self.tooltip_x_labels.format(x_value, x_span)
                        } else {
                            Default::default()
                        };
                    ...
                    if let Some(transform_x) = transform_x {
                        for tag in &overlays.tags_x {
                            ...
                            let value = if tag.show_value {
                                self.tooltip_x_labels.format(tag.x, x_span)
                            } else {
                                Default::default()
                            };
