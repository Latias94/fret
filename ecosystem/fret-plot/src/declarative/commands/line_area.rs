//! Declarative line, area, and stems path-command projection owner.
...
pub(in crate::declarative) fn area_fill_commands_from_polyline(
...
pub(in crate::declarative) fn stems_commands_from_points(
...
pub(in crate::declarative) fn step_commands_from_polyline(
    polyline: &[PathCommand],
    step_mode: StepMode,
) -> Vec<PathCommand> {
