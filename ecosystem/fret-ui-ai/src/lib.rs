...
pub use elements::{
    ...
    OnStackTraceFilePathClick, OnSuggestionClick, OnTestActivate, ParsedStackTrace, Plan,
    PlanAction, PlanContent, PlanController, PlanDescription, PlanFooter, PlanHeader, PlanTitle,
    PlanTrigger, PromptInput, PromptInputActionAddAttachments,
